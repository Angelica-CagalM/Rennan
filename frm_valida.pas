...
procedure TfrmValida.DisplayMail(Attachment: TFileName);
var
...
procedure TfrmValida.btnEnviarClick(Sender: TObject);
begin
...
procedure TfrmValida.btnLiberarClick(Sender: TObject);
var
        ...
        with grid_DatosView.DataController.DataSource.DataSet do
          ...
          begin
            ...
            begin
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                     procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Libera',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
...
procedure TfrmValida.btnMaterialesClick(Sender: TObject);
begin
...
procedure TfrmValida.btnPRClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice, x: Integer;
  SavePlace: TBookmark;
...
//                  zMaterialesR.Open;
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                   ...
                   begin
                    ...
                    procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'GeneroPR',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
...
procedure TfrmValida.btnRechazarClick(Sender: TObject);
var
  iGrid, indice,x: Integer;
begin
   cxLista.Items[iIndiceSeleccionado].Selected := True;
          ...
          begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                      procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida );
...
//  guardar_leer_grid(grid_datosView,frmValida,0);
   PermisosBotones(frmValida,btnPermisos);
...
procedure TfrmValida.grid_datosViewCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
  global_frmActivo := 'Si';
...
procedure TfrmValida.grid_datosViewCellDblClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmValida.grid_datosViewStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
 begin
      //Estatus
...
procedure TfrmValida.BonotesVal;
begin
...
procedure TfrmValida.btnAsignarCCClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice, x: Integer;
  SavePlace: TBookmark;
          ...
          begin
            ...
            begin
                 ...
                 begin
                     ...
                     if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                         procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'AsignoCC',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
        ...
        with grid_DatosView.DataController.DataSource.DataSet do
          ...
          begin
             ...
             begin
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                     procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 2) then
                 begin
                        procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'Valida',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
                 end;

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 3) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'Valida',3, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida);

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 4) then
                 begin
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',4, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida);
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
                      ImprimeDatosPrepare('frxDBEntradas', False, zqDatos);
                      connection.ExportaPDF.ShowProgress := False;
                      connection.ExportaPDF.ShowDialog   := False;
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 5) then
                 begin
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',5, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
                     if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
                       ImprimeDatosPrepare('frxDBEntrada', False, zqDatos);
                       connection.ExportaPDF.ShowProgress := False;
                       connection.ExportaPDF.ShowDialog   := False;
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 6) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'Valida',6, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 7) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'Valida', 7, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 8) then
                 begin
                        procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida );
                 end;

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 9) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',9, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 10) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',10, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 11) then
                 begin
                    procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'Valida',11, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
...
procedure TfrmValida.btncancelarClick(Sender: TObject);
var
  iGrid, indice,x: Integer;
begin
  cxLista.Items[iIndiceSeleccionado].Selected := True;
...
procedure TfrmValida.btnComprarClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice, x: Integer;
  SavePlace: TBookmark;
        ...
        with grid_DatosView.DataController.DataSource.DataSet do
          ...
          begin
            ...
            begin
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Comprado',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
...
procedure TfrmValida.cxListaClick(Sender: TObject);
begin
   grid_datosView.DataController.Groups.FullExpand;
   ...
   begin
      ...
      begin
          ...
          procCargaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Libera',1, frmValida, zqDatos );
      ...
      begin
          ...
          procCargaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, frmValida, zqDatos );
      end
      else
       begin
          grid_datosView.Columns[0].DataBinding.FieldName:='Folio';
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'Valida',2, frmValida, zqDatos );
      {$Endregion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'Valida',3, frmValida, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',4, frmValida, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',5, frmValida, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'Valida',6, frmValida, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'Valida',7, frmValida, zqDatos);
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, frmValida, zqDatos);
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',9, frmValida, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',10, frmValida, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'Valida',11, frmValida, zqDatos );
...
procedure TfrmValida.cxRefrescarClick(Sender: TObject);
begin
   SavePlace2 := grid_DatosView.DataController.DataSource.DataSet.GetBookmark;
   zqDatos.Refresh;
   try
...
procedure TfrmValida.cxVisualizarClick(Sender: TObject);
begin
    cxLista.Items[iIndiceSeleccionado].Selected := True;
    if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1 then
...
procedure TfrmValida.ImprimeDatosPrepare(sParamUser :string; lVisualiza :boolean; uniQ_param: tUniQuery);
var
  ArchivoPDF : String;
  i : integer;
...
function TFrmValida.EnviarMensaje(sUsuario, sClave, sServidor, sAdjunto,
...
procedure TfrmValida.MuestraColumnas(iParamInicio,iParamFin : integer; lTipo :boolean);
var
  i : integer;
begin
...
procedure TfrmValida.EnviaCorreoAvanzado(sParamModulo: string; sParamProceso: string; sParamTipoMaterial: string; sParamComentario : string; sParamEstatus: string; sParamFoldiosDoctos : string);
var
   x: integer;
...
procedure TfrmValida.EnviaCorreo(sParamModulo: string; sParamProceso: string; sParamTipoMaterial: string; sParamEstatus: string; sParamFoldiosDoctos : string);
var
...
procedure TfrmValida.ConcatenaTipoFolios(iParamPuntero : integer);
begin
//    sTipoMaterial := '';
//    sFoliosDoctos := '';
//    sUsuarioReq:='';
...
procedure TfrmValida.GetValueReporte(rReporteParametro: TfrxReport);
var
