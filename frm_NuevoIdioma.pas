...
uses
  ...
  ZAbstractRODataset, ZAbstractDataset, ZDataset, strUtils,
  ...
  dxSkinVisualStudio2013Light, cxContainer, cxTextEdit, cxDBEdit, cxCheckBox;
...
type
  TfrmNuevoIdioma = class(TForm)
    ...
    tsIdIdioma: TcxDBTextEdit;
    tsDescripcion: TcxDBTextEdit;
    cbIdiomaDefault: TcxCheckBox;
...
begin
  tsIdIdioma.Style.Color := global_color_entradaERP

end;

procedure TfrmNuevoIdioma.tsIdIdiomaExit(Sender: TObject);
begin
  tsIdIdioma.Style.color := global_color_salidaPU
end;
