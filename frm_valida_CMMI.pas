...
type
  TfrmValida_CMMI = class(TForm)
    ...
    zMR: TUniQuery;
    dsMR: TDataSource;
    btnValidaTecnico3: TcxButton;
    btnRechazar2: TcxButton;
    ...
    procedure btnValidaTecnico3Click(Sender: TObject);
  private
    ...
    DirPDF, valeSalida :String ;
    procedure creaValeSalida;
...
const
  iPausa = 1000;
var
  frmValida_CMMI: TfrmValida_CMMI;
  dMonto: Currency;
  sJornada, ant : string;
  lRecordChange, lContinua: Boolean;
  iRecord: Integer;
...
procedure TfrmValida_CMMI.DisplayMail(Attachment: TFileName);
var
...
procedure TfrmValida_CMMI.btnEnviarClick(Sender: TObject);
begin
...
procedure TfrmValida_CMMI.btnLiberarClick(Sender: TObject);
var
        ...
        with grid_DatosView.DataController.DataSource.DataSet do
          ...
          begin
            ...
            begin
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                     procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Libera',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
...
procedure TfrmValida_CMMI.btnMaterialesClick(Sender: TObject);
begin
...
procedure TfrmValida_CMMI.btnPRClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice, x: Integer;
  SavePlace: TBookmark;
            ...
            begin
             ...
             begin
               ...
               begin
                  ...
                  'UsuarioCancelo, UsuarioLibero, FechaLibero, UsuarioAsignoCC, FechaAsignoCC, UsuarioGeneroPR, FechaGeneroPR, UsuarioCompro, FechaCompro, sUsuarioCompra, AplicaLogistica, NotasLogistica, FechaCancelo, Vista) '+
                  ...
                  ':FechaAsignoCC, UsuarioGeneroPR, FechaGeneroPR, UsuarioCompro, FechaCompro, sUsuarioCompra, AplicaLogistica, NotasLogistica, FechaCancelo, Vista ' +
                  ...
                  zActualizar.Active:=False;
                  zActualizar.SQL.Clear;
                  zActualizar.SQL.Text := 'UPDATE anexo_prequisicion SET sEstado=:Estado WHERE iFolioRequisicion = :actual';
                  zActualizar.ParamByName('actual').AsInteger:=lastId;
...
//                  zMaterialesR.Open;
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                   ...
                   begin
                    ...
                    procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'GeneroPR',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
...
procedure TfrmValida_CMMI.btnRechazarClick(Sender: TObject);
var
  iGrid, indice,x: Integer;
begin
   cxLista.Items[iIndiceSeleccionado].Selected := True;
...
//                  btnRechazar.Enabled:=false;
           ...
           begin
              if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 5 then
                 if grid_DatosView.DataController.DataSet.FieldByName('Solicitud').AsString = 'N/A' then
                 begin
                    messageDLG('No se puede RECHAZAR una salida sin No. de Solicitud asignado!', mtInformation, [mbOk],0);
                    exit;
                 end;
...
procedure TfrmValida_CMMI.btnValidaClick(Sender: TObject);
var
              ...
              begin
                ...
                begin
                  ...
                  begin
                     ...
                     begin
                         if grid_DatosView.DataController.DataSet.FieldByName('IdGerente').AsInteger > 0 then
                            procValidaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'ValidaGerencias',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI )
                         else
                            procValidaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
                     end
                     else
                        procValidaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
                  end;
                  ...
                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 2 then begin
                      ...
                      begin
                          ...
                          begin
                            ...
                            begin
                              procValidaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'Valida',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI)
                            end
                            else
                            begin
                  ...
                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 3 then
                     procValidaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'Valida',3, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI);

                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 4 then begin
                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',4, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
                  ...
                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 5 then begin
                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',5, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI);
                      if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
                        ImprimeDatosPrepare('frxDBEntrada', False ,zqDatos);
                        connection.ExportaPDF.ShowProgress := False;
                        connection.ExportaPDF.ShowDialog   := False;
                  ...
                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 6 then
                     procValidaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'Valida',6, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );

                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 7 then
                     procValidaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'Valida', 7, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_CMMI );

                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 8 then
                  begin
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                          procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_CMMI )
                      end
                      else
                          procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_CMMI );
                  ...
                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 9 then
                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',9, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI);

                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 10 then
                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',10, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI);

                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 11 then
                  begin
                    procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'Valida',11, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI);
...
//
         ...
         begin
             ...
             if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 11 then
                EnviaCorreo('SOLICITUDES', 'VALIDAR', sTipoMaterial, '',sFoliosDoctos);
         end;
...
procedure TfrmValida_CMMI.btnValidaTecnico3Click(Sender: TObject);
var
  iGrid, indice, i,x: Integer;
  lPoder,lNotificaCotizacion : Boolean;
  SavePlace : TBookmark;
...
//                     begin
//                         if grid_DatosView.DataController.DataSet.FieldByName('IdGerente').AsInteger > 0 then
//                            procValidaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'ValidaGerencias',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida )
//                         else
//                            procValidaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
//                     end
//                     else
//                        procValidaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
//                  end;
                  ...
                  begin
                      ...
                      begin
                          ...
                          begin
                            if grid_DatosView.DataController.DataSet.FieldByName('dMontoMN').AsFloat <= 10000.00 then
                            begin
                              procValidaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'ValidaTecnico',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI)
                            end
                            else
                            begin
                              MessageDlg('Permiso denegado para realizar la validación de O.C., el proveedor no cuenta con todos los documentos necesarios.', mtWarning,[mbOk],0);
...
//                        procValidaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'Valida',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
                  ...
                  kardex_almacen('Valida Tecnica'+cxLista.Items[cxLista.ItemIndex].Caption+' No. [' + grid_DatosView.DataController.DataSet.FieldByName('Folio').AsString + '].', 'Otros Movimientos');
...
procedure TfrmValida_CMMI.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    action := cafree;
end;

procedure TfrmValida_CMMI.FormShow(Sender: TObject);
var
Cursor: TCursor;
  LocIdEmpresa: String;
begin
...
//  guardar_leer_grid(grid_datosView,frmValida,0);
   PermisosBotones(frmValida_CMMI,btnPermisos);
...
procedure TfrmValida_CMMI.grid_datosViewCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
  global_frmActivo := 'Si';
...
procedure TfrmValida_CMMI.grid_datosViewCellDblClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmValida_CMMI.grid_datosViewStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
 begin
      //Estatus
...
procedure TfrmValida_CMMI.BonotesVal;
begin
...
procedure TfrmValida_CMMI.btnAsignarCCClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice, x: Integer;
  SavePlace: TBookmark;
          ...
          begin
            ...
            begin
                 ...
                 begin
                     ...
                     if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                         procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'AsignoCC',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
...
procedure TfrmValida_CMMI.btnAutorizaClick(Sender: TObject);
var
  lPoder, lFilaGrid, lNotifica: Boolean;
  iGrid, indice,x: Integer;
  SavePlace: TBookmark;
  zValida1,zDatos1: tUniquery;
begin
   cxLista.Items[iIndiceSeleccionado].Selected := True;
   sTipoMaterial := '';
   sFoliosDoctos := '';
   ...
   if zqDatos.RecordCount > 0 then
      ...
      begin
          ...
          begin
            ...
            frmModal.formAntecesor := 'frmValida_CMMI';
            FrmModal.show;
            exit;
          end;
      end;
      ...
      begin
        ...
        with grid_DatosView.DataController.DataSource.DataSet do
          ...
          begin
             ...
             if  ((UpperCase(grid_DatosView.DataController.DataSet.FieldByName('sStatus').AsString) = 'VALIDADO TECNICO') or (UpperCase(grid_DatosView.DataController.DataSet.FieldByName('sStatus').AsString) = 'VALIDADO')) then
             begin
                 lRecordChange := True;

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                     procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 2) then
                 begin
                      if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                        if (UpperCase(grid_DatosView.DataController.DataSet.FieldByName('sStatus').AsString) = 'VALIDADO TECNICO') then
                        begin
                            procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'Valida',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI )
                        end
                        else
                        begin
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 3) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'Valida',3, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI);

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 4) then
                 begin
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',4, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI);
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
                      ImprimeDatosPrepare('frxDBEntradas', False, zqDatos);
                      connection.ExportaPDF.ShowProgress := False;
                      connection.ExportaPDF.ShowDialog   := False;
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 5) then
                 begin
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',5, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
                     if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
                       ImprimeDatosPrepare('frxDBEntrada', False, zqDatos);
                       connection.ExportaPDF.ShowProgress := False;
                       connection.ExportaPDF.ShowDialog   := False;
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 6) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'Valida',6, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 7) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'Valida', 7, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_CMMI );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 8) then
                 begin
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                          procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_CMMI )
                      end
                      else
                          procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_CMMI );
                 end;
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 9) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',9, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 10) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',10, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );

                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 11) then
                 begin
                    procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'Valida',11, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
...
procedure TfrmValida_CMMI.creaValeSalida;
var
 Id : Integer;
begin
   connection.zUCommand.Active := False;
   AsignarSQL(connection.zUCommand, 'anexo_psolicitud_upt', pUpdate);
   FiltrarDataSet(connection.zUCommand, 'Contrato, Folio', [global_contrato, grid_datosView.DataController.DataSet.FieldByName('iFolio').AsString]);
   connection.zUCommand.Open;

   connection.qryUBusca.Active := False;
   AsignarSQL(connection.qryUBusca, 'consulta_busca_folio', pUpdate);
   connection.qryUBusca.Open;

   connection.QryUBusca2.Active := False;
   AsignarSQL(connection.QryUBusca2, 'inserta_almacen_salida', pUpdate);
   FiltrarDataSet(connection.QryUBusca2,
   'sContrato, sFolioSalida, dFechaSalida, iFolioSolicitud, '+
   'IdTipo, sNombre, sNumeroOrden, sIdUsuario, mComentarios, IdEmpresa, sStatus, '+
   'IdEmpleado, lEsEquipoProteccion, IdCliente, IdAlmacen, IdFirma,UsuarioValido, '+
   'FechaValido, UsuarioAutorizo, FechaAutorizo, Referencia, sNumeroOrdenCentroC',
   [global_contrato, connection.qryUBusca.FieldByName('sFolioSalida').AsString,
   FechaTimeSQL(Now()), grid_datosView.DataController.DataSet.FieldByName('iFolio').AsString,
   14, grid_datosView.DataController.DataSet.FieldByName('Nombre').AsString,
   grid_datosView.DataController.DataSet.FieldByName('sNumeroOrden').AsString,
   grid_datosView.DataController.DataSet.FieldByName('UsuarioReq').AsString,
   '', connection.uContrato.FieldByName('IdEmpresa').AsInteger, 'PENDIENTE', 0, 'NO',grid_datosView.DataController.DataSet.FieldByName('sLugarEntrega').AsString,
   1, 201, '', '', '', '', '', grid_datosView.DataController.DataSet.FieldByName('sNumeroOrdenCentroC').AsString]);
   connection.QryUBusca2.ExecSQL;

   valeSalida := connection.qryUBusca.FieldByName('sFolioSalida').AsString;

   id :=  connection.qryUBusca2.LastInsertId;
   ...
   begin
     connection.QryUBusca2.Active := False;
     AsignarSQL(connection.QryUBusca2, 'inserta_bitacoradesalida', pUpdate);
     FiltrarDataSet(connection.QryUBusca2,
     'sContrato,  iFolioSalida, dFechaSalida, iItem, IdInsumo, dCantidad, '+
     'sStatus, IdAlmacen, NumeroMaterial, iFolioRequisicion ',
     [global_contrato, id, FechaTimeSQL(now()), 0, connection.zUCommand.FieldByName('IdInsumo').AsString,
     connection.zUCommand.FieldByName('dCantidad').AsFloat,
     'PENDIENTE', 1, '', '']);
...
procedure TfrmValida_CMMI.btncancelarClick(Sender: TObject);
var
  iGrid, indice,x: Integer;
begin
  cxLista.Items[iIndiceSeleccionado].Selected := True;
...
procedure TfrmValida_CMMI.btnComprarClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice, x: Integer;
  SavePlace: TBookmark;
        ...
        with grid_DatosView.DataController.DataSource.DataSet do
          ...
          begin
            ...
            begin
                 ...
                 if (cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1) then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Comprado',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_CMMI );
...
procedure TfrmValida_CMMI.cxListaClick(Sender: TObject);
begin
   grid_datosView.DataController.Groups.FullExpand;
   ...
   begin
      ...
      begin
          ...
          procCargaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Libera',1, frmValida_CMMI, zqDatos );
      ...
      begin
          ...
          procCargaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Valida',1, frmValida_CMMI, zqDatos );
      end
      else
       begin
          grid_datosView.Columns[0].DataBinding.FieldName:='Folio';
   ...
   begin
      ...
      begin
          ...
          panel3.Visible:=true;
          panel5.Visible:=false;
          btnValidaTecnico3.Visible := False;
          btnValida.Enabled:=true;
          btnAutoriza.Enabled:=true;
          btncancelar.Enabled:=False;
      end
      ...
      begin
          grid_datosView.Columns[0].DataBinding.FieldName:='Folio';
          grid_datosView.Columns[1].DataBinding.FieldName:='Referencia';
          grid_datosView.Columns[2].DataBinding.FieldName:='Proveedor';
          grid_datosView.Columns[3].DataBinding.FieldName:='Solicitado';
          grid_datosView.Columns[4].DataBinding.FieldName:='UsuarioValido';
          grid_datosView.Columns[5].DataBinding.FieldName:='FechaValido_A';
          grid_datosView.Columns[6].DataBinding.FieldName:='UsuarioCancelo';
          grid_datosView.Columns[7].DataBinding.FieldName:='FechaCancelo_A';
          grid_datosView.Columns[8].DataBinding.FieldName:='sStatus';
          grid_datosView.Columns[9].DataBinding.FieldName :='dMontoMN';
          grid_datosView.Columns[10].DataBinding.FieldName := 'Ahorro' ;

          //Captions
          grid_datosView.Columns[0].Caption:='Código';
          grid_datosView.Columns[1].Caption:='Proyecto';
          grid_datosView.Columns[2].Caption:='Proveedor';
          grid_datosView.Columns[3].Caption:='Fecha Compra';
          grid_datosView.Columns[4].Caption:='Usuario Validó';
          grid_datosView.Columns[5].Caption:='Fecha Validó';
          grid_datosView.Columns[6].Caption:='Usuario Canceló';
          grid_datosView.Columns[7].Caption:='Fecha Canceló';
          grid_datosView.Columns[8].Caption:='Estatus';
          grid_datosView.Columns[9].Caption := 'Total O.C';
          grid_datosView.Columns[10].Caption := 'Ahorro';
          grid_datosView.Columns[9].PropertiesClassName := 'TcxCurrencyEditProperties';
          grid_datosView.Columns[10].PropertiesClassName := 'TcxCurrencyEditProperties';
          ...
          btnValidaTecnico3.Visible := False;
          btnValidaTecnico3.Visible := True;
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'Valida',2, frmValida_CMMI, zqDatos );
      {$Endregion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'Valida',3, frmValida_CMMI, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',4, frmValida_CMMI, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      grid_datosView.Columns[0].DataBinding.FieldName:='Folio';
      grid_datosView.Columns[1].DataBinding.FieldName:='Referencia';
      grid_datosView.Columns[2].DataBinding.FieldName:='Solicitud';
      grid_datosView.Columns[3].DataBinding.FieldName:='UsuarioReq';
      grid_datosView.Columns[4].DataBinding.FieldName:='Entrega';
      grid_datosView.Columns[5].DataBinding.FieldName:='UsuarioValido_vista';
      grid_datosView.Columns[6].DataBinding.FieldName:='sStatus';
      ...
      grid_datosView.Columns[0].Caption:='Código';
      grid_datosView.Columns[1].Caption:='Proyecto';
      grid_datosView.Columns[2].Caption:='No. Solicitud';
      grid_datosView.Columns[3].Caption:='Usuario';
      grid_datosView.Columns[4].Caption:='Fecha Salida';
      grid_datosView.Columns[5].Caption:='Usuario Validó';
      grid_datosView.Columns[6].Caption:='Estatus';
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',5, frmValida_CMMI, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'Valida',6, frmValida_CMMI, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'Valida',7, frmValida_CMMI, zqDatos);
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Valida',8, frmValida_CMMI, zqDatos);
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',9, frmValida_CMMI, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',10, frmValida_CMMI, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'Valida',11, frmValida_CMMI, zqDatos );
...
procedure TfrmValida_CMMI.cxRefrescarClick(Sender: TObject);
begin
   SavePlace2 := grid_DatosView.DataController.DataSource.DataSet.GetBookmark;
   zqDatos.Refresh;
   try
...
procedure TfrmValida_CMMI.cxVisualizarClick(Sender: TObject);
begin
    cxLista.Items[iIndiceSeleccionado].Selected := True;
    if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1 then
...
procedure TfrmValida_CMMI.ImprimeDatosPrepare(sParamUser :string; lVisualiza :boolean; uniQ_param: tUniQuery);
var
  ArchivoPDF : String;
  i : integer;
...
function TfrmValida_CMMI.EnviarMensaje(sUsuario, sClave, sServidor, sAdjunto,
...
procedure TfrmValida_CMMI.MuestraColumnas(iParamInicio,iParamFin : integer; lTipo :boolean);
var
  i : integer;
begin
...
procedure TfrmValida_CMMI.EnviaCorreoAvanzado(sParamModulo: string; sParamProceso: string; sParamTipoMaterial: string; sParamComentario : string; sParamEstatus: string; sParamFoldiosDoctos : string);
var
   x: integer;
...
procedure TfrmValida_CMMI.EnviaCorreo(sParamModulo: string; sParamProceso: string; sParamTipoMaterial: string; sParamEstatus: string; sParamFoldiosDoctos : string);
var
...
begin
     ...
     if ((zMensaje.FieldByName('EnviarAlValidar').AsString = 'Si') and (sParamProceso = 'VALIDAR'))or
       ((zMensaje.FieldByName('EnviarAlAutorizar').AsString = 'Si') and (sParamProceso = 'AUTORIZAR')) or
       ((sParamModulo='SOLICITUDES') AND (sParamProceso='RECHAZAR'))
     then
     begin
             ...
             begin
              if sParamModulo='ENTRADAS' then
                msg := EnviarMensaje(zCorreo.FieldByName('Correo').AsString,
                          ...
                          cadena,
                          mnj+zMensaje.FieldByName('MensajeValidar').AsString+' No. '+sFoliosDoctos + zqDatos.FieldByName('TotalPorcentaje').AsString + ' % ',
                          zCorreo.FieldByName('Puerto').AsInteger,
                          zCorreo.FieldByName('AplicaTLS').AsString)
              ELSE
                 msg := EnviarMensaje(zCorreo.FieldByName('Correo').AsString,
             ...
             begin
               ...
               begin
                 msg := EnviarMensaje(zCorreo.FieldByName('Correo').AsString,
                      ...
                      cadena,
                      mnj+zMensaje.FieldByName('MensajeAutorizar').AsString+' No. '+sFoliosDoctos+ '. Se creo Vale de Salida con No. '+valeSalida,
                      zCorreo.FieldByName('Puerto').AsInteger,
                      zCorreo.FieldByName('AplicaTLS').AsString);
               end
               else
             ...
             begin
               ...
               begin
                 msg := EnviarMensaje(zCorreo.FieldByName('Correo').AsString,
                      ...
                      zCorreo.FieldByName('SMTP').AsString,
                      sAdjunto,
                      asunto + zMensaje.FieldByName('AsuntoRechazar').AsString+' No. '+sParamFoldiosDoctos,
                      cadena,
                      mnj+zMensaje.FieldByName('MensajeRechazar').AsString+' No. '+sParamFoldiosDoctos+ '. Se eliminó Vale de Salida con No. '+ valeSalida ,
                      zCorreo.FieldByName('Puerto').AsInteger,
                      zCorreo.FieldByName('AplicaTLS').AsString);
               end;
             end;
...
procedure TfrmValida_CMMI.ConcatenaTipoFolios(iParamPuntero : integer);
begin
//    sTipoMaterial := '';
//    sFoliosDoctos := '';
//    sUsuarioReq:='';
    ...
    if grid_DatosView.DataController.DataSet.FieldByName('TipoMaterial').AsString='Material' then
       sTipoMaterial:= sTipoMaterial + grid_DatosView.DataController.DataSet.FieldByName('TipoMaterial').AsString + ' Permanente'
    else
       sTipoMaterial:= sTipoMaterial + grid_DatosView.DataController.DataSet.FieldByName('TipoMaterial').AsString ;
...
procedure TfrmValida_CMMI.GetValueReporte(rReporteParametro: TfrxReport);
var
