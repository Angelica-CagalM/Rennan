...
const
  ...
  {$REGION 'Para mostrar el nombre y la version del proyecto'}
    global_version  = 'Gabinete Ultrasonido Dr. Renán Versión: ';
    Major_Version   = '2020';
    Minor_Version   = '1';
    Release_Version = '1';
    Build_Version   = '1';
...
begin
  ...
  Formlario.Scaled      := True;
  Formlario.Font.Size   := 9;
  Formlario.Font.Name   := 'Arial';
...
begin
  ...
  panel.Width           := Largo;
  Formlario             := TForm.Create(nil);
  Formlario.BorderStyle := bsSizeable;
