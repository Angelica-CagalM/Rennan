...
uses
  ...
  unitactivapop, cxGraphics, cxControls, cxLookAndFeels,
  ...
  dxSkinVisualStudio2013Dark, dxSkinVisualStudio2013Light, unitgenerales;
...
begin
guardar_leer_grid(cxgrdbtblvwGrid1DBTableView1,frmCatalogoModulos,1);
   Action := caFree;
end;
...
begin
   ...
   guardar_leer_grid(cxgrdbtblvwGrid1DBTableView1,frmCatalogoModulos,0);
   PermisosBotones(frmCatalogoModulos,btnPermisos);
