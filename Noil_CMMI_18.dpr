...
uses
  ...
  frm_Noil_CMMI in 'frm_Noil_CMMI.pas' {frmNoil_CMMI},
  ...
  frm_valida_CMMI in 'frm_valida_CMMI.pas' {frmValida_CMMI},
  frm_abrereporte_CMMI in 'frm_abrereporte_CMMI.pas' {frmAbreReporte_CMMI},
...
begin
  ...
  Application.CreateForm(TfrmNoil_CMMI, frmNoil_CMMI);
