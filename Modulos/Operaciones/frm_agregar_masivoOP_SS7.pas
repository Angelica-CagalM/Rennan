...
type
  TfrmAgregarMasivoOP_SS7 = class(TForm)
    mnuPop: TPopupMenu;
    Insertar1: TMenuItem;
    Editar1: TMenuItem;
    N1: TMenuItem;
    ...
    cxTabExist_CC: TcxTabSheet;
    cxGridExist_cc: TcxGridDBTableView;
    cxGridExistenciasLevel1: TcxGridLevel;
    cxGridExistencias: TcxGrid;
    cxGridExist_ccColumn1: TcxGridDBColumn;
    cxGridExist_ccColumn2: TcxGridDBColumn;
    dsMaterialCC: TDataSource;
    zMaterialCC: TUniQuery;
    dxLayoutItem22: TdxLayoutItem;
    cxFindWbs: TcxButton;
    clCentroC: TcxLookupComboBox;
...
var
  frmAgregarMasivoOP_SS7 : TfrmAgregarMasivoOP_SS7;
  sOldId           : string;
  sOpcion          : string;
  Parametro        : string;
  Id               : string;
  ...
  implementation
 uses
    frm_catalogos_Operaciones,Frm_CostoPresupuesto,Frm_RequisicionMaterial,frm_SalidaAlmacen_SS7,frm_AvisoEmbarque,
  frm_EntradaAlmacen_SS7,frm_Existencia, Frm_SolicitudMaterial, frm_SolicitudDeMateriales,Func_Genericas,frm_EntregaEquipo, frm_DevolucionEquipo,
  frm_GridFM;

{$R *.dfm}


procedure TfrmAgregarMasivoOP_SS7.addAsignacion;
begin
   zAsigna.SQL.Text:='select IdVale From vale_resguardo where IdSalida = :Salida';
   zAsigna.ParamByName('Salida').AsString:= frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioSalida').AsString;
   zAsigna.Open;
   ...
   begin
      ...
      zAnterior.ParamByName('Fecha').AsDate := frmSalidaAlmacen_SS7.salida_almacen.FieldByName('dFechaSalida').AsDateTime;
...
procedure TfrmAgregarMasivoOP_SS7.addRequisicon;
Var
  SavePlace : TBookmark;
...
Procedure TfrmAgregarMasivoOP_SS7.SelectEntradas;
begin
    //Entrada de Orden de Compra(ENOC)
    if frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENOC' then
    begin
        ...
        [global_contrato,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioMovimiento').AsInteger,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('IdAlmacen').AsInteger]);
        materiales.Open;
    ...
    if (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'TRAE') or (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'RECP') or (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'EDEV')then
    begin
        materiales.Active := False;
        AsignarSQL(materiales,'traspaso_entrada',pUpdate);
        FiltrarDataSet(materiales,'Contrato,Almacen,Folio',
        [global_contrato,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('IdAlmacen').AsInteger, frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioMovimiento').AsString]);
        materiales.Open;
    end
    else
    //Entrada por Aviso de Embarque(ENAE)
    if ((connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7') and (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENAE')) then
    begin
        materiales.Active := False;
    ...
    if frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'EINI' then
    begin
         materiales.Active := False;
        AsignarSQL(materiales,'insumo_inicial_entrada',pUpdate);
        FiltrarDataSet(materiales,'Contrato,Usuario,Almacen',
        [global_contrato,global_usuario,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('IdAlmacen').AsInteger]);
        materiales.Open;
    end
    else
    begin
        ...
        clCentroC.EditValue := zCentroCosto.FieldByName('sNumeroOrden').AsString;
...
procedure TfrmAgregarMasivoOP_SS7.addEntrada;
var
...
begin
   ...
   if (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('Proviene').AsString <> 'N/A') then
   begin
      ...
      begin
         ...
         begin
            ...
            [frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('sContrato').AsString,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioMovimiento').AsInteger,
            materiales.FieldByName('IdInsumo').AsInteger,materiales.FieldByName('iFolioRequisicion').AsInteger,materiales.FieldByName('iItem').AsInteger]);

            Entradas.Open;
         end;

         //Entrada de Aviso Embarque(ENAE)
         if frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENAE' then
         begin
      ...
      //Entrada Inicial (EINI)
        ...
        asignarSQL(Entradas,'cantidad_bitacoraentrada',pUpdate);
          FiltrarDataSet(Entradas,'Contrato,Folio,Insumo,FolioReq',
          [frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('sContrato').AsString,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,
...
//            materiales.FieldByName('IdInsumo').AsInteger,materiales.FieldByName('iFolioRequisicion').AsInteger])
//          else
            FiltrarDataSet(Entradas,'Contrato,Folio,Insumo,item',
            [frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('sContrato').AsString,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,
            materiales.FieldByName('IdInsumo').AsInteger,materiales.FieldByName('iItem').AsString]);
        end;
        Entradas.Open;
      ...
      if frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EINI' then
          if (sumCantidades > CantidadPedido) and ((frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'TRAE') and (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EMAT') and (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EDEV'))then
          begin
    ...
    begin
       ...
       begin
          ...
          [global_contrato,materiales.FieldByName('IdInsumo').AsInteger,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
          frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,0]);
       end
       else
       begin
//          if Connection.uContrato.FieldByName('sMascara').AsString = 'SUBSEA 7' then
            FiltrarDataSet(Entradas,'Contrato,Insumo,Almacen,Folio,item',
            [global_contrato,materiales.FieldByName('IdInsumo').AsInteger,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
            frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,materiales.FieldByName('iItem').AsInteger])
//          else
//            FiltrarDataSet(Entradas,'Contrato,Insumo,Almacen,Folio,FolioReq',
//            [global_contrato,materiales.FieldByName('IdInsumo').AsInteger,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
//            frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,materiales.FieldByName('iFolioRequisicion').AsInteger]);
       end;
       Entradas.Open;
      try
...
//            if ((Connection.uContrato.FieldByName('sMascara').AsString = 'SUBSEA 7') then
//            begin
//              if ((Connection.uContrato.FieldByName('sMascara').AsString = 'COMPAÑIA CMMI') and (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENOC')) then
...
//                '',materiales.FieldByName('iFolioRequisicion').AsInteger]);
      ...
      begin
        ...
        begin
           ...
           FiltrarDataSet(zActualiza,'Cantidad,Contrato,Folio,Insumo,item',
           [sumCant,frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('sContrato').AsString,
           frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,
           materiales.FieldByName('IdInsumo').AsInteger,materiales.FieldByName('iItem').AsInteger]);
...
//                    if (Connection.uContrato.FieldByName('sMascara').AsString = 'SUBSEA 7')  then
                      FiltrarDataSet(Entradas,'Contrato,Folio,Insumo,FolioReq,item',
                      [frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('sContrato').AsString, frmEntradaAlmacen_SS7.almacen_entrada.FieldValues['iFolioMovimiento'],
                      materiales.FieldByName('IdInsumo').AsInteger,materiales.FieldByName('iFolioRequisicion').AsInteger,materiales.FieldByName('iItem').AsString]);
//                   else
//                    FiltrarDataSet(Entradas,'Contrato,Folio,Insumo,FolioReq,item',
//                    [frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('sContrato').AsString, frmEntradaAlmacen_SS7.almacen_entrada.FieldValues['iFolioMovimiento'],
//                    materiales.FieldByName('IdInsumo').AsInteger,materiales.FieldByName('iFolioRequisicion').AsInteger,
//                    materiales.FieldByName('iItem').AsString]);
                ...
                begin
                    ...
                    [frmEntradaAlmacen_SS7.almacen_entrada.FieldValues['iFolioMovimiento'],materiales.FieldByName('IdInsumo').AsInteger]);
                    Entradas.ExecSQL;
                end;

                //Traspaso Entrada (TRAE) o Entrada por recepcion de material (RECP)
                if (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'TRAE') or (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'RECP') then
                begin
  ...
  if (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EMAT') AND (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'TRAE') and (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EINI') then //and (frmEntradaAlmacen.almacen_entrada.FieldByName('IdTipo').AsInteger <> 3)then
  begin
    materiales.Refresh;
...
//            end;
  ...
  frmEntradaAlmacen_SS7.pEntradas.Refresh;
  frmEntradaAlmacen_SS7.almacen_entrada.RefreshRecord;
  frmEntradaAlmacen_SS7.PgControl.Enabled:=True;
  frmEntradaAlmacen_SS7.Grid_Entradas.Enabled := True;
  materiales.Refresh;

end;

procedure TfrmAgregarMasivoOP_SS7.addEntradaMasivo;
var
  CantidadPedido, CantidadEntrada, total, sumCant,
  CantidadAnterior, CantidadPosterior, sumCantidades: double;
  PosInsumo :TBookmark;
...
begin
    ...
    begin
       ...
       if (Entradas.RecordCount = 0) or ((connection.uContrato.FieldByName('FK_Titulo').AsString = 'SUBSEA 7') and
          (Entradas.RecordCount > 0)  and ((frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('Tipo').AsString = 'AVISO DE EMBARQUE') OR
          (frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('Tipo').AsString = 'AVISO DE DESEMBARQUE') ))then
       begin
          sumCant := CantidadAnterior + edtCantidad.Value ;
          zActualiza.Active := False;
...
procedure TfrmAgregarMasivoOP_SS7.addInsumosSolicitud;
...
procedure TfrmAgregarMasivoOP_SS7.addSalidaEmbarque;
var
...
procedure TfrmAgregarMasivoOP_SS7.addSalida;
var
  dActExistencia:Extended;
  zDatos :TUniQuery;
begin
    ...
    dActExistencia:=0;
      ...
      Begin
        ...
        begin
          ...
          connection.qryUBusca.ParamByName('Contrato').AsString  := global_contrato;
          connection.qryUBusca.ParamByName('Insumo').AsInteger   := materiales.FieldByName('IdInsumo').AsInteger;
          connection.qryUBusca.ParamByName('Almacen').AsInteger  := frmSalidaAlmacen_SS7.salida_almacen.FieldByName('IdAlmacen').AsInteger;
        ...
        connection.qryUBusca2.Params.ParamByName('Contrato').AsString     := frmSalidaAlmacen_SS7.salida_almacen.FieldByName('sContrato').AsString ;
        connection.qryUBusca2.Params.ParamByName('Folio').AsString        := frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioSalida').AsString ;
        connection.qryUBusca2.Params.ParamByName('Insumo').AsInteger      := Materiales.FieldByName('IdInsumo').AsInteger;
        connection.qryUBusca2.Open ;
        ...
        begin
            ...
            END
                ...
                connection.zUCommand.Params.ParamByName('Folio').AsInteger   := frmSalidaAlmacen_SS7.salida_almacen.FieldValues['iFolioSalida'] ;
                connection.zUCommand.Params.ParamByName('FechaS').AsDate     := frmSalidaAlmacen_SS7.salida_almacen.FieldValues['dFechaSalida'];
                if (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('CodigoSalida').AsString = 'SALA') or (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('CodigoSalida').AsString = 'AJIN')then
                   connection.zUCommand.Params.ParamByName('FolioReq').AsInteger := 0
                 else
                   connection.zUCommand.Params.ParamByName('FolioReq').AsInteger  := frmSalidaAlmacen_SS7.salida_almacen.FieldValues['iFolioRequisicion'];
                connection.zUCommand.Params.ParamByName('Insumo').AsInteger  := materiales.FieldValues['IdInsumo'];
                connection.zUCommand.Params.ParamByName('Cantidad').AsFloat  := edtCantidad.Value ;
                connection.zUCommand.Params.ParamByName('Almacen').AsInteger:=frmSalidaAlmacen_SS7.salida_almacen.FieldByName('IdAlmacen').AsInteger;
            end;
        ...
        begin
            if (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioRequisicion').AsInteger = 0) or (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioRequisicion').AsInteger = null)  then
            begin
      ...
      frmSalidaAlmacen_SS7.salida_detalle.Refresh;
      SavePlace := frmSalidaAlmacen_SS7.salida_detalle.GetBookmark ;
      frmSalidaAlmacen_SS7.salida_detalle.FreeBookmark(SavePlace);

      frmSalidaAlmacen_SS7.salida_detalle.Locate('IdInsumo', Materiales.FieldByName('IdInsumo').AsString, []);
      SavePlace := frmSalidaAlmacen_SS7.salida_detalle.GetBookmark ;

      IsOpen:=false;
      Try
         frmSalidaAlmacen_SS7.salida_detalle.GotoBookmark(SavePlace);
      Except
        frmSalidaAlmacen_SS7.salida_detalle.FreeBookmark(SavePlace);
      End;
      IsOpen:=true;
...
procedure TfrmAgregarMasivoOP_SS7.btnAceptarClick(Sender: TObject);
begin
...
procedure TfrmAgregarMasivoOP_SS7.btnAddClick(Sender: TObject);
begin
...
procedure TfrmAgregarMasivoOP_SS7.btnDetalleClick(Sender: TObject);
begin
  PanelDetalle.Visible:=not PanelDetalle.Visible;
  cxSplitterDetalle.Visible:= not cxSplitterDetalle.Visible;
end;

procedure TfrmAgregarMasivoOP_SS7.btnExpandirClick(Sender: TObject);
begin
...
function TfrmAgregarMasivoOP_SS7.camposLlenos() : Boolean;
var
  ban: boolean;
begin
  ban:=True;
...
procedure TfrmAgregarMasivoOP_SS7.cbFamiliaPropertiesEditValueChanged(
  Sender: TObject);
begin
...
procedure TfrmAgregarMasivoOP_SS7.cxActualizaClick(Sender: TObject);
var
...
begin
    ...
    begin
        ...
        begin
          Connection.QryUBusca.Active := False;
          Connection.QryUBusca.SQL.Clear;
          Connection.QryUBusca.SQL.Add('INSERT INTO epp_entrega_detalle (IdBitacoraSalida, IdEntregaEquipo, IdInsumo, Fecha, Cantidad, IdAlmacen) '+
          ' VALUES ((select (IFNULL(MAX(e.IdBitacoraSalida),0)+1) from epp_entrega_detalle as e), :IdEntregaEquipo, :IdInsumo, DATE(NOW()), :Cantidad, :Almacen);');
          Connection.QryUBusca.ParamByName('IdEntregaEquipo').AsInteger:=frmEntregaEquipo.zEntregaEPP.FieldByName('IdEntregaEPP').AsInteger;
          Connection.QryUBusca.ParamByName('IdInsumo').AsInteger:=materiales.FieldByName('IdInsumo').AsInteger;
          Connection.QryUBusca.ParamByName('Cantidad').AsFloat:=edtCantidad.Value;
          Connection.QryUBusca.ParamByName('Almacen').AsInteger:=frmEntregaEquipo.cxView_Requsicion.DataController.DataSet.FieldByName('IdAlmacen').AsInteger;
          Connection.QryUBusca.ExecSQL;

          frmEntregaEquipo.zMateriales.Refresh;

        end;
           if global_frmActivo ='DevolucionEPP' then
        begin
          Connection.QryUBusca.Active := False;
          Connection.QryUBusca.SQL.Clear;
          Connection.QryUBusca.SQL.Add('INSERT INTO epp_devolucion_detalle (IdBitacoraDevolucion, IdDevolucionEquipo, IdInsumo, Fecha, Cantidad, IdAlmacen) '+
          ' VALUES ((select (IFNULL(MAX(e.IdBitacoraDevolucion),0)+1) from epp_devolucion_detalle as e), :IdDevolucionEquipo, :IdInsumo, DATE(NOW()), :Cantidad, :Almacen);');
          Connection.QryUBusca.ParamByName('IdDevolucionEquipo').AsInteger:=frmDevolucionEquipo.zDevolucionEPP.FieldByName('IdDevolucionEPP').AsInteger;
          Connection.QryUBusca.ParamByName('IdInsumo').AsInteger:=materiales.FieldByName('IdInsumo').AsInteger;
          Connection.QryUBusca.ParamByName('Cantidad').AsFloat:=edtCantidad.Value;
          Connection.QryUBusca.ParamByName('Almacen').AsInteger:=frmDevolucionEquipo.cxView_Requsicion.DataController.DataSet.FieldByName('IdAlmacen').AsInteger;
          Connection.QryUBusca.ExecSQL;

          frmDevolucionEquipo.zMateriales.Refresh;
        end;
...
//          FrmSolicitudMaterial.grid_solicitud.Enabled := true;
        ...
        begin
           if frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioRequisicion').AsInteger > 0 then
    ...
    begin
      ...
      begin
         ...
         if frmEntradaAlmacen_SS7.almacen_entrada.FieldByName('IdTipo').AsInteger <> 12 then
         BEGIN
            materiales.Refresh;
            if connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7' then
            BEGIN
         ...
         END;
         frmEntradaAlmacen_SS7.pEntradas.Refresh;
         frmEntradaAlmacen_SS7.almacen_entrada.Refresh;
         frmEntradaAlmacen_SS7.PgControl.Enabled:=True;
         frmEntradaAlmacen_SS7.Grid_Entradas.Enabled := True;
      end;
...
procedure TfrmAgregarMasivoOP_SS7.cxFindWbsClick(Sender: TObject);
begin
Application.CreateForm(TfrmGridFM, frmGridFM);
  ...
  frmGridFM.cxGrid1DBTableView1.DataController.CreateItemByField(clCentroC.Properties.ListColumns[0].Field);
  frmGridFM.cxGrid1DBTableView1.Columns[0].Caption := 'Código';
  frmGridFM.cxGrid1DBTableView1.DataController.CreateItemByField(clCentroC.Properties.ListColumns[1].Field);
  ...
  if frmGridFM.ShowModal = mrOk then
      begin
      clCentroC.EditValue:=frmGridFM.cxGrid1DBTableView1.DataController.DataSource.DataSet.FieldByName('sNumeroOrden').Value;
      end;
end;

procedure TfrmAgregarMasivoOP_SS7.cxGuardiasPropertiesChange(Sender: TObject);
begin
  if global_frmActivo = 'Entrada_Almacen' then
  begin
    View_Grid_MaterialesFechaCosto.Visible:=False;
...
procedure TfrmAgregarMasivoOP_SS7.cxPageCostosChange(Sender: TObject);
begin
  ...
  if cxPageCostos.ActivePage = cxTabExist_CC then
  begin
    AsignarSQL(zMaterialCC,'existencia_cc_partida',pUpdate);
    FiltrarDataSet(zMaterialCC,'Insumo',[materiales.FieldByName('IdInsumo').AsString]);
    zMaterialCC.Open;
  end;

end;

procedure TfrmAgregarMasivoOP_SS7.cxTabCosto_OCShow(Sender: TObject);
begin
  if materiales.Active then
    ScrollMateriales;
end;

procedure TfrmAgregarMasivoOP_SS7.cxTabcosto_PUShow(Sender: TObject);
begin
  if materiales.Active then
    ScrollMateriales;
end;

procedure TfrmAgregarMasivoOP_SS7.dtbCancelarClick(Sender: TObject);
begin
 Close;
end;
...
procedure TfrmAgregarMasivoOP_SS7.FormShow(Sender: TObject);
begin
  id:='-1';
  ...
  IsOpen:=False;
    ...
    if global_frmActivo = 'Entrada_Almacen' then
    begin
      cxLabelOrigen.Caption := '('+frmEntradaAlmacen_SS7.cxAlmacen.Text+')';
      selectEntradas;
    end
    else
    ...
    begin
      ...
      FiltrarDataSet(materiales,'Contrato',
      [global_contrato]);//frmSolicitudDeMateriales.zAvisosEmbarque.FieldByName('iFolioEntrada').AsInteger]);
      materiales.Open;
...
//      end;
    ...
    if (global_frmActivo = 'EntregaEPP') or (global_frmActivo = 'DevolucionEPP') then
    begin
         materiales.Active := False;
         AsignarSQL(materiales,'alm_insumos_epp',pUpdate);
         FiltrarDataSet(materiales,'Usuario,Codigo',[global_usuario,'-1']);
         materiales.Open;
  ...
  if (global_frmActivo <> 'EntregaEPP') and (global_frmActivo <> 'DevolucionEPP') then
  cxTabExist_CC.TabVisible := False;
...
procedure TfrmAgregarMasivoOP_SS7.frmBarra1btnExitClick(Sender: TObject);
begin
   Close;
end;

procedure  TfrmAgregarMasivoOP_SS7.SelectSalidas();
begin
...
//        AsignarSQL(materiales,'catalogo_agregarmasivo_salidaembarque',pUpdate);
//         FiltrarDataSet(materiales,'Contrato,Usuario,Almacen',
//         [global_contrato,Global_Usuario,frmSalidaAlmacen_SS7.salida_almacen.FieldByName('IdAlmacen').AsInteger]);
//         materiales.Open;
//    END
//    ELSE
//    BEGIN
//    if(assigned(frmAvisoEmbarque)) then begin
      if ((connection.uContrato.FieldByName('FK_Titulo').AsString='CMMI') and (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('CodigoSalida').AsString = 'AJS')) or
         ((connection.uContrato.FieldByName('FK_Titulo').AsString='CMMI') and (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('CodigoSalida').AsString = 'SALA'))then
      BEGIN
          AsignarSQL(materiales,'catalogo_agregarmasivo',pUpdate);
    ...
    if (connection.uContrato.FieldByName('FK_Titulo').AsString='SIANI') then  BEGIN
      if not(frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioRequisicion').IsNull)  then
      begin
       noAplica:=True;
       AsignarSQL(materiales,'OC_lista_materiales_req',pUpdate);
       FiltrarDataSet(materiales,'Contrato,FolioReq',[global_contrato,frmSalidaAlmacen_SS7.salida_almacen.FieldValues['iFolioRequisicion']]);
      end
      else
      begin
         noAplica:=False;
    ...
    END
    else if (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('CodigoSalida').AsString = 'SOLM') then begin
        ...
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SS7.salida_almacen.FieldByName('IdAlmacen').AsInteger, frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioSolicitud').AsInteger]);
    end
    else if (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('CodigoSalida').AsString = 'TRAS') and
            (connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7') then begin
        AsignarSQL(materiales,'catalogo_agregarmasivo_salidaembarque',pUpdate);
        FiltrarDataSet(materiales,'Contrato,Usuario,Almacen',
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SS7.salida_almacen.FieldByName('IdAlmacen').AsInteger]);
    end
    else if (frmSalidaAlmacen_SS7.salida_almacen.FieldByName('CodigoSalida').AsString = 'SALA') and
             (connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7') then begin
        ...
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SS7.salida_almacen.FieldByName('IdAlmacen').AsInteger, frmSalidaAlmacen_sS7.salida_almacen.FieldByName('iFolioEntrada').AsInteger]);
    end
    ELSE
    begin
        cxLabelOrigen.Visible := True;
        cxLabelOrigen.Caption := '('+frmSalidaAlmacen_SS7.cxAlmacen.Text+')';
        AsignarSQL(materiales,'catalogo_agregarmasivo_salida',pUpdate);
        FiltrarDataSet(materiales,'Contrato,Usuario,Almacen,FolioReq',
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SS7.salida_almacen.FieldByName('IdAlmacen').AsInteger, frmSalidaAlmacen_SS7.salida_almacen.FieldByName('iFolioRequisicion').AsInteger]);
    end;
    materiales.Open;
...
procedure TfrmAgregarMasivoOP_SS7.frmBarraH11btnEditClick(Sender: TObject);
begin
  if global_frmActivo = 'Costos' then
  begin
    Connection.QryUBusca.Active := False;
...
procedure TfrmAgregarMasivoOP_SS7.ScrollMateriales;
begin
  if not assigned(frmAvisoEmbarque) then begin
   ...
   if (panelDEtalle.Visible = true) and (cxPageCostos.ActivePage = cxTabExist_CC) then
    begin
      AsignarSQL(zMaterialCC,'existencia_cc_partida',pUpdate);
      FiltrarDataSet(zMaterialCC,'Insumo',[materiales.FieldByName('IdInsumo').AsString]);
      zMaterialCC.Open;
...
procedure TfrmAgregarMasivoOP_SS7.SelectMaterial;
begin
...
procedure TfrmAgregarMasivoOP_SS7.View_Grid_MaterialesCellClick(
...
procedure TfrmAgregarMasivoOP_SS7.View_Grid_MaterialesCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmAgregarMasivoOP_SS7.View_Grid_MaterialesKeyUp(Sender: TObject;
