object frmAgregarMasivoOP_SS7: TfrmAgregarMasivoOP_SS7
  Left = 406
  Top = 268
  AlphaBlend = True
  Anchors = []
  ...
  object Panel5: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object View_Grid_Materiales: TcxGridDBTableView
        OnKeyUp = View_Grid_MaterialesKeyUp
  ...
  object PanelDetalle: TPanel
    ...
    object cxPageCostos: TcxPageControl
      ...
      ParentFont = False
      TabOrder = 0
      Properties.ActivePage = cxTabCosto_OC
      ...
      object cxTabExist_CC: TcxTabSheet
        Caption = 'Existencias por CC'
        ImageIndex = 2
        object cxGridExistencias: TcxGrid
          Left = 0
          Top = 0
          Width = 218
          Height = 316
          Align = alClient
          TabOrder = 0
          object cxGridExist_cc: TcxGridDBTableView
            Navigator.Buttons.CustomButtons = <>
            DataController.DataSource = dsMaterialCC
            DataController.Summary.DefaultGroupSummaryItems = <>
            DataController.Summary.FooterSummaryItems = <>
            DataController.Summary.SummaryGroups = <>
            ...
            OptionsView.ColumnAutoWidth = True
            OptionsView.GroupByBox = False
            object cxGridExist_ccColumn1: TcxGridDBColumn
              Caption = 'Centro Costo'
              DataBinding.FieldName = 'sIdFolio'
              Width = 60
            end
            object cxGridExist_ccColumn2: TcxGridDBColumn
              Caption = 'Existencia'
              DataBinding.FieldName = 'dExistencia'
              Width = 50
            end
          end
          object cxGridExistenciasLevel1: TcxGridLevel
            GridView = cxGridExist_cc
          end
        end
      end
    end
  ...
  object Panel6: TPanel
    ...
    object dxLayoutControl3: TdxLayoutControl
      ...
      object clCentroC: TcxLookupComboBox
        Left = 714
        Top = 11
        ParentFont = False
      ...
      object dxLayoutItem16: TdxLayoutItem
        ...
        AlignHorz = ahClient
        AlignVert = avTop
        CaptionOptions.Text = 'Centro Costo'
        Visible = False
        Control = clCentroC
        ControlOptions.ShowBorder = False
        Index = 6
  ...
  object dsMaterialCC: TDataSource
    DataSet = zMaterialCC
    Left = 860
    Top = 233
  end
  object zMaterialCC: TUniQuery
    Left = 884
    Top = 305
  end
end
