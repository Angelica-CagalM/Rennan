...
type
  TfrmAgregarMasivoOP_SSI = class(TForm)
    mnuPop: TPopupMenu;
    Insertar1: TMenuItem;
    Editar1: TMenuItem;
    N1: TMenuItem;
    ...
    cxLabel5: TcxLabel;
    dsBitEntrada: TDataSource;
    zBitEntrada: TUniQuery;
    zBitEntradaCambio: TFloatField;
...
var
  frmAgregarMasivoOP_SSI : TfrmAgregarMasivoOP_SSI;
  sOldId           : string;
  sOpcion          : string;
  Parametro        : string;
  Id               : string;
  ...
  implementation
 uses
    frm_catalogos_Operaciones,Frm_CostoPresupuesto,Frm_RequisicionMaterial,frm_SalidaAlmacen_SSI,frm_AvisoEmbarque,
  frm_EntradaAlmacen_SSI,frm_Existencia, Frm_SolicitudMaterial, frm_SolicitudDeMateriales,Func_Genericas;

{$R *.dfm}


procedure TfrmAgregarMasivoOP_SSI.addAsignacion;
begin
   zAsigna.SQL.Text:='select IdVale From vale_resguardo where IdSalida = :Salida';
   zAsigna.ParamByName('Salida').AsString:= frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioSalida').AsString;
   zAsigna.Open;
   ...
   begin
      ...
      zAnterior.ParamByName('Fecha').AsDate := frmSalidaAlmacen_SSI.salida_almacen.FieldByName('dFechaSalida').AsDateTime;
...
procedure TfrmAgregarMasivoOP_SSI.addRequisicon;
Var
  SavePlace : TBookmark;
...
Procedure TfrmAgregarMasivoOP_SSI.SelectEntradas;
begin
    //Entrada de Orden de Compra(ENOC)
    if frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENOC' then
    begin
        ...
        [global_contrato,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioMovimiento').AsInteger,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger]);
        materiales.Open;
    ...
    if (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'TRAE') or (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'RECP') or (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'EDEV')then
    begin
        materiales.Active := False;
        AsignarSQL(materiales,'traspaso_entrada',pUpdate);
        FiltrarDataSet(materiales,'Contrato,Almacen,Folio',
        [global_contrato,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger, frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioMovimiento').AsString]);
        materiales.Open;
    end
    else
    //Entrada por Aviso de Embarque(ENAE)
    if ((connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7') and (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENAE')) then
    begin
        materiales.Active := False;
    ...
    if frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'EINI' then
    begin
         materiales.Active := False;
        AsignarSQL(materiales,'insumo_inicial_entrada',pUpdate);
        FiltrarDataSet(materiales,'Contrato,Usuario,Almacen',
        [global_contrato,global_usuario,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger]);
        materiales.Open;
    end
    else
    begin
...
procedure TfrmAgregarMasivoOP_SSI.addEntrada;
var
...
begin
   ...
   if (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('Proviene').AsString <> 'N/A') then
   begin
      ...
      begin
         ...
         begin
           if connection.uContrato.FieldByName('FK_Titulo').AsString='TYPHOON' then
            begin
             ...
             [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioMovimiento').AsInteger,
         ...
         if frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENAE' then
         begin
       ...
       (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'ENOC')then
       BEGIN

           Entradas.Active := False;
           asignarSQL(Entradas,'cant_bitacoraentrada_pedido',pUpdate);
           FiltrarDataSet(Entradas,'Contrato,Folio,Insumo,FolioCompra,item',
           [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,
      ...
      if frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EINI' then
          if (sumCantidades > CantidadPedido) and ((frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'TRAE') and (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EMAT') and (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EDEV'))then
          begin
    ...
    begin
       ...
       if (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'EINI') or (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('Proviene').AsString = 'N/A') or (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('Proviene').AsString = ' S / R ') then
       begin
          FiltrarDataSet(Entradas,'Contrato,Insumo,Almacen,Folio,FolioReq',
          [global_contrato,materiales.FieldByName('IdInsumo').AsInteger,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
          frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,0]);
       end
       else
       begin
          if Connection.uContrato.FieldByName('sMascara').AsString = 'SUBSEA 7' then
            ...
            [global_contrato,materiales.FieldByName('IdInsumo').AsInteger,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
            frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioEntrada').AsInteger])
          else
            FiltrarDataSet(Entradas,'Contrato,Insumo,Almacen,Folio,FolioReq',
            [global_contrato,materiales.FieldByName('IdInsumo').AsInteger,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
            frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,materiales.FieldByName('iFolioRequisicion').AsInteger]);
       end;
       Entradas.Open;
      ...
      try
        ...
        sumCant := CantidadAnterior + edtCantidad.Value ;
          ...
          begin
            ...
            [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsVariant,
            0,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,
            materiales.FieldByName('IdInsumo').AsInteger,
            FechaSQL(frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['dFechaEntrega']),edtCantidad.Value,
            CantidadAnterior,sumCant,
            frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,'',0])
          end
          else begin
            if ((Connection.uContrato.FieldByName('sMascara').AsString = 'SUBSEA 7') or (Connection.uContrato.FieldByName('sMascara').AsString = 'COMPAÑIA CMMI')) then
                ...
                [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString,0,frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['iFolioEntrada'],
                materiales.FieldByName('IdInsumo').AsInteger,FechaSQL(frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['dFechaEntrega']),edtCantidad.Value,
                CantidadAnterior,sumCant,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
                ''])
            else
                FiltrarDataSet(zActualiza,'Contrato,Item,Folio,Insumo,FechaE,Cantidad,CantidadAnterior,CantidadTotal,IdAlmacen,Comentario,FolioReq',
                [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString,materiales.FieldByName('iItem').AsInteger,frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['iFolioEntrada'],
                materiales.FieldByName('IdInsumo').AsInteger,FechaSQL(frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['dFechaEntrega']),edtCantidad.Value,
                CantidadAnterior,sumCant,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
      ...
      begin
        ...
        begin
           ...
           [sumCant,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString,
           frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,
           materiales.FieldByName('IdInsumo').AsInteger]);
           zActualiza.ExecSQL;
           lContinua := True;
            ...
            begin
              ...
              begin
                ...
                begin
                    ...
                    if ((Connection.uContrato.FieldByName('sMascara').AsString = 'SUBSEA 7') or (Connection.uContrato.FieldByName('sMascara').AsString = 'COMPAÑIA CMMI')) then
                      FiltrarDataSet(Entradas,'Contrato,Folio,Insumo,FolioReq',
                      [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString, frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['iFolioMovimiento'],
                      materiales.FieldByName('IdInsumo').AsInteger,materiales.FieldByName('iFolioRequisicion').AsInteger])
                   else
                ...
                begin
                    ...
                    [frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['iFolioMovimiento'],materiales.FieldByName('IdInsumo').AsInteger]);
                    Entradas.ExecSQL;
                end;

                //Traspaso Entrada (TRAE) o Entrada por recepcion de material (RECP)
                if (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'TRAE') or (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString = 'RECP') then
                begin
  ...
  if (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EMAT') AND (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'TRAE') and (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('CodigoEntrada').AsString <> 'EINI') then //and (frmEntradaAlmacen.almacen_entrada.FieldByName('IdTipo').AsInteger <> 3)then
  begin
    materiales.Refresh;
  ...
  frmEntradaAlmacen_SSI.pEntradas.Refresh;
  frmEntradaAlmacen_SSI.almacen_entrada.RefreshRecord;
  frmEntradaAlmacen_SSI.PgControl.Enabled:=True;
  frmEntradaAlmacen_SSI.Grid_Entradas.Enabled := True;

end;

procedure TfrmAgregarMasivoOP_SSI.addEntradaMasivo;
var
  CantidadPedido, CantidadEntrada, total, sumCant,
  CantidadAnterior, CantidadPosterior, sumCantidades: double;
  PosInsumo :TBookmark;
...
begin
    ...
    begin
       ...
       if (Entradas.RecordCount = 0) or ((connection.uContrato.FieldByName('FK_Titulo').AsString = 'SUBSEA 7') and
          (Entradas.RecordCount > 0)  and ((frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('Tipo').AsString = 'AVISO DE EMBARQUE') OR
          (frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('Tipo').AsString = 'AVISO DE DESEMBARQUE') ))then
       begin
          sumCant := CantidadAnterior + edtCantidad.Value ;
          zActualiza.Active := False;
          ...
          begin
            ...
            0,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('iFolioEntrada').AsInteger,
            materiales.FieldByName('IdInsumo').AsInteger,
            FechaSQL(frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['dFechaEntrega']),materiales.FieldByName('dCantidadPendiente').AsFloat,
          ...
          begin
            if connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7' then
              ...
              [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString,'0',frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['iFolioEntrada'],
              materiales.FieldByName('IdInsumo').AsInteger,FechaSQL(frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['dFechaEntrega']),materiales.FieldByName('dCantidadPendiente').AsFloat,
              materiales.FieldByName('dCantidad').AsFloat,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
              ''])
            else
              FiltrarDataSet(zActualiza,'Contrato,Item,Folio,Insumo,FechaE,Cantidad,CantidadAnterior,CantidadTotal,IdAlmacen,Comentario,FolioReq',
              [frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('sContrato').AsString,'0',frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['iFolioEntrada'],
              materiales.FieldByName('IdInsumo').AsInteger,FechaSQL(frmEntradaAlmacen_SSI.almacen_entrada.FieldValues['dFechaEntrega']),materiales.FieldByName('dCantidadPendiente').AsFloat,
              materiales.FieldByName('dCantidadRecibida').AsFloat,materiales.FieldByName('dCantidad').AsFloat,frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdAlmacen').AsInteger,
              '',materiales.FieldByName('iFolioRequisicion').AsInteger]);
          end;
...
procedure TfrmAgregarMasivoOP_SSI.addInsumosSolicitud;
...
procedure TfrmAgregarMasivoOP_SSI.addSalidaEmbarque;
var
...
procedure TfrmAgregarMasivoOP_SSI.addSalidaSolicitudMateriales;
var
  dActExistencia:Extended;
begin
  dActExistencia:=0;
...
procedure TfrmAgregarMasivoOP_SSI.addSalida;
var
  dActExistencia:Extended;
  zDatos :TUniQuery;
begin
    ...
    dActExistencia:=0;
      ...
      Begin
        ...
        begin
          ...
          connection.qryUBusca.ParamByName('Contrato').AsString  := global_contrato;
          connection.qryUBusca.ParamByName('Insumo').AsInteger   := materiales.FieldByName('IdInsumo').AsInteger;
          connection.qryUBusca.ParamByName('Almacen').AsInteger  := frmSalidaAlmacen_SSI.salida_almacen.FieldByName('IdAlmacen').AsInteger;
        ...
        connection.qryUBusca2.Params.ParamByName('Contrato').AsString     := frmSalidaAlmacen_SSI.salida_almacen.FieldByName('sContrato').AsString ;
        connection.qryUBusca2.Params.ParamByName('Folio').AsString        := frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioSalida').AsString ;
        connection.qryUBusca2.Params.ParamByName('Insumo').AsInteger      := Materiales.FieldByName('IdInsumo').AsInteger;
        connection.qryUBusca2.Open ;
        ...
        begin
            ...
            BEGIN
                ...
                connection.zUCommand.Params.ParamByName('Contrato').AsString := frmSalidaAlmacen_SSI.salida_almacen.FieldByName('sContrato').AsString ;
                connection.zUCommand.Params.ParamByName('Folio').AsInteger   := frmSalidaAlmacen_SSI.salida_almacen.FieldValues['iFolioSalida'] ;
                connection.zUCommand.Params.ParamByName('FechaS').AsDate     := frmSalidaAlmacen_SSI.salida_almacen.FieldValues['dFechaSalida'];
                connection.zUCommand.Params.ParamByName('Insumo').AsInteger  := materiales.FieldValues['IdInsumo'];
                connection.zUCommand.Params.ParamByName('Cantidad').AsFloat  := edtCantidad.Value ;
                connection.zUCommand.Params.ParamByName('Almacen').AsInteger:=frmSalidaAlmacen_SSI.salida_almacen.FieldByName('IdAlmacen').AsInteger;
            END
            else begin
                ...
                connection.zUCommand.Params.ParamByName('Folio').AsInteger   := frmSalidaAlmacen_SSI.salida_almacen.FieldValues['iFolioSalida'] ;
                connection.zUCommand.Params.ParamByName('FechaS').AsDate     := frmSalidaAlmacen_SSI.salida_almacen.FieldValues['dFechaSalida'];
                if (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('CodigoSalida').AsString = 'SALA') or (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('CodigoSalida').AsString = 'AJIN')then
                   connection.zUCommand.Params.ParamByName('FolioReq').AsInteger := 0
                 else
                   connection.zUCommand.Params.ParamByName('FolioReq').AsInteger  := frmSalidaAlmacen_SSI.salida_almacen.FieldValues['iFolioRequisicion'];
                connection.zUCommand.Params.ParamByName('Insumo').AsInteger  := materiales.FieldValues['IdInsumo'];
                connection.zUCommand.Params.ParamByName('Cantidad').AsFloat  := edtCantidad.Value ;
                connection.zUCommand.Params.ParamByName('Almacen').AsInteger:=frmSalidaAlmacen_SSI.salida_almacen.FieldByName('IdAlmacen').AsInteger;
            end;
        ...
        begin
            if (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioRequisicion').AsInteger = 0) or (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioRequisicion').AsInteger = null)  then
            begin
      ...
      frmSalidaAlmacen_SSI.salida_detalle.Refresh;
      SavePlace := frmSalidaAlmacen_SSI.salida_detalle.GetBookmark ;
      frmSalidaAlmacen_SSI.salida_detalle.FreeBookmark(SavePlace);

      frmSalidaAlmacen_SSI.salida_detalle.Locate('IdInsumo', Materiales.FieldByName('IdInsumo').AsString, []);
      SavePlace := frmSalidaAlmacen_SSI.salida_detalle.GetBookmark ;

      IsOpen:=false;
      Try
         frmSalidaAlmacen_SSI.salida_detalle.GotoBookmark(SavePlace);
      Except
        frmSalidaAlmacen_SSI.salida_detalle.FreeBookmark(SavePlace);
      End;
      IsOpen:=true;
...
procedure TfrmAgregarMasivoOP_SSI.btnAceptarClick(Sender: TObject);
begin
    ...
    Connection.QryUBusca.FieldByName('dTalla').AsString:=edtNumero.Text;
     if cbMarca.Text = '' then
       Connection.QryUBusca.FieldByName('IdMarca').AsInteger:=0
    else
...
procedure TfrmAgregarMasivoOP_SSI.btnAddClick(Sender: TObject);
begin
...
procedure TfrmAgregarMasivoOP_SSI.btnDetalleClick(Sender: TObject);
begin
  PanelDetalle.Visible:=not PanelDetalle.Visible;
  cxSplitterDetalle.Visible:= not cxSplitterDetalle.Visible;
end;

procedure TfrmAgregarMasivoOP_SSI.btnExpandirClick(Sender: TObject);
begin
...
function TfrmAgregarMasivoOP_SSI.camposLlenos() : Boolean;
var
  ban: boolean;
begin
  ban:=True;
...
procedure TfrmAgregarMasivoOP_SSI.cbFamiliaPropertiesEditValueChanged(
  Sender: TObject);
begin
...
procedure TfrmAgregarMasivoOP_SSI.cxActualizaClick(Sender: TObject);
var
...
//          FrmSolicitudMaterial.grid_solicitud.Enabled := true;
        ...
        begin
           ...
           if ((View_Grid_Materiales.DataController.GetSelectedCount > 0 ) and (PanelNuevoMaterial.Visible = False))then
           begin
               Connection.QryUBusca.Active := False;
               Connection.QryUBusca.SQL.Clear;
...
//           cxCantidad.Value:=0.0;
        ...
        begin
           if frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioRequisicion').AsInteger > 0 then
    ...
    begin
      ...
      begin
         ...
         if frmEntradaAlmacen_SSI.almacen_entrada.FieldByName('IdTipo').AsInteger <> 12 then
         BEGIN
            materiales.Refresh;
            if connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7' then
            BEGIN
         ...
         END;
         frmEntradaAlmacen_SSI.pEntradas.Refresh;
         frmEntradaAlmacen_SSI.almacen_entrada.Refresh;
         frmEntradaAlmacen_SSI.PgControl.Enabled:=True;
         frmEntradaAlmacen_SSI.Grid_Entradas.Enabled := True;
      end;
...
//    if ((View_Grid_Materiales.DataController.GetSelectedCount  = 0) and (PanelNuevoMaterial.Visible = True)) then
   if PanelNuevoMaterial.Visible then
    begin
        if not (cbMarca.EditValue=null) then begin
          Connection.QryUBusca.Active := False;
          Connection.QryUBusca.SQL.Clear;
        ...
        MessageDlg('Existen datos vacios: Marca',mtInformation,[mbOk],0);
    end;
...
procedure TfrmAgregarMasivoOP_SSI.cxGuardiasPropertiesChange(Sender: TObject);
begin
  if global_frmActivo = 'Entrada_Almacen' then
  begin
    View_Grid_MaterialesFechaCosto.Visible:=False;
...
procedure TfrmAgregarMasivoOP_SSI.cxPageCostosChange(Sender: TObject);
begin
...
procedure TfrmAgregarMasivoOP_SSI.cxTabCosto_OCShow(Sender: TObject);
begin
  if materiales.Active then
    ScrollMateriales;
end;

procedure TfrmAgregarMasivoOP_SSI.cxTabcosto_PUShow(Sender: TObject);
begin
  if materiales.Active then
    ScrollMateriales;
end;

procedure TfrmAgregarMasivoOP_SSI.dtbCancelarClick(Sender: TObject);
begin
 //frmEntradaAlmacen_SSI.pEntradas.refresh;
 Close;
end;
...
procedure TfrmAgregarMasivoOP_SSI.FormShow(Sender: TObject);
begin
  id:='-1';
...
//    if(assigned(frmAvisoEmbarque)) then begin
      if ((connection.uContrato.FieldByName('FK_Titulo').AsString='CMMI') and (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('CodigoSalida').AsString = 'AJS')) or
         ((connection.uContrato.FieldByName('FK_Titulo').AsString='CMMI') and (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('CodigoSalida').AsString = 'SALA'))then
      BEGIN
    ...
    if (connection.uContrato.FieldByName('FK_Titulo').AsString='SIANI') then  BEGIN
      if not((frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioRequisicion').IsNull) or
            (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioRequisicion').AsInteger = 0)) then begin
         noAplica:=True;
         AsignarSQL(materiales,'OC_lista_materiales_req',pUpdate);
         FiltrarDataSet(materiales,'Contrato,FolioReq',[global_contrato,frmSalidaAlmacen_SSI.salida_almacen.FieldValues['iFolioRequisicion']]);
      end
      else
      begin
         noAplica:=False;
    ...
    END
    else if (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('CodigoSalida').AsString = 'SOLM') then begin
        ...
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SSI.salida_almacen.FieldByName('IdAlmacen').AsInteger, frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioSolicitud').AsInteger]);
    end
    else if (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('CodigoSalida').AsString = 'TRAS') and
        ...
        FiltrarDataSet(materiales,'Contrato,Usuario,Almacen',
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SSI.salida_almacen.FieldByName('IdAlmacen').AsInteger]);
    end
    else if (frmSalidaAlmacen_SSI.salida_almacen.FieldByName('CodigoSalida').AsString = 'SALA') and
             (connection.uContrato.FieldByName('FK_Titulo').AsString='SUBSEA 7') then begin
        ...
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SSI.salida_almacen.FieldByName('IdAlmacen').AsInteger, frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioEntrada').AsInteger]);
    end
    ELSE
    begin
        cxLabelOrigen.Visible := True;
        cxLabelOrigen.Caption := '('+frmSalidaAlmacen_SSI.cxAlmacen.Text+')';
        AsignarSQL(materiales,'catalogo_agregarmasivo_salida',pUpdate);
        FiltrarDataSet(materiales,'Contrato,Usuario,Almacen,FolioReq',
        [global_contrato,Global_Usuario,frmSalidaAlmacen_SSI.salida_almacen.FieldByName('IdAlmacen').AsInteger, frmSalidaAlmacen_SSI.salida_almacen.FieldByName('iFolioRequisicion').AsInteger]);
    end;
    materiales.Open;
  ...
  END
    ...
    if global_frmActivo = 'Entrada_Almacen' then
    begin
      cxLabelOrigen.Caption := '('+frmEntradaAlmacen_SSI.cxAlmacen.Text+')';
      selectEntradas;
//       AsignarSQL(zBitEntrada,'bitacora_entrada_cambio',pUpdate);
//       FiltrarDataSet(zBitEntrada,'Contrato,IdBitacora',[frmEntradaAlmacen_SSI.pEntradas.FieldByName('sContrato').AsString,frmEntradaAlmacen_SSI.pEntradas.FieldByName('IdBitacoraEntrada').AsString]);
//        zBitEntrada.open;
        cxTipoCambio.visible:=true;
        cxTipoCambio.Value:=1;
    end
    else
...
procedure TfrmAgregarMasivoOP_SSI.frmBarra1btnExitClick(Sender: TObject);
begin
   Close;
end;

procedure TfrmAgregarMasivoOP_SSI.frmBarraH11btnEditClick(Sender: TObject);
begin
  if global_frmActivo = 'Costos' then
  begin
    Connection.QryUBusca.Active := False;
...
procedure TfrmAgregarMasivoOP_SSI.ScrollMateriales;
begin
...
procedure TfrmAgregarMasivoOP_SSI.SelectMaterial;
begin
...
procedure TfrmAgregarMasivoOP_SSI.View_Grid_MaterialesCellClick(
...
procedure TfrmAgregarMasivoOP_SSI.View_Grid_MaterialesCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmAgregarMasivoOP_SSI.View_Grid_MaterialesKeyUp(Sender: TObject;
