unit frm_catalogo_empleados_SSI;
...
type
  TfrmCatalogoEmpleadosSSI = class(TForm)
...
var
  ...
  OpcButton1    : String ;
  frmCatalogoEmpleadosSSI: TfrmCatalogoEmpleadosSSI;
...
uses
  ...
  frm_reportesRH, frm_deptos,Frm_FechaVigencia, frm_salarios, frm_firmasNota,frm_Presupuesto;
var
        objNBioBSP    : variant;
        objDevice     : variant;
...
procedure TfrmCatalogoEmpleadosSSI.GlobalKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmCatalogoEmpleadosSSI.lcbFirmaEnter(Sender: TObject);
begin
  zGuardaFirma.Append;
  zGuardaFirma.FieldByName('IdFirma').AsInteger := zFirma.FieldByName('IdFirma').AsInteger;
  zGuardaFirma.FieldByName('NombreForm').AsString := frmCatalogoEmpleadosSSI.Caption;
  zGuardaFirma.FieldByName('Boton').AsString := btnSoldadores.Caption;
end;

procedure TfrmCatalogoEmpleadosSSI.MenuMoverClick(Sender: TObject);
...
procedure TfrmCatalogoEmpleadosSSI.PanelDetalleClick(Sender: TObject);
var
  tem:TUniQuery;
begin
...
procedure TfrmCatalogoEmpleadosSSI.personalAfterScroll(DataSet: TDataSet);
begin
  if IsOpen then
  begin
...
procedure TfrmCatalogoEmpleadosSSI.EnterControl(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmCatalogoEmpleadosSSI.Timer1Timer(Sender: TObject);
begin
{    if (Flap = True) then
    begin
...
procedure TfrmCatalogoEmpleadosSSI.VistaPrevia1Click(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.zEmpresaAfterScroll(DataSet: TDataSet);
begin
...
procedure TfrmCatalogoEmpleadosSSI.FormShow(Sender: TObject);
var tem:TUniQuery;
begin
  ...
  FiltrarDataSet(zEmpresa,'IdEmpresa,bIdEmpresa,IdPadre',['-1','-1','-1']);
  zEmpresa.Open;
  ...
  FiltrarDataSet(personal, 'Empresa',[zEmpresa.FieldByName('IdEmpresa').AsInteger])
  else
  personal.ParamByName('Empresa').AsInteger    := zEmpresa.FieldByName('IdEmpresa').AsInteger;
  ...
  guardar_leer_grid(BView_empresa,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(CxGridMoePersonal,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxGridViewPuesto,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxGrid1DBTableView1,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxViewContacto,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxViewBanco,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxGrid2DBTableView1,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(gridComentariosDBTableView1,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxViewDocumentos,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxGridEPPDBTableView1,frmCatalogoEmpleadosSSI,0);
  guardar_leer_grid(cxGridViewCurso,frmCatalogoEmpleadosSSI,0);
  PermisosBotones(frmCatalogoEmpleadosSSI,btnPermisos);
...
procedure TfrmCatalogoEmpleadosSSI.frxReportCRGetValue(const VarName: string;
  var Value: Variant);
var dat:String;
begin
  dat:=stringreplace(edtSDI.Text, '$', ' ',[rfReplaceAll, rfIgnoreCase]);
  if CompareText(VarName, 'CANTIDAD_LETRA') = 0 then
  begin
    if edtSDI.Text <> '' then
    begin
      Value := LetraMontos('MXN','PESOS', strtofloat(dat) );
    end
    else
    begin
  ...
  if CompareText(VarName, 'SDI') = 0 then
  begin
    if edtSDI.Text <> '' then
    begin
      Value := strtofloat(dat);
    end
    else
    begin
     Value := Contrato.FieldByName('SDI').AsString;
    end;

  end;

  if CompareText(VarName, 'EMPRESA') = 0 then
  begin
    Value := zEmpresa.FieldByName('FK_titulo').AsString;
  end;
end;

procedure TfrmCatalogoEmpleadosSSI.frxReporteGetValue(const VarName: string;
  var Value: Variant);
begin
...
procedure TfrmCatalogoEmpleadosSSI.Actualizar1Click(Sender: TObject);
...
procedure TfrmCatalogoEmpleadosSSI.ActualizarPersonal(IdPersonal: String;
  IdEmpresa: Integer);
var
...
procedure TfrmCatalogoEmpleadosSSI.btnAddClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnAutorizarClick(Sender: TObject);
begin
  try
...
procedure TfrmCatalogoEmpleadosSSI.btnCancelClick(Sender: TObject);
begin
  close;
end;

procedure TfrmCatalogoEmpleadosSSI.btnCargarClick(Sender: TObject);
var
  size: Real;
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnEditClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnEliminarDetalleClick(Sender: TObject);
begin
   if cxPageDetalle.ActivePage = cxTabDocumentos then
   begin
     AsignarSQL(doctoVP,'docto_empleadoVP',pUpdate);
...
procedure TfrmCatalogoEmpleadosSSI.btnFirmaClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnImpInformeClick(Sender: TObject);
var
  empGrid: String;
...
procedure TfrmCatalogoEmpleadosSSI.btnModificacionesClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnMostrarClick(Sender: TObject);
begin
  personal.Active := False;
  personal.ParamByName('Empresa').AsInteger := zEmpresa.FieldByName('IdEmpresa').AsInteger;
...
procedure TfrmCatalogoEmpleadosSSI.btnRefreshClick(Sender: TObject);
begin
   personal.Refresh;
   personal.Refresh;
end;

procedure TfrmCatalogoEmpleadosSSI.BView_empresaCellClick(
...
procedure TfrmCatalogoEmpleadosSSI.BView_empresaDblClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.BView_empresaMouseDown(Sender: TObject;
...
procedure TfrmCatalogoEmpleadosSSI.FormClose(Sender: TObject;
...
begin
  ...
  guardar_leer_grid(BView_empresa,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(CxGridMoePersonal,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxGridViewPuesto,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxGrid1DBTableView1,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxViewContacto,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxViewBanco,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxGrid2DBTableView1,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(gridComentariosDBTableView1,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxViewDocumentos,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxGridEPPDBTableView1,frmCatalogoEmpleadosSSI,1);
  guardar_leer_grid(cxGridViewCurso,frmCatalogoEmpleadosSSI,1);
  action := cafree;
end;

procedure TfrmCatalogoEmpleadosSSI.cbFechaFExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cbFechaIExit(Sender: TObject);
begin
  if (not VarIsNull(Contratos.FieldByName('FechaInicio').AsDateTime)) and (not VarIsNull(Contratos.FieldByName('FechaFinal').AsDateTime)) then begin
    cxDuracion.EditValue:=trunc(Contratos.FieldByName('FechaFinal').AsDateTime - Contratos.FieldByName('FechaInicio').AsDateTime)+1;
  end;
...
procedure TfrmCatalogoEmpleadosSSI.cbtem1Exit(Sender: TObject);
begin
  puesto_empleado.FieldByName('Divicion').ASString:=cbtem1.Text;
end;

procedure TfrmCatalogoEmpleadosSSI.cbtem2Exit(Sender: TObject);
begin
  puesto_empleado.FieldByName('Guardia').ASString:=cbtem2.Text+' '+tem3.text;
end;

procedure TfrmCatalogoEmpleadosSSI.cbTipoExit(Sender: TObject);
begin
  puesto_empleado.FieldByName('Tipo').ASString:=cbTipo.Text;
end;

procedure TfrmCatalogoEmpleadosSSI.cbTipoPropertiesChange(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.CheckFiltroClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cmbSalarioExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxAceptarClick(Sender: TObject);
var
     SavePlace     : TBookmark;
     sEstado, Id : string;
     FlapImg:boolean;
...
//      CargaDatos;
    ...
    PanelAnexos.Visible := True;
     ...
     if global_frmActivo = 'frmPresupuesto' then
      begin
       try
           frmPresupuesto.uPersonal.Refresh;
       Except
       end;
      end;
...
procedure TfrmCatalogoEmpleadosSSI.cxAgregaCityClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
...
procedure TfrmCatalogoEmpleadosSSI.cxAgregaCPClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
    if not MostrarFormChild('frmCatalogosRHTipos', global_dxBarManagerPrincipal) then
     begin
...
procedure TfrmCatalogoEmpleadosSSI.cxAgregaDocumentoClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxAgregaListaClick(Sender: TObject);
var
    Id  : integer;
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxButton10Click(Sender: TObject);
var
  ListParam:String;
...
procedure TfrmCatalogoEmpleadosSSI.cxButton11Click(Sender: TObject);
var
  size: Real;
begin
  try
...
procedure TfrmCatalogoEmpleadosSSI.cxImprimirCredencialRapidaClick(Sender: TObject);
var
...
begin
  if cantidadLista = 0 then begin
    ...
    procReporteCredencialPrint(personal.FieldByName('IdEmpresa').AsInteger,'','_RH_CredencialEmpleados_2.fr3', CredeTemp, frmCatalogoEmpleadosSSI, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
    CredeTemp.Close;
  end
  else begin
    ...
    procReporteCredencialPrint(personal.FieldByName('IdEmpresa').AsInteger,'','_RH_CredencialEmpleados_2.fr3', tempo_table, frmCatalogoEmpleadosSSI, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
    tempo_table.Close;
  end;
end;

procedure TfrmCatalogoEmpleadosSSI.cxMovimientoExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxButton1Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
    global_indexactivo:=11;
    if not MostrarFormChild('frmCatalogosRHTipos', global_dxBarManagerPrincipal) then
     begin
        global_frmActivo := 'frmCatalogoEmpleadosSSI';
        Application.CreateForm(TfrmCatalogosRHTipos, frmCatalogosRHTipos);
        frmCatalogosRHTipos.show;
...
procedure TfrmCatalogoEmpleadosSSI.cxButton2Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
...
procedure TfrmCatalogoEmpleadosSSI.cxButton3Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
...
procedure TfrmCatalogoEmpleadosSSI.cxButton5Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
    if not MostrarFormChild('frmCatalogosRHTipos', global_dxBarManagerPrincipal) then
     begin
...
procedure TfrmCatalogoEmpleadosSSI.cxButton6Click(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
  pwd,Id : String;
begin
    ...
    begin
      ...
      Id,empGrid]);
      reporte.Open;
      procReporteCredencialPrint(personal.FieldByName('IdEmpresa').AsInteger,'','_RH_CredencialEmpleados_2.fr3', reporte, frmCatalogoEmpleadosSSI, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
    end;

end;

procedure TfrmCatalogoEmpleadosSSI.cxButton7Click(Sender: TObject);
var fecha:TDateTime;
    dia,dia2:Integer;
     ...
     try
      ...
      begin
        ...
        if dia > 0 then
         ...
         begin
            procReporteVacaciones(personal.FieldByName('IdPersonal').AsInteger,'', img, frmCatalogoEmpleadosSSI, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
            cbFInicio.Date:=now;
            cbFTermino.Date:=now;
         end
         else
...
procedure TfrmCatalogoEmpleadosSSI.cxButton8Click(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxButton9Click(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmCatalogoEmpleadosSSI.btnCartaRClick(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
  indice, iGrid    : integer;
begin
  ...
  begin
    if cxGridMoePersonal.DataController.GetSelectedCount > 0 then begin
    iGrid     := 0;
    indice := cxGridMoePersonal.DataController.GetSelectedRowIndex(iGrid);
    cxGridMoePersonal.DataController.FocusedRowIndex := indice;
      ...
      with cxGridMoePersonal.DataController.DataSource.DataSet do
        ...
        begin
          indice := cxGridMoePersonal.DataController.GetSelectedRowIndex(iGrid);
          cxGridMoePersonal.DataController.FocusedRowIndex := indice;
          empGrid := cxGridMoePersonal.DataController.DataSource.DataSet.FieldByName('CodigoPersonal').AsString +','+ empGrid;
        end;
    end;
//   empGrid:=Personal.FieldByName('CodigoPersonal').AsString+',';
  End;
...
procedure TfrmCatalogoEmpleadosSSI.btnContratoClick(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnCostoPersonalClick(Sender: TObject);
begin
  if CheckFiltro.Checked then
  begin
...
procedure TfrmCatalogoEmpleadosSSI.btnDeleteClick(Sender: TObject);
var
    conteo : integer;
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnDetalleClick(Sender: TObject);
var
tem:TUniQuery;
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnDocumentosxVencerClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.btnVerClick(Sender: TObject);
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmCatalogoEmpleadosSSI.cxCancelarClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxCancelarDetalleClick(Sender: TObject);
begin
  try
     if cxPageDetalle.ActivePage = cxTabDocumentos then
     begin
...
procedure TfrmCatalogoEmpleadosSSI.cxCargarDocumentoClick(Sender: TObject);
var
  BlobStream : TStream;
  FileStream : TFileStream;
...
procedure TfrmCatalogoEmpleadosSSI.btnSoldadoresClick(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxCredencialNombreExit(Sender: TObject);
begin
   BuscaPersonalProveedor;
   if BuscarPersonal.RecordCount > 0 then
   begin
...
procedure TfrmCatalogoEmpleadosSSI.cxDuracionExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxDoctoExpedicionExit(Sender: TObject);
begin
    docto_usuarios.FieldByName('Fechavigencia').AsDateTime   := GeneraPeriodoDocto(date,documentos.FieldByName('IdDocumento').AsInteger);
end;

procedure TfrmCatalogoEmpleadosSSI.cxEditaDetalleClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxGrid2DBTableView1CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxGridDBTableView2StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
...
procedure TfrmCatalogoEmpleadosSSI.CxGridMoePersonalCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmCatalogoEmpleadosSSI.CxGridMoePersonalColumn2PropertiesChange(
  Sender: TObject);
begin
    cxGridMoePersonal.OnDblClick(sender);
end;

procedure TfrmCatalogoEmpleadosSSI.cxGuardarDetalleClick(Sender: TObject);
var
        i   : longint;
        fh1 : TextFile;
...
procedure TfrmCatalogoEmpleadosSSI.cxNuevoDetalleClick(Sender: TObject);
var i:Integer;
    dato:String;
begin;
   {se deshabilitan los botones principales}
...
procedure TfrmCatalogoEmpleadosSSI.cxPageContratoClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxPageControlFormatosChange(Sender: TObject);
var
  tempo_table:TUniQuery;
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxPageDetalleClick(Sender: TObject);
begin
    btnEliminarDetalle.Visible:= True;
    cxEditaDetalle.Visible    := True;
    cxNuevoDetalle.Visible    := True;
    ...
    begin
        ...
        if zEmpresa.FieldByName('FK_Titulo').AsString = 'SIANI' then begin
           dxLayoutItem162.Visible:=True;
        end;
...
procedure TfrmCatalogoEmpleadosSSI.cxVerClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleadosSSI.cxViewDocumentosCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmCatalogoEmpleadosSSI.Enroll;
var
        i         : longint;
        nUserID   : longint;
        szFir     : wideString;
...
procedure TfrmCatalogoEmpleadosSSI.activa_detalle_puestos;
begin
    puesto.Active := False;
...
procedure TfrmCatalogoEmpleadosSSI.BuscaPersonalProveedor;
begin
