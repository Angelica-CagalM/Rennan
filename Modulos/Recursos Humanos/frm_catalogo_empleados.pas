...
type
  TfrmCatalogoEmpleados = class(TForm)
...
var
  ...
  OpcButton1    : String ;
  frmCatalogoEmpleados: TfrmCatalogoEmpleados;
...
procedure TfrmCatalogoEmpleados.GlobalKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmCatalogoEmpleados.lcbFirmaEnter(Sender: TObject);
begin
  zGuardaFirma.Append;
  zGuardaFirma.FieldByName('IdFirma').AsInteger := zFirma.FieldByName('IdFirma').AsInteger;
  zGuardaFirma.FieldByName('NombreForm').AsString := frmCatalogoEmpleados.Caption;
  zGuardaFirma.FieldByName('Boton').AsString := btnSoldadores.Caption;
end;

procedure TfrmCatalogoEmpleados.MenuMoverClick(Sender: TObject);
...
procedure TfrmCatalogoEmpleados.PanelDetalleClick(Sender: TObject);
var
  tem:TUniQuery;
begin
...
procedure TfrmCatalogoEmpleados.personalAfterScroll(DataSet: TDataSet);
begin
  if IsOpen then
  begin
...
procedure TfrmCatalogoEmpleados.EnterControl(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmCatalogoEmpleados.Timer1Timer(Sender: TObject);
begin
{    if (Flap = True) then
    begin
...
procedure TfrmCatalogoEmpleados.VistaPrevia1Click(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.zEmpresaAfterScroll(DataSet: TDataSet);
begin
...
procedure TfrmCatalogoEmpleados.FormShow(Sender: TObject);
var tem:TUniQuery;
begin
  ...
  guardar_leer_grid(BView_empresa,frmCatalogoEmpleados,0);
  guardar_leer_grid(CxGridMoePersonal,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxGridViewPuesto,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxGrid1DBTableView1,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxViewContacto,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxViewBanco,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxGrid2DBTableView1,frmCatalogoEmpleados,0);
  guardar_leer_grid(gridComentariosDBTableView1,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxViewDocumentos,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxGridEPPDBTableView1,frmCatalogoEmpleados,0);
  guardar_leer_grid(cxGridViewCurso,frmCatalogoEmpleados,0);
  PermisosBotones(frmCatalogoEmpleados,btnPermisos);
...
procedure TfrmCatalogoEmpleados.frxReportCRGetValue(const VarName: string;
  var Value: Variant);
begin
...
procedure TfrmCatalogoEmpleados.frxReporteGetValue(const VarName: string;
  var Value: Variant);
begin
...
procedure TfrmCatalogoEmpleados.Actualizar1Click(Sender: TObject);
...
procedure TfrmCatalogoEmpleados.ActualizarPersonal(IdPersonal: String;
  IdEmpresa: Integer);
var
...
procedure TfrmCatalogoEmpleados.btnAddClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.btnAutorizarClick(Sender: TObject);
begin
  try
...
procedure TfrmCatalogoEmpleados.btnCancelClick(Sender: TObject);
begin
  close;
end;

procedure TfrmCatalogoEmpleados.btnCargarClick(Sender: TObject);
var
  size: Real;
begin
...
procedure TfrmCatalogoEmpleados.btnEditClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.btnEliminarDetalleClick(Sender: TObject);
begin
   if cxPageDetalle.ActivePage = cxTabDocumentos then
   begin
     AsignarSQL(doctoVP,'docto_empleadoVP',pUpdate);
...
procedure TfrmCatalogoEmpleados.btnFirmaClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.btnImpInformeClick(Sender: TObject);
var
  empGrid: String;
...
procedure TfrmCatalogoEmpleados.btnModificacionesClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.btnMostrarClick(Sender: TObject);
begin
  personal.Active := False;
  personal.ParamByName('Empresa').AsInteger := zEmpresa.FieldByName('IdEmpresa').AsInteger;
...
procedure TfrmCatalogoEmpleados.btnRefreshClick(Sender: TObject);
begin
   personal.Refresh;
end;

procedure TfrmCatalogoEmpleados.BView_empresaCellClick(
...
procedure TfrmCatalogoEmpleados.BView_empresaDblClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.BView_empresaMouseDown(Sender: TObject;
...
procedure TfrmCatalogoEmpleados.FormClose(Sender: TObject;
...
begin
  ...
  guardar_leer_grid(BView_empresa,frmCatalogoEmpleados,1);
  guardar_leer_grid(CxGridMoePersonal,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxGridViewPuesto,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxGrid1DBTableView1,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxViewContacto,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxViewBanco,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxGrid2DBTableView1,frmCatalogoEmpleados,1);
  guardar_leer_grid(gridComentariosDBTableView1,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxViewDocumentos,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxGridEPPDBTableView1,frmCatalogoEmpleados,1);
  guardar_leer_grid(cxGridViewCurso,frmCatalogoEmpleados,1);
  action := cafree;
end;

procedure TfrmCatalogoEmpleados.cbFechaFExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cbFechaIExit(Sender: TObject);
begin
  if (not VarIsNull(Contratos.FieldByName('FechaInicio').AsDateTime)) and (not VarIsNull(Contratos.FieldByName('FechaFinal').AsDateTime)) then begin
    cxDuracion.EditValue:=trunc(Contratos.FieldByName('FechaFinal').AsDateTime - Contratos.FieldByName('FechaInicio').AsDateTime)+1;
  end;
...
procedure TfrmCatalogoEmpleados.cbtem1Exit(Sender: TObject);
begin
  puesto_empleado.FieldByName('Divicion').ASString:=cbtem1.Text;
end;

procedure TfrmCatalogoEmpleados.cbtem2Exit(Sender: TObject);
begin
 // puesto_empleado.FieldByName('Guardia').ASString:=cbtem2.Text+' '+tem3.text;
end;

procedure TfrmCatalogoEmpleados.cbTipoExit(Sender: TObject);
begin
  puesto_empleado.FieldByName('Tipo').ASString:=cbTipo.Text;
end;

procedure TfrmCatalogoEmpleados.cbTipoPropertiesChange(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.CheckFiltroClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cmbSalarioExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxAceptarClick(Sender: TObject);
var
     SavePlace     : TBookmark;
     sEstado, Id : string;
     FlapImg:boolean;
...
procedure TfrmCatalogoEmpleados.cxAgregaCityClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxAgregaCPClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
    if not MostrarFormChild('frmCatalogosRHTipos', global_dxBarManagerPrincipal) then
     begin
...
procedure TfrmCatalogoEmpleados.cxAgregaDocumentoClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxAgregaListaClick(Sender: TObject);
var
    Id  : integer;
begin
...
procedure TfrmCatalogoEmpleados.cxButton10Click(Sender: TObject);
var
  ListParam:String;
...
procedure TfrmCatalogoEmpleados.cxButton11Click(Sender: TObject);
var
  size: Real;
begin
  try
...
procedure TfrmCatalogoEmpleados.cxImprimirCredencialRapidaClick(Sender: TObject);
var
...
begin
  if cantidadLista = 0 then begin
    ...
    procReporteCredencialPrint(personal.FieldByName('IdEmpresa').AsInteger,'','_RH_CredencialEmpleados_2.fr3', CredeTemp, frmCatalogoEmpleados, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
    CredeTemp.Close;
  end
  else begin
    ...
    procReporteCredencialPrint(personal.FieldByName('IdEmpresa').AsInteger,'','_RH_CredencialEmpleados_2.fr3', tempo_table, frmCatalogoEmpleados, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
    tempo_table.Close;
  end;
end;

procedure TfrmCatalogoEmpleados.cxMovimientoExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxButton1Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
...
procedure TfrmCatalogoEmpleados.cxButton2Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
...
procedure TfrmCatalogoEmpleados.cxButton3Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
...
procedure TfrmCatalogoEmpleados.cxButton5Click(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmCatalogoEmpleados';
    if not MostrarFormChild('frmCatalogosRHTipos', global_dxBarManagerPrincipal) then
     begin
...
procedure TfrmCatalogoEmpleados.cxButton6Click(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
  pwd,Id : String;
begin
    ...
    begin
      ...
      Id,empGrid]);
      reporte.Open;
      procReporteCredencialPrint(personal.FieldByName('IdEmpresa').AsInteger,'','_RH_CredencialEmpleados_2.fr3', reporte, frmCatalogoEmpleados, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
    end;

end;

procedure TfrmCatalogoEmpleados.cxButton7Click(Sender: TObject);
var fecha:TDateTime;
    dia,dia2:Integer;
     ...
     try
      ...
      begin
        ...
        if dia > 0 then
         ...
         begin
            procReporteVacaciones(personal.FieldByName('IdPersonal').AsInteger,'', img, frmCatalogoEmpleados, frxReporte.OnGetValue, progreso, connection.uconfiguracion.FieldByName('sFormatos').AsString, '');
            cbFInicio.Date:=now;
            cbFTermino.Date:=now;
         end
         else
...
procedure TfrmCatalogoEmpleados.cxButton8Click(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxButton9Click(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmCatalogoEmpleados.btnCartaRClick(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
begin
...
procedure TfrmCatalogoEmpleados.btnContratoClick(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
begin
...
procedure TfrmCatalogoEmpleados.btnCostoPersonalClick(Sender: TObject);
begin
  if CheckFiltro.Checked then
  begin
...
procedure TfrmCatalogoEmpleados.btnDeleteClick(Sender: TObject);
var
    conteo : integer;
begin
...
procedure TfrmCatalogoEmpleados.btnDetalleClick(Sender: TObject);
var
tem:TUniQuery;
begin
...
procedure TfrmCatalogoEmpleados.btnDocumentosxVencerClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.btnVerClick(Sender: TObject);
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmCatalogoEmpleados.cxCancelarClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxCancelarDetalleClick(Sender: TObject);
begin
  try
     if cxPageDetalle.ActivePage = cxTabDocumentos then
     begin
...
procedure TfrmCatalogoEmpleados.cxCargarDocumentoClick(Sender: TObject);
var
  BlobStream : TStream;
  FileStream : TFileStream;
...
procedure TfrmCatalogoEmpleados.btnSoldadoresClick(Sender: TObject);
var
  empGrid: String;
  contEmpGrid,j : Integer;
begin
...
procedure TfrmCatalogoEmpleados.cxCredencialNombreExit(Sender: TObject);
begin
   BuscaPersonalProveedor;
   if BuscarPersonal.RecordCount > 0 then
   begin
...
procedure TfrmCatalogoEmpleados.cxDuracionExit(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxDoctoExpedicionExit(Sender: TObject);
begin
    docto_usuarios.FieldByName('Fechavigencia').AsDateTime   := GeneraPeriodoDocto(date,documentos.FieldByName('IdDocumento').AsInteger);
end;

procedure TfrmCatalogoEmpleados.cxEditaDetalleClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxGrid2DBTableView1CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmCatalogoEmpleados.cxGridDBTableView2StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
...
procedure TfrmCatalogoEmpleados.CxGridMoePersonalCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmCatalogoEmpleados.CxGridMoePersonalColumn2PropertiesChange(
  Sender: TObject);
begin
    cxGridMoePersonal.OnDblClick(sender);
end;

procedure TfrmCatalogoEmpleados.cxGuardarDetalleClick(Sender: TObject);
var
        i   : longint;
        fh1 : TextFile;
...
procedure TfrmCatalogoEmpleados.cxNuevoDetalleClick(Sender: TObject);
var i:Integer;
    dato:String;
begin;
   {se deshabilitan los botones principales}
...
procedure TfrmCatalogoEmpleados.cxPageContratoClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxPageControlFormatosChange(Sender: TObject);
var
  tempo_table:TUniQuery;
begin
...
procedure TfrmCatalogoEmpleados.cxPageDetalleClick(Sender: TObject);
begin
    btnEliminarDetalle.Visible:= True;
    cxEditaDetalle.Visible    := True;
    cxNuevoDetalle.Visible    := True;
...
procedure TfrmCatalogoEmpleados.cxVerClick(Sender: TObject);
begin
...
procedure TfrmCatalogoEmpleados.cxViewDocumentosCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmCatalogoEmpleados.Enroll;
var
        i         : longint;
        nUserID   : longint;
        szFir     : wideString;
...
procedure TfrmCatalogoEmpleados.activa_detalle_puestos;
begin
    puesto.Active := False;
...
procedure TfrmCatalogoEmpleados.BuscaPersonalProveedor;
begin
