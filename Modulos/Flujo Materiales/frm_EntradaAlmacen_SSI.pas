...
type
  TfrmEntradaAlmacen_SSI = class(TForm)
    ...
    cxViewMaterialEntradaColumn1: TcxGridDBColumn;
...
var
  frmEntradaAlmacen_SSI: TfrmEntradaAlmacen_SSI;
  SavePlace: TBookmark;
  lNuevo: Boolean;
  OpcButton1: string;
  btnPermisos : String;
...
uses frm_connection, UnitValidaTexto, Func_Genericas, frm_firmasNota, unitMetodos,
  frm_repositorio,frm_almacenamiento, frm_agregar_masivoOP_SSI;

{$R *.dfm}

procedure TfrmEntradaAlmacen_SSI.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
//  guardar_leer_grid(Grid_ViewEntradas,frmEntradaAlmacen_SSI,1);
//  guardar_leer_grid(cxViewMaterialEntrada,frmEntradaAlmacen_SSI,1);
  ListaFiles.Clear;
  ListaFiles.destroy;
...
procedure TfrmEntradaAlmacen_SSI.FormCreate(Sender: TObject);
begin
  ListaFiles:=TstringList.Create;
end;

procedure TfrmEntradaAlmacen_SSI.FormShow(Sender: TObject);
begin
...
//  guardar_leer_grid(Grid_ViewEntradas,frmEntradaAlmacen_SSI,0);
//  guardar_leer_grid(cxViewMaterialEntrada,frmEntradaAlmacen_SSI,0);
end;

procedure TfrmEntradaAlmacen_SSI.BtnExitClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmEntradaAlmacen_SSI.btnImpInformeClick(Sender: TObject);
var
  entradasGrid : String;
...
procedure TfrmEntradaAlmacen_SSI.btnPostClick(Sender: TObject);
begin
   pEntradas.Post;
   pEntradas.Refresh;
...
procedure TfrmEntradaAlmacen_SSI.btnRutaClick(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmEntradaAlmacen_SSI.EditarClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.CancelarClick(Sender: TObject);
begin
  Grid_entradas.Enabled := True;
  PgControl.Enabled:=True;
  PermisosBotones(frmEntradaAlmacen_SSI,btnPermisos);
end;

procedure TfrmEntradaAlmacen_SSI.EliminarClick(Sender: TObject);
var
...
procedure TfrmEntradaAlmacen_SSI.frmBarra2btnAddClick(Sender: TObject);
begin
  try
    OpcButton1 := 'New';
...
procedure TfrmEntradaAlmacen_SSI.frmBarra2btnEditClick(Sender: TObject);
begin
   if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
   begin
     messageDLG('La Entrada de Material se encuentra en estatus '+almacen_entrada.FieldValues['sStatus'], mtInformation, [mbOk], 0);
...
procedure TfrmEntradaAlmacen_SSI.frmBarra2btnPrinterClick(Sender: TObject);
var
...
procedure TfrmEntradaAlmacen_SSI.frmBarra2btnDeleteClick(Sender: TObject);
begin
   if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
   begin
     messageDLG('La Entrada de Material se encuentra en estatus '+almacen_entrada.FieldValues['sStatus'], mtInformation, [mbOk], 0);
...
procedure TfrmEntradaAlmacen_SSI.frmBarra2btnRefreshClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.frmBarraH22btnCancelClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.frmBarraH22btnPostClick(Sender: TObject);
begin
  try
...
procedure TfrmEntradaAlmacen_SSI.frmBarra2btnCancelClick(Sender: TObject);
begin
   pEntradas.Cancel;
   cxSplitMaterial.Visible := False;
   PanelMaterial.Visible := False;
...
procedure TfrmEntradaAlmacen_SSI.tsFolioMovimientoExit(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.tsTipomovimientoExit(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.frxEntradaGetValue(const VarName: string; var Value: Variant);
begin
...
procedure TfrmEntradaAlmacen_SSI.cxAlmacenamientoClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.cxButton1Click(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.cxComprasxProveedorClick(Sender: TObject);
var
...
procedure TfrmEntradaAlmacen_SSI.cxEditaDetalleClick(Sender: TObject);
begin
     If almacen_entrada.RecordCount > 0 Then
     Begin
         if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
...
procedure TfrmEntradaAlmacen_SSI.cxViewMaterialEntradaCellClick(
...
procedure TfrmEntradaAlmacen_SSI.cxViewMaterialEntradaCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmEntradaAlmacen_SSI.cxNuevoDetalleClick(Sender: TObject);
begin
    If (almacen_entrada.RecordCount > 0) Then
    Begin
       if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
...
procedure TfrmEntradaAlmacen_SSI.almacen_entradaAfterOpen(DataSet: TDataSet);
begin
    almacen_entrada.Cancel;
end;

procedure TfrmEntradaAlmacen_SSI.btnDetalleClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.EnterControl(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SSI.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmEntradaAlmacen_SSI.GlobalKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmEntradaAlmacen_SSI.Grid_ViewEntradasCellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmEntradaAlmacen_SSI.Grid_ViewEntradasKeyUp(Sender: TObject;
...
procedure TfrmEntradaAlmacen_SSI.entrada_scroll;
begin
    if almacen_entrada.RecordCount > 0 then
    begin
