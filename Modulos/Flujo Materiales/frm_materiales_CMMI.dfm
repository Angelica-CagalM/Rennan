object frmMateriales_CMMI: TfrmMateriales_CMMI
  Left = 195
  Top = 55
    ...
    object Panel1: TPanel
      ...
      object grid_materiales: TcxGrid
        ...
        object cxView_Materiales: TcxGridDBTableView
          ...
          DataController.DetailKeyFieldNames = 'IdInsumo'
          DataController.Filter.Options = [fcoCaseInsensitive]
          ...
          DataController.KeyFieldNames = 'IdInsumo'
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
          ...
          object cxView_MaterialesColumn14: TcxGridDBColumn
            Caption = 'C C'
            DataBinding.FieldName = 'CentroCosto'
            Width = 60
          end
          object cxView_MaterialesColumn15: TcxGridDBColumn
            Caption = 'Centro de Costo'
            DataBinding.FieldName = 'NombreCC'
            Width = 200
          end
        ...
        object grid_materialesDBCC: TcxGridDBTableView
          Navigator.Buttons.CustomButtons = <>
          DataController.DataSource = dsInsumoCC
          DataController.DetailKeyFieldNames = 'IdInsumo'
          DataController.KeyFieldNames = 'IdInsumo'
          DataController.MasterKeyFieldNames = 'IdInsumo'
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <>
          DataController.Summary.SummaryGroups = <>
          ...
          object grid_materialesDBCCColumn1: TcxGridDBColumn
            Caption = 'Centro de costo'
            DataBinding.FieldName = 'CentroCosto'
            Width = 150
          end
          object grid_materialesDBCCColumn4: TcxGridDBColumn
            Caption = 'Nombre'
            DataBinding.FieldName = 'NombreCC'
            Width = 500
          end
          object grid_materialesDBCCColumn2: TcxGridDBColumn
            DataBinding.FieldName = 'Almacen'
            Width = 200
          end
          object grid_materialesDBCCColumn3: TcxGridDBColumn
        ...
        object grid_materialesLevel1: TcxGridLevel
          ...
          object grid_materialesLevel2: TcxGridLevel
            GridView = grid_materialesDBCC
          end
        end
      end
    end
