object frmPedidos_SAP_Estatus: TfrmPedidos_SAP_Estatus
  Left = 255
  Top = 73
    ...
    object PanelTopDD: TPanel
      ...
      object Grid_Entradas: TcxGrid
        ...
        object dbg_OCVista: TcxGridDBTableView
          ...
          object col_Planta: TcxGridDBColumn
          ...
          object col_TipoEstatus: TcxGridDBColumn
            Caption = 'Estatus PO'
            DataBinding.FieldName = 'TipoEstatus'
          end
        end
  ...
  object frxEntrada: TfrxReport
    ...
    ReportOptions.LastChange = 43554.763015185180000000
    ...
    ScriptText.Strings = (
      ...
      'begin'
        ...
        '    Memo27.Text := FormatFloat('#39'#0.00'#39',(<frxOrdenCompra."dCosto"' +
        ...
        object Memo30: TfrxMemoView
          ...
          Memo.UTF8W = (
            ...
            ''
              ...
              'hrs de anticipaci'#243'n, para que se programe la disposici'#243'n de los ' +
              'mismos, en los horarios'
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo18: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'hacer referencia a los sifuientes detalles: [frxOrdenCompra."Raz' +
              'onSocial"]/ Ref de cotizaci'#243'n XXXX Solicitante Orginal: JUAN CAS' +
              'TELLANOS'
            ''
            
              'Todo servicio tendr'#225' un plazo no mayor a 60 d'#237'as posterior en ha' +
              'berse realizado y/o enviado la PO para la presentaci'#243'n de su est' +
              'imaci'#243'n para su aprobaci'#243'n, posterior a dicho periodo no se podr' +
              #225' regularizar no se conceder'#225' ning'#250'n servicio.'
            ''
            ...
            ''
              ...
              'rs ser'#225'n tomados como aceptados.')
          ParentFont = False
        end
