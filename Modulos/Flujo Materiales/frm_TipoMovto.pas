...
uses
  ...
  unitGenerales, dxSkinOffice2016Colorful, dxSkinOffice2016Dark,
...
begin
  ...
  {Continua insercion de datos..}
   try
       if ValidaExiste('', 'movimientosdealmacen ', 'sIdTipo', tsIdTipo.Text, 'Código' ) = True then
          exit;
       ...
       begin
         try
           frmEntradaAlmacen.zq_tipomovimiento.Refresh;
           frmEntradaAlmacen.tsTipomovimiento.EditValue :=sId;
           frmEntradaAlmacen.tsTipomovimiento.SetFocus;
         Except
         end;
      end;
