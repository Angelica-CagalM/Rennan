...
type
  TfrmEntradaAlmacen_SS7 = class(TForm)
...
var
  frmEntradaAlmacen_SS7: TfrmEntradaAlmacen_SS7;
  SavePlace: TBookmark;
  lNuevo: Boolean;
  OpcButton1: string;
  btnPermisos : String;
...
uses frm_connection, UnitValidaTexto, Func_Genericas, frm_firmasNota, unitMetodos,
  frm_repositorio,frm_almacenamiento, frm_agregar_masivoOP_SS7;

{$R *.dfm}

procedure TfrmEntradaAlmacen_SS7.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  guardar_leer_grid(Grid_ViewEntradas,frmEntradaAlmacen_SS7,1);
  guardar_leer_grid(cxViewMaterialEntrada,frmEntradaAlmacen_SS7,1);
  ListaFiles.Clear;
  ListaFiles.destroy;
...
procedure TfrmEntradaAlmacen_SS7.FormCreate(Sender: TObject);
begin
  ListaFiles:=TstringList.Create;
end;

procedure TfrmEntradaAlmacen_SS7.FormShow(Sender: TObject);
begin
  ...
  guardar_leer_grid(Grid_ViewEntradas,frmEntradaAlmacen_SS7,0);
  guardar_leer_grid(cxViewMaterialEntrada,frmEntradaAlmacen_SS7,0);
end;

procedure TfrmEntradaAlmacen_SS7.BtnExitClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmEntradaAlmacen_SS7.btnImpInformeClick(Sender: TObject);
var
  entradasGrid : String;
...
procedure TfrmEntradaAlmacen_SS7.btnPostClick(Sender: TObject);
begin
   pEntradas.Post;
   pEntradas.Refresh;
...
procedure TfrmEntradaAlmacen_SS7.btnRutaClick(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmEntradaAlmacen_SS7.EditarClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.CancelarClick(Sender: TObject);
begin
  Grid_entradas.Enabled := True;
  PgControl.Enabled:=True;
  PermisosBotones(frmEntradaAlmacen_SS7,btnPermisos);
end;

procedure TfrmEntradaAlmacen_SS7.EliminarClick(Sender: TObject);
var
...
procedure TfrmEntradaAlmacen_SS7.frmBarra2btnEditClick(Sender: TObject);
begin
   if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
   begin
     messageDLG('La Entrada de Material se encuentra en estatus '+almacen_entrada.FieldValues['sStatus'], mtInformation, [mbOk], 0);
...
procedure TfrmEntradaAlmacen_SS7.frmBarra2btnPrinterClick(Sender: TObject);
var
...
procedure TfrmEntradaAlmacen_SS7.frmBarra2btnDeleteClick(Sender: TObject);
begin
   if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
   begin
     messageDLG('La Entrada de Material se encuentra en estatus '+almacen_entrada.FieldValues['sStatus'], mtInformation, [mbOk], 0);
...
procedure TfrmEntradaAlmacen_SS7.frmBarra2btnRefreshClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.frmBarraH22btnCancelClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.frmBarraH22btnPostClick(Sender: TObject);
begin
  try
...
procedure TfrmEntradaAlmacen_SS7.frmBarra2btnCancelClick(Sender: TObject);
begin
   pEntradas.Cancel;
   cxSplitMaterial.Visible := False;
   PanelMaterial.Visible := False;
...
procedure TfrmEntradaAlmacen_SS7.tsFolioMovimientoExit(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.tsTipomovimientoExit(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.frxEntradaGetValue(const VarName: string; var Value: Variant);
begin
...
procedure TfrmEntradaAlmacen_SS7.cxAlmacenamientoClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.cxButton1Click(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.cxComprasxProveedorClick(Sender: TObject);
var
...
procedure TfrmEntradaAlmacen_SS7.cxEditaDetalleClick(Sender: TObject);
begin
     If almacen_entrada.RecordCount > 0 Then
     Begin
         if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
...
procedure TfrmEntradaAlmacen_SS7.cxViewMaterialEntradaCellClick(
...
procedure TfrmEntradaAlmacen_SS7.cxViewMaterialEntradaCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmEntradaAlmacen_SS7.cxNuevoDetalleClick(Sender: TObject);
begin
    If (almacen_entrada.RecordCount > 0) Then
    Begin
       if almacen_entrada.FieldValues['sStatus'] <> 'PENDIENTE' then
...
procedure TfrmEntradaAlmacen_SS7.almacen_entradaAfterOpen(DataSet: TDataSet);
begin
    almacen_entrada.Cancel;
end;

procedure TfrmEntradaAlmacen_SS7.btnDetalleClick(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.EnterControl(Sender: TObject);
begin
...
procedure TfrmEntradaAlmacen_SS7.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmEntradaAlmacen_SS7.GlobalKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmEntradaAlmacen_SS7.Grid_ViewEntradasCellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
    ...
    begin
      ...
      begin
         cxViewMaterialEntrada.Columns[4].Caption:='Solicitado';
      end;
...
procedure TfrmEntradaAlmacen_SS7.Grid_ViewEntradasKeyUp(Sender: TObject;
...
procedure TfrmEntradaAlmacen_SS7.entrada_scroll;
begin
    if almacen_entrada.RecordCount > 0 then
    begin
