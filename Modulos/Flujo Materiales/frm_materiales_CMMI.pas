...
type
  TfrmMateriales_CMMI = class(TForm)
    ...
    zReq: TUniQuery;
    zCentro_costos: TUniQuery;
    zMaterialCosto: TUniQuery;
    Entrada_almacen: TUniQuery;
    dsInsumoCC: TDataSource;
    zInsumoCC: TUniQuery;
    grid_materialesLevel2: TcxGridLevel;
    grid_materialesDBCC: TcxGridDBTableView;
    grid_materialesDBCCColumn1: TcxGridDBColumn;
    grid_materialesDBCCColumn2: TcxGridDBColumn;
    grid_materialesDBCCColumn3: TcxGridDBColumn;
    ProcExistenCC: TUniStoredProc;
    grid_materialesDBCCColumn4: TcxGridDBColumn;
    cxButton3: TcxButton;
    dxLayoutItem57: TdxLayoutItem;
    cxView_MaterialesColumn14: TcxGridDBColumn;
    cxView_MaterialesColumn15: TcxGridDBColumn;
    ...
    procedure cxButton3Click(Sender: TObject);  private
...
var
  frmMateriales_CMMI : TfrmMateriales_CMMI;
  Opcion         : String ;
...
procedure TfrmMateriales_CMMI.EnterControl(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmMateriales_CMMI.SeleccionarMovimientosMatClick(Sender: TObject);
var
    conteo:Integer;
    sMensaje : string;
...
procedure TfrmMateriales_CMMI.FormShow(Sender: TObject);
begin
...
//          FiltrarDataSet(zqInsumos,'Usuario,Codigo,AplicaMto',[global_usuario,'-1','Si'])
//        else
        FiltrarDataSet(zqInsumos,'Usuario,Codigo,IdFamilia1',[global_usuario,'-1','117']);
        zqInsumos.Open;
...
//        else
        ...
        if global_grupo = 'ADMON' then
           dxLayoutItem56.Visible:=True
        else
          dxLayoutItem56.Visible:=False;
        IsOpen := True;
        PermisosBotones(frmMateriales_CMMI,btnPermisos);
...
//  guardar_leer_grid(BView_filtro,frmMateriales,0);
//  guardar_leer_grid(cxView_Materiales,frmMateriales,0);
//  guardar_leer_grid(cxGridViewImagen,frmMateriales,0);
//  guardar_leer_grid(cxGridCertificados,frmMateriales,0);
//  guardar_leer_grid(cxGridExistenciaDBTableView1,frmMateriales,0);
//  guardar_leer_grid(cxGridCostosDBTableView1,frmMateriales,0);
//  guardar_leer_grid(cxGridSerieDBTableView1,frmMateriales,0);
//  guardar_leer_grid(cxGridMovimientos,frmMateriales,0);
end;

procedure TfrmMateriales_CMMI.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
//  guardar_leer_grid(BView_filtro,frmMateriales,1);
//  guardar_leer_grid(cxView_Materiales,frmMateriales,1);
//  guardar_leer_grid(cxGridViewImagen,frmMateriales,1);
//  guardar_leer_grid(cxGridCertificados,frmMateriales,1);
//  guardar_leer_grid(cxGridExistenciaDBTableView1,frmMateriales,1);
//  guardar_leer_grid(cxGridCostosDBTableView1,frmMateriales,1);
//  guardar_leer_grid(cxGridSerieDBTableView1,frmMateriales,1);
//  guardar_leer_grid(cxGridMovimientos,frmMateriales,1);
  zqInsumos.Cancel ;
  action := cafree ;
end;

procedure TfrmMateriales_CMMI.grid_proveedoresCellClick(Column: TColumn);
begin
...
procedure TfrmMateriales_CMMI.cxView_MaterialesCellClick(
...
procedure TfrmMateriales_CMMI.cxView_MaterialesCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmMateriales_CMMI.cxView_MaterialesColumn10GetProperties(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AProperties: TcxCustomEditProperties);
var
...
procedure TfrmMateriales_CMMI.cxView_MaterialesDataControllerFilterBeforeChange(
  Sender: TcxDBDataFilterCriteria; ADataSet: TDataSet;
  const AFilterText: string);
begin
  IsOpen := False;
...
procedure TfrmMateriales_CMMI.cxView_MaterialesDataControllerFilterChanged(
  Sender: TObject);
begin
  IsOpen:=True;
end;

procedure TfrmMateriales_CMMI.cxView_MaterialesKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmMateriales_CMMI.frmBarra1btnAddClick(Sender: TObject);
begin
  try
...
procedure TfrmMateriales_CMMI.frmBarra1btnEditClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.frmBarra1btnPostClick(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.frmBarra1btnCancelClick(Sender: TObject);
begin
 try
...
procedure TfrmMateriales_CMMI.frmBarra1btnDeleteClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.frmBarra1btnRefreshClick(Sender: TObject);
begin
 try
  zqInsumos.Active := False ;
  zqInsumos.Open
...
procedure TfrmMateriales_CMMI.Insertar1Click(Sender: TObject);
begin
    frmBarraH11.btnAdd.Click
end;

procedure TfrmMateriales_CMMI.muestraImagen;
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmMateriales_CMMI.opcionImprimirPropertiesChange(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.Editar1Click(Sender: TObject);
begin
    frmBarraH11.btnEdit.Click
end;

procedure TfrmMateriales_CMMI.Registrar1Click(Sender: TObject);
begin
    frmBarraH21.btnPost.Click
end;

procedure TfrmMateriales_CMMI.btnAddClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.btnCancelClick(Sender: TObject);
begin
    cxLeyenda.Caption:=titulo;
    Panel2.Visible:=False;
    cxSplitter1.Visible := False;
...
procedure TfrmMateriales_CMMI.btnDeleteClick(Sender: TObject);
var
   conteo:Integer;
   sMensaje : string;
...
procedure TfrmMateriales_CMMI.btnDescargarClick(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.btnDetalleClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.btnEditClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.btnExistenciaClick(Sender: TObject);
begin
  if connection.UContrato.FieldByName('FK_Titulo').AsString = 'CMMI' then
  begin
...
procedure TfrmMateriales_CMMI.btnExpandirClick(Sender: TObject);
begin
   if lExpandido then
   begin
...
procedure TfrmMateriales_CMMI.btnExportaClick(Sender: TObject);
var
  rutaArchivo: string;
  Excel, Sheet: Variant;
  dlgSave : TSaveDialog;
...
procedure TfrmMateriales_CMMI.btnImpInformeClick(Sender: TObject);
var
  MaterialGrid : String;
...
procedure TfrmMateriales_CMMI.btnPostClick(Sender: TObject);
var
     SavePlace     : TBookmark;
     zUpt: TUniquery;
     nombres, cadenas : TStringList;
...
//    grid_Materiales.Enabled:=True;
    ...
    nombres.Add('Familia');
    cadenas.Add(cxFamilia.EditText);
...
procedure TfrmMateriales_CMMI.btnPrinterClick(Sender: TObject);
begin
    IsOpen:=False;
    generar_reporte_grid(cxView_Materiales,'Reporte General de Materiales.');
    IsOpen:=True;
...
procedure TfrmMateriales_CMMI.btnRefreshClick(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.BView_empresaDataControllerFilterRecord(
  ADataController: TcxCustomDataController; ARecordIndex: Integer;
  var Accept: Boolean);
begin
...
procedure TfrmMateriales_CMMI.BView_filtroCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
    if BView_filtro.DataController.Filter.FilterText = '' then
...
procedure TfrmMateriales_CMMI.Can1Click(Sender: TObject);
begin
    frmBarraH21.btnCancel.Click
end;

procedure TfrmMateriales_CMMI.cargarExistenciCC;
var sqlCC: TUniquery;
begin
...
procedure TfrmMateriales_CMMI.Eliminar1Click(Sender: TObject);
begin
    frmBarraH11.btnDelete.Click
end;

procedure TfrmMateriales_CMMI.Imprimir1Click(Sender: TObject);
begin
    frmBarraH11.btnPrinter.Click
end;

procedure TfrmMateriales_CMMI.popmenuAplicaClick(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.popmenuSeleccionaClick(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.PopupMovimientosPopup(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.VerDocumento1Click(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.zImagenesCalcFields(DataSet: TDataSet);
begin
   if zImagenes.RecordCount > 0 then
      zImagenes.FieldByName('Nombre').AsString := 'Imagen ' + IntTostr(zImagenes.RecNo);
end;

procedure TfrmMateriales_CMMI.ColPrecioGetProperties(Sender: TcxCustomGridTableItem;
  ARecord: TcxCustomGridRecord; var AProperties: TcxCustomEditProperties);
var
  AColumn: TcxGridDBColumn;
begin
...
procedure TfrmMateriales_CMMI.Copiar1Click(Sender: TObject);
begin
ModificarPortaPapeles(self.ActiveControl, ftcopiar)
end;

procedure TfrmMateriales_CMMI.CopiarFamiliaClick(Sender: TObject);
var
    indice, iGrid    : integer;
    lcontinua : boolean;
begin
...
procedure TfrmMateriales_CMMI.CopiarMedidaClick(Sender: TObject);
var
    indice, iGrid    : integer;
    lcontinua : boolean;
begin
...
procedure TfrmMateriales_CMMI.btnAgregaMarcaClick(Sender: TObject);
begin
      GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmMateriales_CMMI.btnAgregarClick(Sender: TObject);
var
  size: Real;
begin
  sOpcion := 'New';
...
procedure TfrmMateriales_CMMI.btnAgregarDoctoClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.btnAgregarFabricanteClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmMateriales_CMMI.btnAgregarServicioClick(Sender: TObject);
begin
   GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmMateriales_CMMI.cxAgregaFamiliaClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.cxAgregaMedidaClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmMateriales_CMMI.cxAgregaSubFamiliaClick(Sender: TObject);
begin
     GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmMateriales_CMMI.cxButton1Click(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmMateriales_CMMI.cxButton2Click(Sender: TObject);
var
  folio,cc,Tipo:String;
  last,IdReq,lastEnt,Id:Integer;
  exitencia:double;
  listValues: array of Variant;
  isPrimero:boolean;
  status: TStatusWindowHandle;
begin
  if MessageDlg('Seguro de establecer las existencias en 0?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
  begin

    isPrimero:=true;
    // se buscan los centro de costo
    Try
      status := CreateStatusWindow('Procesando, espere por favor...');

      zCentro_costos.Active:=False;
      zCentro_costos.SQL.Text:='select * from ordenesdetrabajo where TipoProyecto = :tipo';
      zCentro_costos.ParamByName('tipo').AsString:='CENTRO_COSTO';
      zCentro_costos.Open;

      while not zCentro_costos.eof do
      begin
        cc:= zCentro_costos.FieldByName('sNumeroOrden').AsString;
        // se buscan las existencias de los materilaes por centro de costo
        AsignarSQL(zMaterialCosto,'procedimiento_cc_ceros',pUpdate);
        FiltrarDataSet(zMaterialCosto,'contrato,cc',[global_contrato,cc]);
        zMaterialCosto.Open;

        if zMaterialCosto.RecordCount>0 then
        begin
        // crea la requisicion

          zAjustes.Active:= False;
          AsignarSQL(zAjustes,'anexo_requisicion',pUpdate);
          FiltrarDataSet(zAjustes,'contrato,IdDepartamento,Vista',[global_contrato, -1,-1,-1]);
          zAjustes.Open;

          zAjustes.Append;
          folio:=autoFolio(zAjustes,'anexo_requisicion',connection.uContrato.FieldByName('IdEmpresa').AsInteger,0,1);
          zAjustes.Cancel;


          AsignarSQL(zReq,'Insert_requisicion',pUpdate);
          FiltrarDataSet(zReq,'usuario,Folio,sNumeroOrden',[GLOBAL_USUARIO,folio,zMaterialCosto.FieldByName('sNumeroOrdenCC').AsString]);
          zReq.Execute;
          IdReq:=zReq.LastInsertId;

        //se crea la entrada

          Entrada_almacen.Active:= False;
          AsignarSQL(Entrada_almacen,'almacen_entrada',pUpdate);
          FiltrarDataSet(Entrada_almacen,'contrato,Usuario',[global_contrato,global_usuario]);
          Entrada_almacen.Open;
          Entrada_almacen.Append;
          folio:=autofolio(Entrada_almacen, 'almacen_entrada', connection.uContrato.FieldByName('IdEmpresa').AsInteger, 0,0);

          Entrada_almacen.Cancel;

          zAjustes.SQL.Clear;
          AsignarSQL(zAjustes,'Insert_entrada_almacen',pUpdate);
          FiltrarDataSet(zAjustes,'Folio,usuario,sNumeroOrden',[folio,GLOBAL_USUARIO,zMaterialCosto.FieldByName('sNumeroOrdenCC').AsString]);
          zAjustes.Execute;

          lastEnt:=zAjustes.LastInsertId;
        ...
        // crea la salida
          ...
          folio:=autofolio(salida_almacen,'almacen_salida');
          salida_almacen.Cancel;

          zAjustes.SQL.Clear;
          AsignarSQL(zAjustes,'Inser_salida_almacen',pUpdate);
          FiltrarDataSet(zAjustes,'Folio,usaurio,Empresa,req,sNumeroOrden',[folio,GLOBAL_USUARIO,Connection.ucontrato.FieldByName('IdEmpresa').AsInteger,IdReq,zMaterialCosto.FieldByName('sNumeroOrdenCC').AsString]);
          zAjustes.Execute;

          last:=zAjustes.LastInsertId;

           while not zMaterialCosto.Eof do
           begin

              if zMaterialCosto.FieldByName('Existencia').AsFloat <> 0 then
              begin

                if zMaterialCosto.FieldByName('Existencia').AsFloat > 0 then
                begin
                  exitencia:=zMaterialCosto.FieldByName('Existencia').AsFloat;
                  Id:=last;
                  Tipo:='Salida';
                end
                else if zMaterialCosto.FieldByName('Existencia').AsFloat < 0 then
                begin
                  exitencia:=(zMaterialCosto.FieldByName('Existencia').AsFloat*(-1));
                  Id:=lastEnt;
                  Tipo:='Entrada';
                end;
                //se inserta en las tablas destalles de requisicion, salida, entrada por medio de un procedimiento
                salida_almacen.SQL.Clear;
                salida_almacen.SQL.Text:='call insert_bitacora_salida(:Existencia, :LastId, :IdInsumo, :Req, :Desp,:Med,:Tipo)';
                salida_almacen.ParamByName('Existencia').AsFloat:=exitencia;
                salida_almacen.ParamByName('LastId').AsInteger:=Id;
                salida_almacen.ParamByName('IdInsumo').AsInteger:=zMaterialCosto.FieldByName('IdInsumo').AsInteger;
                salida_almacen.ParamByName('Req').AsInteger:=IdReq;
                salida_almacen.ParamByName('Desp').AsString:='';
                salida_almacen.ParamByName('Med').AsInteger:=0;
                salida_almacen.ParamByName('Tipo').AsString:=Tipo;
                salida_almacen.ExecSQL;
              end;
             zMaterialCosto.Next;
           end;
        end;
      ...
      begin
          ...
          if zqInsumos.FieldByName('dExistencia').AsFloat <> 0 then
          begin
            ...
            begin
              ...
              zAjustes.SQL.Clear;
              AsignarSQL(zAjustes,'Insert_entrada_almacen',pUpdate);
              FiltrarDataSet(zAjustes,'Folio,usuario,sNumeroOrden',[folio,GLOBAL_USUARIO,'']);
              zAjustes.Execute;
              ...
              zAjustes.SQL.Clear;
              AsignarSQL(zAjustes,'Inser_salida_almacen',pUpdate);
              FiltrarDataSet(zAjustes,'Folio,usaurio,Empresa,req,sNumeroOrden',[folio,GLOBAL_USUARIO,Connection.ucontrato.FieldByName('IdEmpresa').AsInteger,IdReq,'']);
              zAjustes.Execute;
              isPrimero:=False;
            end;
            ...
            begin
              Id:=last;
              exitencia:=zqInsumos.FieldByName('dExistencia').AsFloat;
              Tipo:='Salida';
            end
            else if zqInsumos.FieldByName('dExistencia').AsFloat < 0 then
            begin
              exitencia:=(zqInsumos.FieldByName('dExistencia').AsFloat*(-1));
              Id:=lastEnt;
              Tipo:='Entrada';
            end;
            //se inserta en las tablas destalles de requisicion, salida, entrada por medio de un procedimiento
            ...
            salida_almacen.ParamByName('Existencia').AsFloat:=exitencia;
            salida_almacen.ParamByName('LastId').AsInteger:=Id;
            salida_almacen.ParamByName('IdInsumo').AsInteger:=zqInsumos.FieldByName('IdInsumo').AsInteger;
            salida_almacen.ParamByName('Req').AsInteger:=0;
            salida_almacen.ParamByName('Desp').AsString:='';
            salida_almacen.ParamByName('Med').AsInteger:=0;
            salida_almacen.ParamByName('Tipo').AsString:=Tipo;
            salida_almacen.ExecSQL;
    ...
    try
      status := CreateStatusWindow('Recargando datos, espere por favor...');
      IsOpen := False;
      zqInsumos.Refresh;
      AsignarSQL(zInsumoCC,'procedimiento_existenciaCC',pUpdate);
      FiltrarDataset(zInsumoCC,'Contrato',[global_contrato]);
...
procedure TfrmMateriales_CMMI.cxButton3Click(Sender: TObject);
begin
  if grid_materialesLevel2.Visible then
  begin
    grid_materialesLevel2.Visible := False;
    cxView_MaterialesColumn13.Visible := False;
    cxView_MaterialesColumn14.Visible := True;
    cxView_MaterialesColumn15.Visible := True;
    cxView_Materiales.DataController.DetailKeyFieldNames:='';
    cxView_Materiales.DataController.KeyFieldNames := '';
    zqInsumos.Active:=False;
    AsignarSQL(zqInsumos,'alm_insumos_desagrupar',pUpdate);
    FiltrarDataSet(zqInsumos,'Contrato,Usuario,Codigo,IdFamilia1',[global_contrato, global_usuario,'-1','117']);
    zqInsumos.Open;

  end
  else
  begin
    cxView_MaterialesColumn13.Visible := True;
    cxView_MaterialesColumn14.Visible := False;
    cxView_MaterialesColumn15.Visible := False;
    cxView_Materiales.DataController.DetailKeyFieldNames:='IdInsumo';
    cxView_Materiales.DataController.KeyFieldNames := 'IdInsumo';
    zqInsumos.Active:=False;
    AsignarSQL(zqInsumos,'alm_insumos',pUpdate);
    FiltrarDataSet(zqInsumos,'Usuario,Codigo,IdFamilia1',[global_usuario,'-1','117']);
    zqInsumos.Open;
    cargarExistenciCC;
    grid_materialesLevel2.Visible := True;
  end;


end;

procedure TfrmMateriales_CMMI.cxEliminarClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.cxVisualizarImgClick(Sender: TObject);
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmMateriales_CMMI.cxCancelarDetalleClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.cxEditaDetalleClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.cxFamiliaExit(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.cxGridCertificadosCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  if zCertificado.RecordCount > 0 then
...
procedure TfrmMateriales_CMMI.cxGridViewImagenCellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmMateriales_CMMI.cxGuardarDetalleClick(Sender: TObject);
var
   lContinua : boolean;
begin
   lContinua := True;
...
procedure TfrmMateriales_CMMI.cxImportarClick(Sender: TObject);
var
   x, y, i : Integer;
begin
...
procedure TfrmMateriales_CMMI.cxImprimeInventarioClick(Sender: TObject);
begin
...
procedure TfrmMateriales_CMMI.cxImprimeMaximosClick(Sender: TObject);
begin
    AsignarSQL(zReporteDetalle,'reporte_maximos',pUpdate);
    FiltrarDataSet(zReporteDetalle,'IdFiltro',[-1]);
    zReporteDetalle.Open;
...
procedure TfrmMateriales_CMMI.cxNuevoDetalleClick(Sender: TObject);
begin
   PanelDown.Visible := True;
...
procedure TfrmMateriales_CMMI.cxPageDetalleChange(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.cxRepetidosClick(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.cxTabInformeShow(Sender: TObject);
begin
  opcionImprimir.EditValue := 1;
end;

procedure TfrmMateriales_CMMI.GlobalKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmMateriales_CMMI.OpenXLSClose(Sender: TObject);
var
...
procedure TfrmMateriales_CMMI.OpenXLSFolderChange(Sender: TObject);
begin
   tsArchivo := OpenXLS.FileName;
end;

procedure TfrmMateriales_CMMI.OpenXLSSelectionChange(Sender: TObject);
begin
   tsArchivo := OpenXLS.FileName;
end;

procedure TfrmMateriales_CMMI.Orden_Compra_scroll;
begin
     if PanelDetalle.Visible then
     begin
         if cxPageDetalle.ActivePage = cxPageImagen then
...
procedure TfrmMateriales_CMMI.PegarFamiliaClick(Sender: TObject);
var
   zActualiza : tUniquery;
   indice, iGrid    : integer;
...
procedure TfrmMateriales_CMMI.PegarMedidaClick(Sender: TObject);
var
   zActualiza : tUniquery;
   indice, iGrid    : integer;
   SavePlace, SavePlace2 : TBookMark;
...
procedure TfrmMateriales_CMMI.PegarMovimientosMatClick(Sender: TObject);
var
   zActualiza : tUniquery;
...
function TfrmMateriales_CMMI.EnviarMensaje(sUsuario, sClave, sServidor, sAdjunto,
...
procedure TfrmMateriales_CMMI.EnviaCorreo(sParamModulo: string; sParamProceso: string; sParamTipoMaterial: string; sParamEstatus: string; sParamFoldiosDoctos : string);
var
