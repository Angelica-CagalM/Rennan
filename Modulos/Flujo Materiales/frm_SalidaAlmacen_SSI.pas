...
type
  TfrmSalidaAlmacen_SSI = class(TForm)
...
var
  frmSalidaAlmacen_SSI: TfrmSalidaAlmacen_SSI;
  insert : Boolean ;
  OpcButton1    : String ;
  SavePlace     : TBookmark;
...
uses frm_connection , Func_Genericas, frm_agregar_masivoOP_SSI, unitMetodos, frm_firmasNota;

{$R *.dfm}


procedure TfrmSalidaAlmacen_SSI.SetDatos;
begin

end;

procedure TfrmSalidaAlmacen_SSI.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
guardar_leer_grid(Grid_EntradasDBTableView1,frmSalidaAlmacen_SSI,1);
guardar_leer_grid(GridPartidasView,frmSalidaAlmacen_SSI,1);
  action := cafree ;
end;

procedure TfrmSalidaAlmacen_SSI.FormShow(Sender: TObject);
var
    SavePlace : TBookmark;
    temE:TUniQuery;
    id : String;
begin
    ...
    PermisosBotones(frmSalidaAlmacen_SSI,btnPermisos);
...
//       cxSolicitudEmb.Visible:=False;
    ...
    guardar_leer_grid(Grid_EntradasDBTableView1,frmSalidaAlmacen_SSI,0);
    guardar_leer_grid(GridPartidasView,frmSalidaAlmacen_SSI,0);
end;

procedure TfrmSalidaAlmacen_SSI.BtnExitClick(Sender: TObject);
begin
    Close ;
end;

procedure TfrmSalidaAlmacen_SSI.btnImagenClick(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmSalidaAlmacen_SSI.btnImpInformeClick(Sender: TObject);
var
  salidasGrid : String;
...
procedure TfrmSalidaAlmacen_SSI.btnPostClick(Sender: TObject);
var
...
procedure TfrmSalidaAlmacen_SSI.btnPrinterClick(Sender: TObject);
var
...
procedure TfrmSalidaAlmacen_SSI.btnRefreshClick(Sender: TObject);
begin
   SavePlace := Grid_EntradasDBTableView1.DataController.DataSource.DataSet.GetBookmark;
...
procedure TfrmSalidaAlmacen_SSI.BuscarFolio1Click(Sender: TObject);
Var
...
procedure TfrmSalidaAlmacen_SSI.edtFolioEnter(Sender: TObject);
begin
  cxCodigo.Style.Color:=global_color_entradaERP;
end;

procedure TfrmSalidaAlmacen_SSI.edtFolioExit(Sender: TObject);
begin
   cxCodigo.Style.Color:=global_color_salidaERP;
end;

procedure TfrmSalidaAlmacen_SSI.edtFolioKeyPress(Sender: TObject; var Key: Char);
begin
   If Key = #13 Then
    cxFecha.SetFocus
end;

procedure TfrmSalidaAlmacen_SSI.tsIsometricoReferenciaKeyPress(
...
procedure TfrmSalidaAlmacen_SSI.GridPartidasViewCellClick(
...
procedure TfrmSalidaAlmacen_SSI.GridPartidasViewCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmSalidaAlmacen_SSI.GridPartidasViewMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TfrmSalidaAlmacen_SSI.frmBarra2btnEditClick(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.tdIdFechaEnter(Sender: TObject);
begin
    cxFecha.Style.Color := global_color_entrada
end;

procedure TfrmSalidaAlmacen_SSI.ValedeResguardo1Click(Sender: TObject);
begin
  If salida_almacen.RecordCount > 0 Then
     begin
         frmRepositorio.Reporte.Active := False;
...
procedure TfrmSalidaAlmacen_SSI.Grid_EntradasDBTableView1CellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  try
...
procedure TfrmSalidaAlmacen_SSI.Grid_EntradasDBTableView1CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmSalidaAlmacen_SSI.Grid_EntradasDBTableView1DataControllerFilterBeforeChange(
  Sender: TcxDBDataFilterCriteria; ADataSet: TDataSet;
  const AFilterText: string);
begin
  IsOpen:=False;
...
procedure TfrmSalidaAlmacen_SSI.Grid_EntradasDBTableView1KeyUp(Sender: TObject;
...
procedure TfrmSalidaAlmacen_SSI.Grid_EntradasDBTableView1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TfrmSalidaAlmacen_SSI.InsertarNumeroMaterial1Click(Sender: TObject);
var
...
procedure TfrmSalidaAlmacen_SSI.LimpiarCdigoMaterial1Click(Sender: TObject);
var
    zActualiza : tUniquery;
    indice, iGrid    : integer;
    lContinua : boolean;
...
procedure TfrmSalidaAlmacen_SSI.PopupPrincipalPopup(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.frxEntradaGetValue(const VarName: String; var Value: Variant);
begin
...
procedure TfrmSalidaAlmacen_SSI.cxButton1Click(Sender: TObject);
var zUpt: TUniquery;
begin
...
procedure TfrmSalidaAlmacen_SSI.cxButton2Click(Sender: TObject);
begin
 if True then
...
procedure TfrmSalidaAlmacen_SSI.cxButton3Click(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.cxCancelaMaterialClick(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.cxCancelarDetalleClick(Sender: TObject);
begin
   salida_detalle.Cancel;
...
procedure TfrmSalidaAlmacen_SSI.cxEditaDetalleClick(Sender: TObject);
begin
 If salida_almacen.RecordCount > 0 Then
     Begin
...
procedure TfrmSalidaAlmacen_SSI.cxEliminarDetalleClick(Sender: TObject);
var
  Id : Integer;
begin
     If salida_detalle.RecordCount > 0 Then
...
procedure TfrmSalidaAlmacen_SSI.cxEmpleadoPropertiesEditValueChanged(
  Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.cxGuardarDetalleClick(Sender: TObject);
begin
    salida_detalle.Post;
    cxCancelarDetalle.Click;
end;

procedure TfrmSalidaAlmacen_SSI.cxNuevoDetalleClick(Sender: TObject);
begin
    If (salida_almacen.RecordCount > 0) Then
     Begin
          if salida_almacen.FieldValues['sStatus'] <> 'PENDIENTE' then
...
procedure TfrmSalidaAlmacen_SSI.cxPageDetalleClick(Sender: TObject);
begin
 try
...
procedure TfrmSalidaAlmacen_SSI.cxRequisicionPropertiesChange(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.cxSalidaEPPClick(Sender: TObject);
var
frxDBEntrada : TfrxDBDataset;
begin
  try
...
procedure TfrmSalidaAlmacen_SSI.cxSalidaResguardoClick(Sender: TObject);
var
frxDBEntrada : TfrxDBDataset;
begin
  try
...
procedure TfrmSalidaAlmacen_SSI.cxSolicitudPropertiesChange(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.cxTabSheet3Show(Sender: TObject);
begin
  opcionImprimir.EditValue := 1;
end;

procedure TfrmSalidaAlmacen_SSI.cxTipoSalidaExit(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.cxTipoSalidaPropertiesChange(Sender: TObject);
begin
  if insert then
  begin
    cxProyecto.SetFocus;
...
procedure TfrmSalidaAlmacen_SSI.tdFechaAvisoKeyPress(Sender: TObject;
  var Key: Char);
begin
    If Key = #13 Then
        cxProyecto.SetFocus
...
procedure TfrmSalidaAlmacen_SSI.tsNumeroOrdenKeyPress(Sender: TObject;
  var Key: Char);
begin
       If Key = #13 Then
          cxRecibe.SetFocus
...
procedure TfrmSalidaAlmacen_SSI.ActivaBotones(Sender: Boolean);
begin
    if sender then
    begin
...
procedure TfrmSalidaAlmacen_SSI.AsignacionPersonal;
var
...
procedure TfrmSalidaAlmacen_SSI.btnAddClick(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.btnCancelClick(Sender: TObject);
begin
  insert:=False;
...
procedure TfrmSalidaAlmacen_SSI.btnDeleteClick(Sender: TObject);
begin
  If salida_almacen.RecordCount > 0 Then
...
procedure TfrmSalidaAlmacen_SSI.btnDetalleClick(Sender: TObject);
begin
  panelDown.Visible:= False;
...
procedure TfrmSalidaAlmacen_SSI.btnEditClick(Sender: TObject);
begin
    if salida_almacen.FieldValues['sStatus'] <> 'PENDIENTE' then
    begin
       messageDLG('La Salida de Material se encuentra en estatus '+salida_almacen.FieldValues['sStatus'], mtInformation, [mbOk], 0);
...
procedure TfrmSalidaAlmacen_SSI.EnterControl(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_SSI.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmSalidaAlmacen_SSI.GlobalKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmSalidaAlmacen_SSI.salida_detalleAfterScroll(DataSet: TDataSet);
begin
  IdRequi :=  Salida_Almacen.FieldByName('iFolioRequisicion').AsInteger;
end;

procedure TfrmSalidaAlmacen_SSI.salida_scroll;
begin
    if salida_almacen.RecordCount > 0 then
    begin
