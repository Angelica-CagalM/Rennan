...
uses frm_connection, frm_proveedores, Func_Genericas,
  frm_Presupuesto, frm_Empresas, frm_Pedidos, frm_firmasNota,frm_agregar_Requisicion;
...
procedure TfrmTipoMaterial.GlobalKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmTipoMaterial.FormShow(Sender: TObject);
var x: integer;
begin
  ...
  zMedida.Open;
    ...
    on e: exception do begin
      UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Tipo de Materiales', 'Al iniciar formulario', 0);
    end;
  end;
  zAlm_Insumo.Append;
...
procedure TfrmTipoMaterial.btnCancelClick(Sender: TObject);
begin
zAlm_Insumo.cancel;
close;
end;
...
procedure TfrmTipoMaterial.btnPostClick(Sender: TObject);
begin
...
procedure TfrmTipoMaterial.EnterControl(Sender: TObject);
begin
...
procedure TfrmTipoMaterial.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
