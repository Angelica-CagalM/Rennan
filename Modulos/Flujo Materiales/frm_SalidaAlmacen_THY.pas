...
type
  TfrmSalidaAlmacen_THY = class(TForm)
...
var
  frmSalidaAlmacen_THY: TfrmSalidaAlmacen_THY;
  insert : Boolean ;
  OpcButton1    : String ;
  SavePlace     : TBookmark;
...
uses frm_connection , Func_Genericas, frm_agregar_masivoOP_THY, unitMetodos, frm_firmasNota;

{$R *.dfm}


procedure TfrmSalidaAlmacen_THY.SetDatos;
begin

end;

procedure TfrmSalidaAlmacen_THY.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
guardar_leer_grid(Grid_EntradasDBTableView1,frmSalidaAlmacen_THY,1);
guardar_leer_grid(GridPartidasView,frmSalidaAlmacen_THY,1);
  action := cafree ;
end;

procedure TfrmSalidaAlmacen_THY.FormShow(Sender: TObject);
var
    SavePlace : TBookmark;
    temE:TUniQuery;
    id : String;
begin
    ...
    PermisosBotones(frmSalidaAlmacen_THY,btnPermisos);
...
//       cxSolicitudEmb.Visible:=False;
     ...
     dxLayoutItem24.Visible:=True;
     Grid_EntradasDBTableView1Column8.Visible:=False;
    guardar_leer_grid(Grid_EntradasDBTableView1,frmSalidaAlmacen_THY,0);
    guardar_leer_grid(GridPartidasView,frmSalidaAlmacen_THY,0);
end;

procedure TfrmSalidaAlmacen_THY.BtnExitClick(Sender: TObject);
begin
    Close ;
end;

procedure TfrmSalidaAlmacen_THY.btnImagenClick(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmSalidaAlmacen_THY.btnImpInformeClick(Sender: TObject);
var
  salidasGrid : String;
...
procedure TfrmSalidaAlmacen_THY.btnPostClick(Sender: TObject);
var
...
procedure TfrmSalidaAlmacen_THY.btnPrinterClick(Sender: TObject);
var
...
procedure TfrmSalidaAlmacen_THY.btnRefreshClick(Sender: TObject);
begin
   SavePlace := Grid_EntradasDBTableView1.DataController.DataSource.DataSet.GetBookmark;
...
procedure TfrmSalidaAlmacen_THY.BuscarFolio1Click(Sender: TObject);
Var
...
procedure TfrmSalidaAlmacen_THY.edtFolioEnter(Sender: TObject);
begin
  cxCodigo.Style.Color:=global_color_entradaERP;
end;

procedure TfrmSalidaAlmacen_THY.edtFolioExit(Sender: TObject);
begin
   cxCodigo.Style.Color:=global_color_salidaERP;
end;

procedure TfrmSalidaAlmacen_THY.edtFolioKeyPress(Sender: TObject; var Key: Char);
begin
   If Key = #13 Then
    cxFecha.SetFocus
end;

procedure TfrmSalidaAlmacen_THY.tsIsometricoReferenciaKeyPress(
...
procedure TfrmSalidaAlmacen_THY.GridPartidasViewCellClick(
...
procedure TfrmSalidaAlmacen_THY.GridPartidasViewCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmSalidaAlmacen_THY.GridPartidasViewMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
if Connection.uContrato.FieldByName('FK_Titulo').AsString = 'CMMI' then
  begin
...
procedure TfrmSalidaAlmacen_THY.frmBarra2btnEditClick(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.tdIdFechaEnter(Sender: TObject);
begin
    cxFecha.Style.Color := global_color_entrada
end;

procedure TfrmSalidaAlmacen_THY.ValedeResguardo1Click(Sender: TObject);
begin
  If salida_almacen.RecordCount > 0 Then
     begin
         frmRepositorio.Reporte.Active := False;
...
procedure TfrmSalidaAlmacen_THY.Grid_EntradasDBTableView1CellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  try
...
procedure TfrmSalidaAlmacen_THY.Grid_EntradasDBTableView1CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmSalidaAlmacen_THY.Grid_EntradasDBTableView1DataControllerFilterBeforeChange(
  Sender: TcxDBDataFilterCriteria; ADataSet: TDataSet;
  const AFilterText: string);
begin
  IsOpen:=False;
...
procedure TfrmSalidaAlmacen_THY.Grid_EntradasDBTableView1KeyUp(Sender: TObject;
...
procedure TfrmSalidaAlmacen_THY.Grid_EntradasDBTableView1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TfrmSalidaAlmacen_THY.InsertarNumeroMaterial1Click(Sender: TObject);
var
...
procedure TfrmSalidaAlmacen_THY.LimpiarCdigoMaterial1Click(Sender: TObject);
var
    zActualiza : tUniquery;
    indice, iGrid    : integer;
    lContinua : boolean;
...
procedure TfrmSalidaAlmacen_THY.PopupPrincipalPopup(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.frxEntradaGetValue(const VarName: String; var Value: Variant);
begin
...
procedure TfrmSalidaAlmacen_THY.cxButton1Click(Sender: TObject);
var zUpt: TUniquery;
begin
...
procedure TfrmSalidaAlmacen_THY.cxButton2Click(Sender: TObject);
begin
 if True then
...
procedure TfrmSalidaAlmacen_THY.cxButton3Click(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.cxCancelaMaterialClick(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.cxCancelarDetalleClick(Sender: TObject);
begin
   salida_detalle.Cancel;
...
procedure TfrmSalidaAlmacen_THY.cxEditaDetalleClick(Sender: TObject);
begin
 If salida_almacen.RecordCount > 0 Then
     Begin
...
procedure TfrmSalidaAlmacen_THY.cxEliminarDetalleClick(Sender: TObject);
var
  Id : Integer;
begin
     If salida_detalle.RecordCount > 0 Then
...
procedure TfrmSalidaAlmacen_THY.cxEmpleadoPropertiesEditValueChanged(
  Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.cxGuardarDetalleClick(Sender: TObject);
begin
    salida_detalle.Post;
    cxCancelarDetalle.Click;
end;

procedure TfrmSalidaAlmacen_THY.cxNuevoDetalleClick(Sender: TObject);
begin
    If (salida_almacen.RecordCount > 0) Then
     Begin
          if salida_almacen.FieldValues['sStatus'] <> 'PENDIENTE' then
...
procedure TfrmSalidaAlmacen_THY.cxPageDetalleClick(Sender: TObject);
begin
 try
...
procedure TfrmSalidaAlmacen_THY.cxRequisicionPropertiesChange(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.cxSalidaEPPClick(Sender: TObject);
var
frxDBEntrada : TfrxDBDataset;
begin
  try
...
procedure TfrmSalidaAlmacen_THY.cxSalidaResguardoClick(Sender: TObject);
var
frxDBEntrada : TfrxDBDataset;
begin
  try
...
procedure TfrmSalidaAlmacen_THY.cxSolicitudPropertiesChange(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.cxTabSheet3Show(Sender: TObject);
begin
  opcionImprimir.EditValue := 1;
end;

procedure TfrmSalidaAlmacen_THY.cxTipoSalidaExit(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.cxTipoSalidaPropertiesChange(Sender: TObject);
begin
  if insert then
  begin
    cxProyecto.SetFocus;
...
procedure TfrmSalidaAlmacen_THY.tdFechaAvisoKeyPress(Sender: TObject;
  var Key: Char);
begin
    If Key = #13 Then
        cxProyecto.SetFocus
...
procedure TfrmSalidaAlmacen_THY.tsNumeroOrdenKeyPress(Sender: TObject;
  var Key: Char);
begin
       If Key = #13 Then
          cxRecibe.SetFocus
...
procedure TfrmSalidaAlmacen_THY.ActivaBotones(Sender: Boolean);
begin
    if sender then
    begin
...
procedure TfrmSalidaAlmacen_THY.AsignacionPersonal;
var
...
procedure TfrmSalidaAlmacen_THY.btnAddClick(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.btnCancelClick(Sender: TObject);
begin
  insert:=False;
...
procedure TfrmSalidaAlmacen_THY.btnDeleteClick(Sender: TObject);
begin
  If salida_almacen.RecordCount > 0 Then
...
procedure TfrmSalidaAlmacen_THY.btnDetalleClick(Sender: TObject);
begin
  panelDown.Visible:= False;
...
procedure TfrmSalidaAlmacen_THY.btnEditClick(Sender: TObject);
begin
    if salida_almacen.FieldValues['sStatus'] <> 'PENDIENTE' then
    begin
       messageDLG('La Salida de Material se encuentra en estatus '+salida_almacen.FieldValues['sStatus'], mtInformation, [mbOk], 0);
...
procedure TfrmSalidaAlmacen_THY.EnterControl(Sender: TObject);
begin
...
procedure TfrmSalidaAlmacen_THY.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmSalidaAlmacen_THY.GlobalKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmSalidaAlmacen_THY.salida_detalleAfterScroll(DataSet: TDataSet);
begin
  IdRequi :=  Salida_Almacen.FieldByName('iFolioRequisicion').AsInteger;
end;

procedure TfrmSalidaAlmacen_THY.salida_scroll;
begin
    if salida_almacen.RecordCount > 0 then
    begin
