...
type
  TfrmServicios_CMMI = class(TForm)
    ...
    procedure cxButton2Click(Sender: TObject);  private
...
var
  frmServicios_CMMI : TfrmServicios_CMMI;
  Opcion         : String ;
...
procedure TfrmServicios_CMMI.EnterControl(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmServicios_CMMI.SeleccionarMovimientosMatClick(Sender: TObject);
var
    conteo:Integer;
    sMensaje : string;
...
procedure TfrmServicios_CMMI.FormShow(Sender: TObject);
begin
...
//        else
          FiltrarDataSet(zqInsumos,'Usuario,Codigo,IdFamilia',[global_usuario,'-1','117']);
        zqInsumos.Open;
...
//        else
        ...
        IsOpen := True;
        PermisosBotones(frmServicios_CMMI,btnPermisos);
...
procedure TfrmServicios_CMMI.FormClose(Sender: TObject;
...
procedure TfrmServicios_CMMI.grid_proveedoresCellClick(Column: TColumn);
begin
...
procedure TfrmServicios_CMMI.cxView_MaterialesCellClick(
...
procedure TfrmServicios_CMMI.cxView_MaterialesCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmServicios_CMMI.cxView_MaterialesColumn10GetProperties(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AProperties: TcxCustomEditProperties);
var
...
procedure TfrmServicios_CMMI.cxView_MaterialesDataControllerFilterBeforeChange(
  Sender: TcxDBDataFilterCriteria; ADataSet: TDataSet;
  const AFilterText: string);
begin
  IsOpen := False;
...
procedure TfrmServicios_CMMI.cxView_MaterialesDataControllerFilterChanged(
  Sender: TObject);
begin
  IsOpen:=True;
end;

procedure TfrmServicios_CMMI.cxView_MaterialesKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmServicios_CMMI.frmBarra1btnAddClick(Sender: TObject);
begin
  try
...
procedure TfrmServicios_CMMI.frmBarra1btnEditClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.frmBarra1btnPostClick(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.frmBarra1btnCancelClick(Sender: TObject);
begin
 try
...
procedure TfrmServicios_CMMI.frmBarra1btnDeleteClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.frmBarra1btnRefreshClick(Sender: TObject);
begin
 try
  zqInsumos.Active := False ;
  zqInsumos.Open
...
procedure TfrmServicios_CMMI.Insertar1Click(Sender: TObject);
begin
    frmBarraH11.btnAdd.Click
end;

procedure TfrmServicios_CMMI.muestraImagen;
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmServicios_CMMI.opcionImprimirPropertiesChange(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.Editar1Click(Sender: TObject);
begin
    frmBarraH11.btnEdit.Click
end;

procedure TfrmServicios_CMMI.Registrar1Click(Sender: TObject);
begin
    frmBarraH21.btnPost.Click
end;

procedure TfrmServicios_CMMI.btnAddClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.btnCancelClick(Sender: TObject);
begin
    cxLeyenda.Caption:=titulo;
    Panel2.Visible:=False;
    cxSplitter1.Visible := False;
...
procedure TfrmServicios_CMMI.btnDeleteClick(Sender: TObject);
var
   conteo:Integer;
   sMensaje : string;
...
procedure TfrmServicios_CMMI.btnDescargarClick(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.btnDetalleClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.btnEditClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.btnExistenciaClick(Sender: TObject);
begin
  if connection.UContrato.FieldByName('FK_Titulo').AsString = 'CMMI' then
  begin
...
procedure TfrmServicios_CMMI.btnExpandirClick(Sender: TObject);
begin
   if lExpandido then
   begin
...
procedure TfrmServicios_CMMI.btnExportaClick(Sender: TObject);
var
  rutaArchivo: string;
  Excel, Sheet: Variant;
  dlgSave : TSaveDialog;
...
procedure TfrmServicios_CMMI.btnImpInformeClick(Sender: TObject);
var
  MaterialGrid : String;
...
procedure TfrmServicios_CMMI.btnPostClick(Sender: TObject);
var
     SavePlace     : TBookmark;
     zUpt: TUniquery;
begin
...
procedure TfrmServicios_CMMI.btnPrinterClick(Sender: TObject);
begin
    IsOpen:=False;
    generar_reporte_grid(cxView_Materiales,'Reporte General de Materiales.');
    IsOpen:=True;
...
procedure TfrmServicios_CMMI.btnRefreshClick(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.BView_empresaDataControllerFilterRecord(
  ADataController: TcxCustomDataController; ARecordIndex: Integer;
  var Accept: Boolean);
begin
...
procedure TfrmServicios_CMMI.BView_filtroCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
    if BView_filtro.DataController.Filter.FilterText = '' then
...
procedure TfrmServicios_CMMI.Can1Click(Sender: TObject);
begin
    frmBarraH21.btnCancel.Click
end;

procedure TfrmServicios_CMMI.cargarExistenciCC;
var sqlCC: TUniquery;
begin
...
procedure TfrmServicios_CMMI.Eliminar1Click(Sender: TObject);
begin
    frmBarraH11.btnDelete.Click
end;

procedure TfrmServicios_CMMI.Imprimir1Click(Sender: TObject);
begin
    frmBarraH11.btnPrinter.Click
end;

procedure TfrmServicios_CMMI.popmenuAplicaClick(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.popmenuSeleccionaClick(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.PopupMovimientosPopup(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.VerDocumento1Click(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.zImagenesCalcFields(DataSet: TDataSet);
begin
   if zImagenes.RecordCount > 0 then
      zImagenes.FieldByName('Nombre').AsString := 'Imagen ' + IntTostr(zImagenes.RecNo);
end;

procedure TfrmServicios_CMMI.ColPrecioGetProperties(Sender: TcxCustomGridTableItem;
  ARecord: TcxCustomGridRecord; var AProperties: TcxCustomEditProperties);
var
  AColumn: TcxGridDBColumn;
begin
...
procedure TfrmServicios_CMMI.Copiar1Click(Sender: TObject);
begin
ModificarPortaPapeles(self.ActiveControl, ftcopiar)
end;

procedure TfrmServicios_CMMI.CopiarFamiliaClick(Sender: TObject);
var
    indice, iGrid    : integer;
    lcontinua : boolean;
begin
...
procedure TfrmServicios_CMMI.CopiarMedidaClick(Sender: TObject);
var
    indice, iGrid    : integer;
    lcontinua : boolean;
begin
...
procedure TfrmServicios_CMMI.btnAgregaMarcaClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.btnAgregarClick(Sender: TObject);
var
  size: Real;
begin
  sOpcion := 'New';
...
procedure TfrmServicios_CMMI.btnAgregarDoctoClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.btnAgregarFabricanteClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmServicios_CMMI.btnAgregarServicioClick(Sender: TObject);
begin
   GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmServicios_CMMI.cxAgregaFamiliaClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.cxAgregaMedidaClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmServicios_CMMI.cxAgregaSubFamiliaClick(Sender: TObject);
begin
     GLOBAL_FRMACTIVO:='frmMateriales_CMMI';
...
procedure TfrmServicios_CMMI.cxButton1Click(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmServicios_CMMI.cxButton2Click(Sender: TObject);
var
...
begin
  ...
  zCentro_costos.ParamByName('tipo').AsString:='PROYECTO';
  zCentro_costos.Open;

  while not zCentro_costos.eof do
  begin
    cc:= zCentro_costos.FieldByName('sIdFolio').AsString;
    // se buscan las existencias de los materilaes por centro de costo
    AsignarSQL(zMaterialCosto,'centro_costos_exitencias',pUpdate);
    FiltrarDataSet(zMaterialCosto,'contrato,sIdFolio',[global_contrato,cc]);
    zMaterialCosto.Open;
    ...
    FiltrarDataSet(zReq,'cc,usuario,Folio,sNumeroOrden',[cc,GLOBAL_USUARIO,folio,zMaterialCosto.FieldByName('sNumeroOrden').AsString]);
    zReq.Execute;
    ...
    FiltrarDataSet(zAjustes,'Folio,usuario,sNumeroOrden',[folio,GLOBAL_USUARIO,zMaterialCosto.FieldByName('sNumeroOrden').AsString]);
    zAjustes.Execute;
    ...
    FiltrarDataSet(zAjustes,'Folio,usaurio,Empresa,req,sNumeroOrden',[folio,GLOBAL_USUARIO,Connection.ucontrato.FieldByName('IdEmpresa').AsInteger,IdReq,zMaterialCosto.FieldByName('sNumeroOrden').AsString]);
    zAjustes.Execute;
    ...
    last:=zAjustes.LastInsertId;
     ...
     begin
        ...
        begin
          ...
          salida_almacen.ParamByName('Desp').AsString:=zMaterialCosto.FieldByName('Insumo').AsString;
          salida_almacen.ParamByName('Med').AsInteger:=zMaterialCosto.FieldByName('IdMedida').AsInteger;
  ...
  begin
      ...
      begin
        ...
        begin
          ...
          zAjustes.SQL.Clear;
          AsignarSQL(zAjustes,'Insert_entrada_almacen',pUpdate);
          FiltrarDataSet(zAjustes,'Folio,usuario,sNumeroOrden',[folio,GLOBAL_USUARIO,'PROY-0006']);
          zAjustes.Execute;
          ...
          zAjustes.SQL.Clear;
          AsignarSQL(zAjustes,'Inser_salida_almacen',pUpdate);
          FiltrarDataSet(zAjustes,'Folio,usaurio,Empresa,req,sNumeroOrden',[folio,GLOBAL_USUARIO,Connection.ucontrato.FieldByName('IdEmpresa').AsInteger,IdReq,'PROY-0006']);
          zAjustes.Execute;
          isPrimero:=False;
        end;
...
procedure TfrmServicios_CMMI.cxEliminarClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.cxVisualizarImgClick(Sender: TObject);
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmServicios_CMMI.cxCancelarDetalleClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.cxEditaDetalleClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.cxFamiliaExit(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.cxGridCertificadosCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  if zCertificado.RecordCount > 0 then
...
procedure TfrmServicios_CMMI.cxGridViewImagenCellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmServicios_CMMI.cxGuardarDetalleClick(Sender: TObject);
var
   lContinua : boolean;
begin
   lContinua := True;
...
procedure TfrmServicios_CMMI.cxImportarClick(Sender: TObject);
var
   x, y, i : Integer;
begin
...
procedure TfrmServicios_CMMI.cxImprimeInventarioClick(Sender: TObject);
begin
...
procedure TfrmServicios_CMMI.cxImprimeMaximosClick(Sender: TObject);
begin
    AsignarSQL(zReporteDetalle,'reporte_maximos',pUpdate);
    FiltrarDataSet(zReporteDetalle,'IdFiltro',[-1]);
    zReporteDetalle.Open;
...
procedure TfrmServicios_CMMI.cxNuevoDetalleClick(Sender: TObject);
begin
   PanelDown.Visible := True;
...
procedure TfrmServicios_CMMI.cxPageDetalleChange(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.cxRepetidosClick(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.cxTabInformeShow(Sender: TObject);
begin
  opcionImprimir.EditValue := 1;
end;

procedure TfrmServicios_CMMI.GlobalKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmServicios_CMMI.OpenXLSClose(Sender: TObject);
var
...
procedure TfrmServicios_CMMI.OpenXLSFolderChange(Sender: TObject);
begin
   tsArchivo := OpenXLS.FileName;
end;

procedure TfrmServicios_CMMI.OpenXLSSelectionChange(Sender: TObject);
begin
   tsArchivo := OpenXLS.FileName;
end;

procedure TfrmServicios_CMMI.Orden_Compra_scroll;
begin
     if PanelDetalle.Visible then
     begin
         if cxPageDetalle.ActivePage = cxPageImagen then
...
procedure TfrmServicios_CMMI.PegarFamiliaClick(Sender: TObject);
var
   zActualiza : tUniquery;
   indice, iGrid    : integer;
...
procedure TfrmServicios_CMMI.PegarMedidaClick(Sender: TObject);
var
   zActualiza : tUniquery;
   indice, iGrid    : integer;
   SavePlace, SavePlace2 : TBookMark;
...
procedure TfrmServicios_CMMI.PegarMovimientosMatClick(Sender: TObject);
var
   zActualiza : tUniquery;
...
function TfrmServicios_CMMI.EnviarMensaje(sUsuario, sClave, sServidor, sAdjunto,
...
procedure TfrmServicios_CMMI.EnviaCorreo(sParamModulo: string; sParamProceso: string; sParamTipoMaterial: string; sParamEstatus: string; sParamFoldiosDoctos : string);
var
