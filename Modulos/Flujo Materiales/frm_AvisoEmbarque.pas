...
var
  frmAvisoEmbarque: TfrmAvisoEmbarque;
...
//    try
      ...
      ELSE
        zAvisosEmbarque.FieldByName('Codigo').AsString    := autoFolioAviso(zAvisosEmbarque,'alm_aviso_embarque');
...
procedure TfrmAvisoEmbarque.btnCancelClick(Sender: TObject);
begin
  try
    ...
    PermisosBotones(frmAvisoEmbarque,btnPermisos);
  EXCEPT
  ON e:Exception do
    ShowMessage('Error: ' + e.Message);
...
procedure TfrmAvisoEmbarque.btnDeleteClick(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.btnDetalleClick(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.btnEditClick(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.btnExportaClick(Sender: TObject);
begin
ExportarToExcel(cxGridMateriales);
end;

procedure TfrmAvisoEmbarque.btnImpInformeClick(Sender: TObject);
var
  avisosGrid : String;
...
procedure TfrmAvisoEmbarque.btnPostClick(Sender: TObject);
begin
  try
    IsOpen := False;
...
procedure TfrmAvisoEmbarque.btnPrinterClick(Sender: TObject);
var
...
procedure TfrmAvisoEmbarque.btnRefreshClick(Sender: TObject);
begin
    zAvisosEmbarque.Refresh;
    zDetalleMaterial.Refresh;
end;

procedure TfrmAvisoEmbarque.CancelarClick(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.cxCancelarDetalleClick(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.cxEditaDetalleClick(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.cxEliminarDetalleClick(Sender: TObject);
var
  Id : Integer;
begin
     If zDetalleMaterial.RecordCount > 0 Then
...
procedure TfrmAvisoEmbarque.cxGuardarDetalleClick(Sender: TObject);
begin
    zDetalleMaterial.Post;
    cxCancelarDetalle.Click;
end;

procedure TfrmAvisoEmbarque.cxNuevoDetalleClick(Sender: TObject);
begin
  tdCantidad.Text  := '';
    If (zAvisosEmbarque.RecordCount > 0) Then
     Begin
...
procedure TfrmAvisoEmbarque.cxSalidaPropertiesChange(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.cxTabSheet3Show(Sender: TObject);
begin
  OpcionImprimir.EditValue := 1;
end;

procedure TfrmAvisoEmbarque.cxTipoSalidaExit(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.cxView_EmbarqueCellClick(
...
procedure TfrmAvisoEmbarque.cxView_MaterialesCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmAvisoEmbarque.FormClose(Sender: TObject;
...
begin
  try
   ...
   guardar_leer_grid(cxView_Embarque,frmAvisoEmbarque,1);
   guardar_leer_grid(cxView_Materiales,frmAvisoEmbarque,1);
  action := caFree
end;

procedure TfrmAvisoEmbarque.FormShow(Sender: TObject);
var
temE:TUniQuery;
begin
...
//    zOrdenesTrabajo.Open ;
   ...
   // dxLayoutItem16.Visible:=False;
    ...
    guardar_leer_grid(cxView_Embarque,frmAvisoEmbarque,0);
    guardar_leer_grid(cxView_Materiales,frmAvisoEmbarque,0);
end;

procedure TfrmAvisoEmbarque.SalvarClick(Sender: TObject);
var
...
procedure TfrmAvisoEmbarque.zAvisosEmbarqueAfterScroll(DataSet: TDataSet);
begin
  if IsOpen= True then
  begin
...
procedure TfrmAvisoEmbarque.zSalidaInsumoAfterScroll(DataSet: TDataSet);
begin
  if IsOpen then
  begin
...
procedure TfrmAvisoEmbarque.EnterControl(Sender: TObject);
begin
...
procedure TfrmAvisoEmbarque.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmAvisoEmbarque.GlobalKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
