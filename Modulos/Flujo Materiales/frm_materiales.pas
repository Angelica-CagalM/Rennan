...
procedure TfrmMateriales.EnterControl(Sender: TObject);
begin
...
procedure TfrmMateriales.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
...
procedure TfrmMateriales.SeleccionarMovimientosMatClick(Sender: TObject);
var
    conteo:Integer;
    sMensaje : string;
...
procedure TfrmMateriales.FormShow(Sender: TObject);
begin
...
//        else
        ...
        IsOpen := True;
        PermisosBotones(frmMateriales,btnPermisos);
...
procedure TfrmMateriales.grid_proveedoresCellClick(Column: TColumn);
begin
...
procedure TfrmMateriales.cxView_MaterialesCellClick(
...
procedure TfrmMateriales.cxView_MaterialesCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmMateriales.cxView_MaterialesColumn10GetProperties(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AProperties: TcxCustomEditProperties);
var
...
procedure TfrmMateriales.cxView_MaterialesDataControllerFilterBeforeChange(
  Sender: TcxDBDataFilterCriteria; ADataSet: TDataSet;
  const AFilterText: string);
begin
  IsOpen := False;
...
procedure TfrmMateriales.cxView_MaterialesDataControllerFilterChanged(
  Sender: TObject);
begin
  IsOpen:=True;
end;

procedure TfrmMateriales.cxView_MaterialesKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmMateriales.frmBarra1btnAddClick(Sender: TObject);
begin
  try
...
procedure TfrmMateriales.frmBarra1btnEditClick(Sender: TObject);
begin
...
procedure TfrmMateriales.frmBarra1btnPostClick(Sender: TObject);
var
...
procedure TfrmMateriales.frmBarra1btnCancelClick(Sender: TObject);
begin
 try
...
procedure TfrmMateriales.frmBarra1btnDeleteClick(Sender: TObject);
begin
...
procedure TfrmMateriales.frmBarra1btnRefreshClick(Sender: TObject);
begin
 try
  zqInsumos.Active := False ;
  zqInsumos.Open
...
procedure TfrmMateriales.Insertar1Click(Sender: TObject);
begin
    frmBarraH11.btnAdd.Click
end;

procedure TfrmMateriales.muestraImagen;
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmMateriales.opcionImprimirPropertiesChange(Sender: TObject);
begin
...
procedure TfrmMateriales.Editar1Click(Sender: TObject);
begin
    frmBarraH11.btnEdit.Click
end;

procedure TfrmMateriales.Registrar1Click(Sender: TObject);
begin
    frmBarraH21.btnPost.Click
end;

procedure TfrmMateriales.btnAddClick(Sender: TObject);
begin
...
procedure TfrmMateriales.btnCancelClick(Sender: TObject);
begin
    cxLeyenda.Caption:=titulo;
    Panel2.Visible:=False;
    cxSplitter1.Visible := False;
...
procedure TfrmMateriales.btnDeleteClick(Sender: TObject);
var
   conteo:Integer;
   sMensaje : string;
...
procedure TfrmMateriales.btnDescargarClick(Sender: TObject);
var
...
procedure TfrmMateriales.btnDetalleClick(Sender: TObject);
begin
...
procedure TfrmMateriales.btnEditClick(Sender: TObject);
begin
...
procedure TfrmMateriales.btnExistenciaClick(Sender: TObject);
begin
  if connection.UContrato.FieldByName('FK_Titulo').AsString = 'CMMI' then
  begin
...
procedure TfrmMateriales.btnExpandirClick(Sender: TObject);
begin
   if lExpandido then
   begin
...
procedure TfrmMateriales.btnExportaClick(Sender: TObject);
var
  rutaArchivo: string;
  Excel, Sheet: Variant;
  dlgSave : TSaveDialog;
...
procedure TfrmMateriales.btnImpInformeClick(Sender: TObject);
var
  MaterialGrid : String;
...
procedure TfrmMateriales.btnPostClick(Sender: TObject);
var
     SavePlace     : TBookmark;
     zUpt: TUniquery;
begin
...
procedure TfrmMateriales.btnPrinterClick(Sender: TObject);
begin
    IsOpen:=False;
    generar_reporte_grid(cxView_Materiales,'Reporte General de Materiales.');
    IsOpen:=True;
...
procedure TfrmMateriales.btnRefreshClick(Sender: TObject);
var
...
procedure TfrmMateriales.BView_empresaDataControllerFilterRecord(
  ADataController: TcxCustomDataController; ARecordIndex: Integer;
  var Accept: Boolean);
begin
...
procedure TfrmMateriales.BView_filtroCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
    if BView_filtro.DataController.Filter.FilterText = '' then
...
procedure TfrmMateriales.Can1Click(Sender: TObject);
begin
    frmBarraH21.btnCancel.Click
end;

procedure TfrmMateriales.Eliminar1Click(Sender: TObject);
begin
    frmBarraH11.btnDelete.Click
end;

procedure TfrmMateriales.Imprimir1Click(Sender: TObject);
begin
    frmBarraH11.btnPrinter.Click
end;

procedure TfrmMateriales.popmenuAplicaClick(Sender: TObject);
var
...
procedure TfrmMateriales.popmenuSeleccionaClick(Sender: TObject);
var
...
procedure TfrmMateriales.PopupMovimientosPopup(Sender: TObject);
begin
...
procedure TfrmMateriales.VerDocumento1Click(Sender: TObject);
begin
...
procedure TfrmMateriales.zImagenesCalcFields(DataSet: TDataSet);
begin
   if zImagenes.RecordCount > 0 then
      zImagenes.FieldByName('Nombre').AsString := 'Imagen ' + IntTostr(zImagenes.RecNo);
end;

procedure TfrmMateriales.ColPrecioGetProperties(Sender: TcxCustomGridTableItem;
  ARecord: TcxCustomGridRecord; var AProperties: TcxCustomEditProperties);
var
  AColumn: TcxGridDBColumn;
begin
...
procedure TfrmMateriales.Copiar1Click(Sender: TObject);
begin
ModificarPortaPapeles(self.ActiveControl, ftcopiar)
end;

procedure TfrmMateriales.CopiarFamiliaClick(Sender: TObject);
var
    indice, iGrid    : integer;
    lcontinua : boolean;
begin
...
procedure TfrmMateriales.CopiarMedidaClick(Sender: TObject);
var
    indice, iGrid    : integer;
    lcontinua : boolean;
begin
...
procedure TfrmMateriales.btnAgregaMarcaClick(Sender: TObject);
begin
...
procedure TfrmMateriales.btnAgregarClick(Sender: TObject);
var
  size: Real;
begin
  sOpcion := 'New';
...
procedure TfrmMateriales.btnAgregarDoctoClick(Sender: TObject);
begin
...
procedure TfrmMateriales.btnAgregarFabricanteClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmMateriales';
...
procedure TfrmMateriales.btnAgregarServicioClick(Sender: TObject);
begin
   GLOBAL_FRMACTIVO:='frmMateriales';
...
procedure TfrmMateriales.cxAgregaFamiliaClick(Sender: TObject);
begin
...
procedure TfrmMateriales.cxAgregaMedidaClick(Sender: TObject);
begin
    GLOBAL_FRMACTIVO:='frmMateriales';
...
procedure TfrmMateriales.cxAgregaSubFamiliaClick(Sender: TObject);
begin
     GLOBAL_FRMACTIVO:='frmMateriales';
...
procedure TfrmMateriales.cxButton1Click(Sender: TObject);
var
  BlobStream : TStream;
...
procedure TfrmMateriales.cxButton2Click(Sender: TObject);
var
...
procedure TfrmMateriales.cxEliminarClick(Sender: TObject);
begin
...
procedure TfrmMateriales.cxVisualizarImgClick(Sender: TObject);
var
  bS: TStream;
  Pic: TJPEGImage;
  BlobField: tField;
...
procedure TfrmMateriales.cxCancelarDetalleClick(Sender: TObject);
begin
...
procedure TfrmMateriales.cxEditaDetalleClick(Sender: TObject);
begin
...
procedure TfrmMateriales.cxFamiliaExit(Sender: TObject);
begin
...
procedure TfrmMateriales.cxGridCertificadosCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
  if zCertificado.RecordCount > 0 then
...
procedure TfrmMateriales.cxGridViewImagenCellClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmMateriales.cxGuardarDetalleClick(Sender: TObject);
var
   lContinua : boolean;
begin
   lContinua := True;
...
procedure TfrmMateriales.cxImportarClick(Sender: TObject);
var
   x, y, i : Integer;
begin
...
procedure TfrmMateriales.cxImprimeInventarioClick(Sender: TObject);
begin
...
procedure TfrmMateriales.cxImprimeMaximosClick(Sender: TObject);
begin
    AsignarSQL(zReporteDetalle,'reporte_maximos',pUpdate);
    FiltrarDataSet(zReporteDetalle,'IdFiltro',[-1]);
    zReporteDetalle.Open;
...
procedure TfrmMateriales.cxNuevoDetalleClick(Sender: TObject);
begin
   PanelDown.Visible := True;
...
procedure TfrmMateriales.cxPageDetalleChange(Sender: TObject);
var
...
procedure TfrmMateriales.cxRepetidosClick(Sender: TObject);
var
...
procedure TfrmMateriales.cxTabInformeShow(Sender: TObject);
begin
  opcionImprimir.EditValue := 1;
end;

procedure TfrmMateriales.GlobalKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmMateriales.OpenXLSClose(Sender: TObject);
var
...
procedure TfrmMateriales.OpenXLSFolderChange(Sender: TObject);
begin
   tsArchivo := OpenXLS.FileName;
end;

procedure TfrmMateriales.OpenXLSSelectionChange(Sender: TObject);
begin
   tsArchivo := OpenXLS.FileName;
end;

procedure TfrmMateriales.Orden_Compra_scroll;
begin
     if PanelDetalle.Visible then
     begin
         if cxPageDetalle.ActivePage = cxPageImagen then
...
procedure TfrmMateriales.PegarFamiliaClick(Sender: TObject);
var
   zActualiza : tUniquery;
   indice, iGrid    : integer;
...
procedure TfrmMateriales.PegarMedidaClick(Sender: TObject);
var
   zActualiza : tUniquery;
   indice, iGrid    : integer;
   SavePlace, SavePlace2 : TBookMark;
...
procedure TfrmMateriales.PegarMovimientosMatClick(Sender: TObject);
var
   zActualiza : tUniquery;
...
function TfrmMateriales.EnviarMensaje(sUsuario, sClave, sServidor, sAdjunto,
...
procedure TfrmMateriales.EnviaCorreo(sParamModulo: string; sParamProceso: string; sParamTipoMaterial: string; sParamEstatus: string; sParamFoldiosDoctos : string);
var
