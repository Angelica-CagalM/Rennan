object frmpagoProveedores: TfrmpagoProveedores
  Left = 353
  Top = 73
    ...
    object PanelDetalle: TPanel
      ...
      object PanelCentro: TPanel
        ...
        object cxPageDetalle: TcxPageControl
          ...
          ShowHint = True
          TabOrder = 2
          Properties.ActivePage = cxPagePP
          ...
          object cxPagePP: TcxTabSheet
            ...
            object cxGrid1: TcxGrid
              ...
              object cxGridDBTableView1: TcxGridDBTableView
                ...
                object cxColumn4: TcxGridDBColumn
                  Caption = 'Fecha'
                  DataBinding.FieldName = 'dFechaPago'
                  Options.Editing = False
                  Width = 66
                end
                ...
                object cxGridDBColumn2: TcxGridDBColumn
                  Caption = 'Abonado'
                  DataBinding.FieldName = 'dAbonado'
                  PropertiesClassName = 'TcxCurrencyEditProperties'
                  Options.Editing = False
                  Width = 60
                end
                object cxGridDBColumn3: TcxGridDBColumn
                  Caption = 'Saldo'
                  DataBinding.FieldName = 'dPendiente'
                  PropertiesClassName = 'TcxCurrencyEditProperties'
                  Options.Editing = False
                  Width = 61
                end
            ...
            object pnl_ord: TPanel
              ...
              object dxLayoutControl1: TdxLayoutControl
                ...
                object cmbTipoPago: TcxDBComboBox
                  Left = 90
                  Top = 11
                  Hint = 
                    'Indica si se realizar'#225' el pago en su totalidad o en parcialidade' +
                    's'
                  DataBinding.DataField = 'Estatus'
                  DataBinding.DataSource = ds_pago
                  ParentFont = False
                ...
                object txtProveedor: TcxDBTextEdit
                  Left = 90
                  Top = 39
                  DataBinding.DataField = 'NombreProveedor'
                ...
                object cmbCuenta: TcxDBLookupComboBox
                  Left = 361
                  Top = 39
                ...
                object txtTotal: TcxDBCurrencyEdit
                  Left = 90
                  Top = 67
                ...
                object txtSaldo: TcxDBCurrencyEdit
                  Left = 379
                  Top = 95
                  DataBinding.DataField = 'dPendiente'
                  DataBinding.DataSource = ds_pago
                  Enabled = False
                  ParentFont = False
                  Style.Font.Charset = DEFAULT_CHARSET
                ...
                object txtAbono: TcxDBCurrencyEdit
                  Left = 90
                  Top = 95
                  DataBinding.DataField = 'dAbonado'
                  DataBinding.DataSource = ds_pago
                  ParentFont = False
                  Properties.OnChange = txtAbonoPropertiesChange
                  Style.Font.Charset = DEFAULT_CHARSET
                  Style.Font.Color = clWindowText
                  Style.Font.Height = -12
                  Style.Font.Name = 'Tahoma'
                ...
                object cxFechaPago: TcxDBDateEdit
                  Left = 379
                  Top = 11
                  DataBinding.DataField = 'dFechaPago'
                  DataBinding.DataSource = ds_pago
                  ParentFont = False
                ...
                object dxLayoutItem1: TdxLayoutItem
                  ...
                  AlignHorz = ahClient
                  AlignVert = avTop
                  CaptionOptions.Text = 'Tipo de Pago'
                  Control = cmbTipoPago
  ...
  object catalogo: TUniQuery
    ...
    SQL.Strings = (
      '')
    AfterScroll = catalogoAfterScroll
    Left = 86
    Top = 123
  end
  object ds_pago: TDataSource
    AutoEdit = False
    DataSet = pago_proveedor
    Left = 32
    Top = 320
  end
  object pago_proveedor: TUniQuery
    Connection = connection.Uconnection
    Left = 81
    Top = 320
  end
