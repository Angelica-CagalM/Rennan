object frmComprobantesFiscalesD: TfrmComprobantesFiscalesD
  Left = 353
  Top = 73
  ...
  Caption = 'Lista de Comprobantes Fiscales Digitales'
  ClientHeight = 501
  ClientWidth = 1294
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object Panel2: TPanel
        ...
        object dxLayoutControl2: TdxLayoutControl
          ...
          object cxTotal: TcxDBCurrencyEdit
            Left = 740
            Top = 40
            ParentFont = False
            Style.Font.Charset = DEFAULT_CHARSET
          ...
          object cxNetoPorPagar: TcxDBCurrencyEdit
            Left = 397
            Top = 69
            ParentFont = False
            Style.Font.Charset = DEFAULT_CHARSET
          ...
          object cxDescuento: TcxDBCurrencyEdit
            Left = 80
            Top = 69
            ParentFont = False
            Style.Font.Charset = DEFAULT_CHARSET
          ...
          object dxLayoutItem12: TdxLayoutItem
            ...
            AlignHorz = ahClient
            AlignVert = avTop
            CaptionOptions.Text = 'Neto Por Pagar:'
            Control = cxNetoPorPagar
            ControlOptions.ShowBorder = False
            Index = 2
          end
      ...
      object grid_comprobantes: TcxGrid
        ...
        object cxView_Comprobantes: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              Kind = skCount
              Column = cxView_CFDFecha
              DisplayText = 'CFDI:'
            end
            item
              Kind = skSum
              Column = cxView_CFDTotal
              DisplayText = 'Total:'
            end
            item
              Kind = skSum
              Column = cxView_CFDSaldo
              DisplayText = 'Total:'
            end>
          ...
          Styles.OnGetContentStyle = cxView_ComprobantesStylesGetContentStyle
          ...
          object cxView_CFDDescuento: TcxGridDBColumn
            Caption = 'Descuento'
            DataBinding.FieldName = 'DescuentoRelacionado'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.Alignment.Horz = taRightJustify
            Properties.DecimalPlaces = 2
            Properties.DisplayFormat = ',0.00;-,0.00'
          ...
          object cxView_CFDNetoPorPagar: TcxGridDBColumn
            ...
            DataBinding.FieldName = 'NetoPagar'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.Alignment.Horz = taRightJustify
            Properties.DecimalPlaces = 2
            Properties.DisplayFormat = ',0.00;-,0.00'
          ...
          object cxView_ComprobantesSeleccionado: TcxGridDBColumn
  ...
  object Panel4: TPanel
    ...
    object dxLayoutControl4: TdxLayoutControl
      ...
      object cbEjercicio: TcxComboBox
        Left = 118
        Top = 11
        ParentFont = False
      ...
      object cbTipo: TcxLookupComboBox
        ...
        Top = 79
        ParentFont = False
        Properties.KeyFieldNames = 'IdTipoComprobante'
        Properties.ListColumns = <
          item
            FieldName = 'Descripcion'
          end>
        Properties.ListSource = dsTipoComprobante
        Style.Font.Charset = DEFAULT_CHARSET
        Style.Font.Color = clWindowText
        Style.Font.Height = -12
        Style.Font.Name = 'Arial'
      ...
      object cbEstadoSaldo: TcxComboBox
        Left = 665
        Top = 69
        ParentFont = False
        Properties.Items.Strings = (
      ...
      object dxLayoutGroupPeriodo: TdxLayoutGroup
        Parent = dxLayoutAutoCreatedGroup2
        CaptionOptions.AlignVert = tavCenter
        CaptionOptions.Text = 'Periodo:'
        ButtonOptions.Buttons = <>
        LayoutDirection = ldHorizontal
        Index = 0
      end
      object dxLayoutItem20: TdxLayoutItem
        Parent = dxLayoutGroupPeriodo
        AlignHorz = ahLeft
        AlignVert = avTop
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43598.551914375000000000
    ...
    ScriptText.Strings = (
      ...
      '   begin'
      '       Memo32.Text := <frxDBRequisicion."mDescripcion">+#13+#13+'
      ...
      '   begin'
        ...
        'l"> +#13+'
      '                      <frxDBRequisicion."mDescripcion">+#13+#13+'
      '                      <frxDBRequisicion."sObservacion">;'
      ''
      '   end;'
      ''
      ...
      '       else'
        ...
        '">+#13+<frxDBRequisicion."mDescripcion">+#13+#13+'
      '                      <frxDBRequisicion."sObservacion">;'
      '    end;'
      ''
      'end;'
  ...
  object zComprobantes: TUniQuery
    Left = 112
    Top = 72
  end
  object ds_comprobantes: TDataSource
    DataSet = zComprobantes
    Left = 208
    Top = 40
  end
  ...
  object zRfc: TUniQuery
    Connection = connection.Uconnection
    Left = 240
    Top = 160
  end
  object dsRfc: TDataSource
    DataSet = zRfc
    Left = 160
    Top = 160
  end
  object PopupMenu2: TPopupMenu
    Left = 121
    Top = 162
    object CancelarCFDI1: TMenuItem
      Caption = 'Cancelar CFDI'
      OnClick = CancelarCFDI1Click
    end
    object AnularCancelacion: TMenuItem
      Caption = 'Anular Cancelaci'#243'n '
      OnClick = AnularCancelacionClick
    end
    object AnularFechaEntregq1: TMenuItem
      Caption = 'Anular Fecha Entrega'
      OnClick = AnularFechaEntregq1Click
    end
    object CambiaraEstatusVigente1: TMenuItem
      Caption = 'Cambiar a Estatus Vigente'
      OnClick = CambiaraEstatusVigente1Click
    end
  end
