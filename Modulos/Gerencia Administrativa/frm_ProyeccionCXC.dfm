object frmProyeccionCXC: TfrmProyeccionCXC
  Left = 353
  Top = 73
  ...
  Caption = 'Proyecci'#243'n Cuentas Por Cobrar'
  ClientHeight = 501
  ClientWidth = 1294
  Color = clBtnFace
  ...
  object PanelPrincipal: TPanel
    ...
    object Panel1: TPanel
      ...
      object grid_cuentasxCobrar: TcxGrid
        Left = 1
        Top = 1
        Width = 1287
        Height = 294
        ...
        ParentFont = False
        TabOrder = 2
        object cxView_CuentasxCobrar: TcxGridDBTableView
          ...
          DataController.DataSource = ds_proyeccion
          ...
          object cxView_CuentasxCobrarProyecto: TcxGridDBColumn
            DataBinding.FieldName = 'Proyecto'
            Width = 120
          end
          object cxView_CuentasxCobrarCliente: TcxGridDBColumn
            DataBinding.FieldName = 'Cliente'
            Width = 120
          end
          object cxView_CuentasxCobrarOC: TcxGridDBColumn
            Caption = 'Orden Compra'
            Width = 120
          end
          object cxView_CuentasxCobrarDateOC: TcxGridDBColumn
            Caption = 'Fecha OC'
            DataBinding.FieldName = 'FechaOC'
            Width = 120
          end
          object cxView_CuentasxCobrarFactura: TcxGridDBColumn
            DataBinding.FieldName = 'Factura'
            Width = 120
          end
          object cxView_CuentasxCobrarDateEmision: TcxGridDBColumn
            Caption = 'Fecha de Emisi'#243'n'
            DataBinding.FieldName = 'FechaEmision'
            Width = 120
          end
          object cxView_CuentasxCobrarDateEntrega: TcxGridDBColumn
            Caption = 'Fecha de Entrega'
            DataBinding.FieldName = 'FechaEntrega'
            Width = 120
          end
          object cxView_CuentasxCobrarCredito: TcxGridDBColumn
            Caption = 'D'#237'as de Cr'#233'dito'
            DataBinding.FieldName = 'DiasC'
            Width = 120
          end
          object cxView_CuentasxCobrarCobro: TcxGridDBColumn
            Caption = 'Fecha de Cobro'
            DataBinding.FieldName = 'FechaPago'
            Width = 120
          end
          object cxView_CuentasxCobrarMonto: TcxGridDBColumn
            DataBinding.FieldName = 'Total'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Width = 120
          end
          object cxView_CuentasxCobrarCobrado: TcxGridDBColumn
            DataBinding.FieldName = 'MontoComp'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Width = 120
          end
          object cxView_CuentasxCobrarSaldo: TcxGridDBColumn
            DataBinding.FieldName = 'Saldo'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Width = 120
          end
        end
        object grid_cuentasxCobrarLevel1: TcxGridLevel
          GridView = cxView_CuentasxCobrar
        end
      end
    end
  end
  ...
  object zProyeccion: TUniQuery
    Left = 104
    Top = 136
  end
  object ds_proyeccion: TDataSource
    DataSet = zProyeccion
    Left = 208
    Top = 40
  end
