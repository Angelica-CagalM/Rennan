object frm_SatisfaccionCliente: Tfrm_SatisfaccionCliente
  Left = 0
  Top = 0
  Caption = 'Satisfacci'#243'n del Cliente'
  ClientHeight = 471
  ClientWidth = 1091
  Color = clBtnFace
    ...
    object Panel1: TPanel
      ...
      object grid_evaluacion: TcxGrid
        ...
        object cxView_Evaluacion: TcxGridDBTableView
          ...
          object cxView_EvaluacionColumn6: TcxGridDBColumn
            Caption = 'T'#233'lefono'
            DataBinding.FieldName = 'TelefonoCliente'
            Width = 92
          end
          object cxView_EvaluacionColumn3: TcxGridDBColumn
            Caption = 'C'#243'digo Postal'
            DataBinding.FieldName = 'RsCliente'
            Width = 82
          end
          object cxView_EvaluacionColumn4: TcxGridDBColumn
            Caption = 'Correo'
            DataBinding.FieldName = 'CorreoCliente'
            Width = 139
          end
        end
          ...
          object cxTabSheet2: TcxTabSheet
            ...
            object cxGridEvaluar: TcxGrid
              ...
              object cxGridViewEvalua: TcxGridDBTableView
                ...
                Navigator.InfoPanel.Visible = True
                Navigator.Visible = True
                DataController.DataSource = ds_ClienteDetalle
                DataController.Summary.DefaultGroupSummaryItems = <>
                DataController.Summary.FooterSummaryItems = <>
                DataController.Summary.SummaryGroups = <>
                FilterRow.Visible = True
                ...
                object colPregunta: TcxGridDBColumn
                  Caption = 'Documento'
                  DataBinding.FieldName = 'IdPCliente'
                  ...
                  Properties.ListSource = dsPregCliente
          ...
          object cxTabSheet3: TcxTabSheet
            ...
            object cxGridDocumentos: TcxGrid
              ...
              object cxViewDocumentos: TcxGridDBTableView
                ...
                DataController.DataSource = ds_Clientedoctos
                DataController.Filter.Options = [fcoCaseInsensitive]
  ...
  object dsPregCliente: TDataSource
    DataSet = zPregCliente
    Left = 93
    Top = 318
  end
  object zPregCliente: TUniQuery
    Connection = connection.Uconnection
    Left = 29
    Top = 318
  end
  ...
  object zClienteDoctos: TUniQuery
    Connection = connection.Uconnection
    Left = 191
    Top = 340
  end
  object ds_Clientedoctos: TDataSource
    DataSet = zListcDoc
    Left = 279
    Top = 340
  end
  ...
  object zClienteDetalle: TUniQuery
    Connection = connection.Uconnection
    Left = 39
    Top = 380
  end
  object ds_ClienteDetalle: TDataSource
    DataSet = zClienteDetalle
    Left = 119
    Top = 380
  end
end
