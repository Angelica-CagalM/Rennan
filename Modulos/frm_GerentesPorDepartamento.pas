...
begin
  btnPermisos := global_btnPermisos;
    ...
    on e : exception do begin
        UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Catálogo de Gerentes por Departamento', 'Al iniciar el formulario', 0);
    end;
 end;
end;
...
begin
   ...
   try
      ...
      on e : exception do begin
          UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Catálogo de Gerentes por Departamento', 'Al editar registro', 0);
          frmBarraH21.btnCancel.Click ;
      end;
   end ;
     frmBarraH11.btnPrinter.Enabled:=false;
...
begin
 try
  ...
  on e : exception do begin
  UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Catálogo de Gerentes por Departamento', 'Al cancelar', 0);
  end;
 end;
 frmBarraH11.btnPrinter.Enabled:=false;
end;
...
begin
 try
  ...
  on e : exception do begin
  UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Catálogo de Gerentes por Departamento', 'Al actualizar grid', 0);
  end;
 end;
end;
...
begin
    ...
    begin
      try
        ...
        on E : exception do begin
           UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Catálogo de Gerentes por Departamento', 'Al eliminar registro', 0);
        end;
      end
    end
end;
...
begin
   ...
   if zqGerenteDepartamento.State = dsInsert then
    ...
    try
        ...
        Except
           on e : exception do
             UnitExcepciones.manejarExcep(E.Message, E.ClassName, 'Catálogo de Gerentes por Departamento', 'Al salvar registro', 0);
        end;
    end;
