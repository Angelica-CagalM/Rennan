...
uses
  ...
  frxClass, frxDBSet, Buttons, RxLookup, RxMemDS, utilerias,
  ...
  jpeg, ComObj, UnitExcepciones, UFunctionsGHH,
  RXDBCtrl, ExtDlgs,
  System.ImageList;
...
begin
  ...
  OrdenesdeTrabajo.Params.ParamByName('status').Value :=  'P';
...
begin
    ...
    fotografico_acta.FieldValues['bImagen']          := connection.uconfiguracion.FieldValues['bImagen'];
...
//Verifica que la fecha final no sea menor que la fecha inicio
  ...
  try
    ...
    Begin
        ...
        QryPersonal.Params.ParamByName('status').Value :=  'P';
        QryPersonal.Open ;
        ...
        QryEquipos.Params.ParamByName('status').Value :=  'P';
        QryEquipos.Open ;
        ...
        QryGraficaTiemposMuertos.Params.ParamByName('status').Value := 'P';
        QryGraficaTiemposMuertos.Open ;
...
begin
    ...
    QryrFotografico.Params.ParamByName('codigo').Value      := connection.ucontrato.FieldValues['sCodigo'];
    QryrFotografico.Params.ParamByName('orden').DataType    := ftString ;
