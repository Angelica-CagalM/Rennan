...
uses
  ...
  StdCtrls, Buttons, global, ZAbstractRODataset, ZDataset, frm_repositorio,
  ...
  CxGridExportLink,ShellAPI, dxSkinOffice2016Colorful,//FormAutoScaler ,
  dxSkinOffice2016Dark, dxSkinVisualStudio2013Blue, dxSkinVisualStudio2013Dark,
  dxSkinVisualStudio2013Light, System.ImageList, cxContainer, cxTextEdit,
  cxMaskEdit, cxDropDownEdit, cxLookupEdit, cxDBLookupEdit, cxDBLookupComboBox,
  cxCheckBox,unitgenerales;
...
type
  TfrmKardex = class(TForm)
    ...
    tsIdUsuario: TcxDBLookupComboBox;
...
begin
    tsIdUsuario.Style.Color := global_color_salidaPU
end;
...
begin
    ...
    Begin
        ...
        Kardex.Params.ParamByName('Usuario').Value := tsIdUsuario.Text ;
        Kardex.Open ;
    End;
...
begin
  guardar_leer_grid(gridKardex,frmKardex,1);
  action := cafree ;
end;
...
begin
  usuarios.Open ;
  guardar_leer_grid(gridKardex,frmKardex,0);
end;
