object frmCompara: TfrmCompara
  ...
  Caption = 'Concentrado de consultas'
  ClientHeight = 409
  ClientWidth = 544
  Color = 14145495
  ...
  object GroupBox6: TGroupBox
    ...
    Height = 39
    TabOrder = 6
    object btnMatxDia: TButton
      Left = 7
      Top = 7
      Width = 233
      Height = 25
      Caption = 'Materiales Instalados por Dia'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
      ...
      ParentFont = False
      TabOrder = 0
      OnClick = btnMatxDiaClick
    end
  end
  object tdIdFecha: TcxDateEdit
    Left = 236
    Top = 12
    ParentFont = False
  ...
  object frxDBDordentrabajo: TfrxDBDataset
    UserName = 'frxDBDordentrabajo'
    CloseDataSource = False
    FieldAliases.Strings = (
      'sOficioAutorizacion=sOficioAutorizacion')
    DataSet = Ordentrabajo
    BCDToCurrency = False
    Left = 408
    Top = 336
  end
  object Ordentrabajo: TZReadOnlyQuery
    Connection = connection.zConnection
    SQL.Strings = (
      'select'
      '  b.snumeroorden,'
      '  b.sOficioAutorizacion,'
      '  b.mdescripcion'
      'from'
      '  actividadesxanexo a '
      '  inner join'
