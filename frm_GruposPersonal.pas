...
uses
  ...
  ZAbstractDataset, ZDataset, UnitExcepciones,
  ...
  cxGrid, cxContainer, dxLayoutcxEditAdapters, dxLayoutContainer, cxTextEdit,
  cxDBEdit, dxLayoutControl, dxSkinOffice2016Colorful, dxSkinOffice2016Dark,
...
procedure TfrmGruposPersonal.GlobalKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmGruposPersonal.EnterControl(Sender: TObject);
begin
...
procedure TfrmGruposPersonal.SalidaControl(Sender: TObject);
begin
    if (sender is tcxDBTextEdit) then
