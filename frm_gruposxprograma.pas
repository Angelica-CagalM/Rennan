...
uses
  ...
  DBGrids, ComCtrls, global, DB, Menus, frxClass, frxDBSet,
   RXDBCtrl, ImgList, Buttons, ZAbstractRODataset, ZDataset, unitexcepciones,
  ...
  dxSkinVisualStudio2013Light, System.ImageList, cxContainer, cxCheckListBox,
  cxCheckBox, cxListBox, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCheckComboBox,
  MemDS, DBAccess, Uni ;
...
type
  TfrmGruposxPrograma = class(TForm)
    ...
    ListChecked: TcxCheckListBox;
    chInsertar: TcxCheckBox;
    chEditar: TcxCheckBox;
    chEliminar: TcxCheckBox;
    chImprimir: TcxCheckBox;
    Programas: TUniQuery;
    GruposxPrograma: TUniQuery;
    ...
    procedure InicializarCheck(ListChecked: TcxCheckListBox; Cadena:String);
...
procedure TfrmGruposxPrograma.InicializarCheck(ListChecked: TcxCheckListBox; Cadena:String);
var
  Recorrido:integer;
  Item:string;
begin
...
//   InicializarCheck(ChkLbExportar,connection.uconfiguracion.FieldByName('sformatos').AsString);
