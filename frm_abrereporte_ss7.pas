...
type
  TfrmAbreReporte_ss7 = class(TForm)
    rDiario: TfrxReport;
...
var
  frmAbreReporte_ss7 : TfrmAbreReporte_ss7;
  sJornada       : string;
  iRecord        : Integer;
...
uses Func_Genericas, frm_Pedidos,
  UFrmEnviarCorreo, frm_valida_ss7, frm_ReporteDiarioTurno,
...
procedure TfrmAbreReporte_ss7.btnDComprarClick(Sender: TObject);
var
           ...
           grid_DatosView.DataController.FocusedRowIndex := indice;
            ...
            begin
               lRecordChange := True;
                ...
                procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DComprado',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );
...
procedure TfrmAbreReporte_ss7.btnDLiberarClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
           ...
           grid_DatosView.DataController.FocusedRowIndex := indice;
            ...
            begin
               lRecordChange := True;
                ...
                procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DLibero',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                kardex_almacen('DesLiberar '+cxLista.Items[cxLista.ItemIndex].Caption+' No. [' + grid_DatosView.DataController.DataSet.FieldByName('Folio').AsString + '].', 'Otros Movimientos');
            end
            else
            begin
                MessageDlg('No de puede realizar el proceso: '+#13+' -> '+cxLista.Items[cxLista.ItemIndex].Caption+' en Estatus '+grid_DatosView.DataController.DataSet.FieldByName('sStatus').AsString, mtInformation, [mbOk], 0);
...
procedure TfrmAbreReporte_ss7.btnEnviarClick(Sender: TObject);
begin
    cxLista.Items[iIndiceSeleccionado].Selected := True;
...
procedure TfrmAbreReporte_ss7.BtnExitClick(Sender: TObject);
begin
  close
end;

procedure TfrmAbreReporte_ss7.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    action := cafree;
end;

procedure TfrmAbreReporte_ss7.FormShow(Sender: TObject);
begin
...
//    guardar_leer_grid(grid_datosView,frmAbreReporte,0);
   PermisosBotones(frmAbreReporte_ss7,btnPermisos);
...
procedure TfrmAbreReporte_ss7.grid_datosViewCellClick(
...
procedure TfrmAbreReporte_ss7.grid_datosViewCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmAbreReporte_ss7.grid_datosViewStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
begin
    //Estatus
...
procedure TfrmAbreReporte_ss7.HabilitarF;
begin
   // lRecordChange := True;

    if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1 then
       procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'Habilita',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

    if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 2 then
       procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'Habilita',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

    if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 8 then
       procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'Habilita',3, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );
...
procedure TfrmAbreReporte_ss7.btnHabilitaClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
...
procedure TfrmAbreReporte_ss7.btnPRClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
           ...
           grid_DatosView.DataController.FocusedRowIndex := indice;
            ...
            begin
               lRecordChange := True;
                ...
                procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DGeneroPR',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                kardex_almacen('DesGenerarPR '+cxLista.Items[cxLista.ItemIndex].Caption+' No. [' + grid_DatosView.DataController.DataSet.FieldByName('Folio').AsString + '].', 'Otros Movimientos');
            end
            else
            begin
                MessageDlg('No de puede realizar el proceso: '+#13+' -> '+cxLista.Items[cxLista.ItemIndex].Caption+' en Estatus '+grid_DatosView.DataController.DataSet.FieldByName('sStatus').AsString, mtInformation, [mbOk], 0);
...
procedure TfrmAbreReporte_ss7.btnValidaClick(Sender: TObject);
var
  iGrid, indice: Integer;
  lPoder: Boolean;
  SavePlace : TBookmark;
          ...
          begin
           ...
           grid_DatosView.DataController.FocusedRowIndex := indice;
            ...
            begin
               lRecordChange := True;
                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1 then
                    procValidaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DesValida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 2 then
                 BEGIN
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                        zMontoDesvalida := TUniQuery.Create(nil);
                        AsignarSQL(zMontoDesvalida,'autorizaciones_VALIDA_monto',pUpdate);
                        FiltrarDataSet(zMontoDesvalida,'Valor,Tipo,Page,Grupo',[
                                        grid_DatosView.DataController.DataSet.FieldByName('dMontoMN').AsString,
                                        'Compras','VALIDAR',global_grupo]);
                        zMontoDesvalida.Open;

                        if zMontoDesvalida.RecordCount > 0 then
                          procValidaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'DesValida',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 )
                        else
                        begin
                          MessageDlg('Permiso denegado para realizar la Desvalidación de O.C., su monto esta fuera del Rango Asignado.', mtWarning,[mbOk],0);
                          exit
                        end;
                      end
                      else
                 ...
                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 3 then
                    procValidaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'DesValida',3, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7);

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 4 then
                    procValidaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'DesValida',4, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7);

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 5 then
                    procValidaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'DesValida',5, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 6 then
                    procValidaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'DesValida',6, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 7 then
                    procValidaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'DesValida',7, 0,grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_ss7 );
                 ...
                 BEGIN
                    ...
                    begin
                        ...
                        if zMontoDesvalida.RecordCount > 0 then
                          procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'DesValida',8, 0,grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida_ss7 )
                        else
                        begin
                          MessageDlg('Permiso denegado para realizar la Desvalidación de S.A.P., su monto esta fuera del Rango', mtWarning,[mbOk],0);
                          exit
                        end;
                    end
                    else
                 ...
                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 9 then
                    procValidaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'DesValida',9, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7);

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 10 then
                    procValidaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'DesValida',10, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 11 then
                    procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'DesValida',11, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );
...
procedure TfrmAbreReporte_ss7.cxListaClick(Sender: TObject);
begin
   grid_datosView.DataController.Groups.FullExpand;
   ...
   begin
       ...
       begin
          ...
          grid_datosView.Columns[12].DataBinding.FieldName:='Revision';
          ...
          grid_datosView.Columns[12].Caption:='Revisión';
...
//          btnAutoriza2.Visible := True;
          procCargaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DLibera',1, frmValida_ss7, zqDatos );
       ...
       begin
          ...
          procCargaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DesValida',1, frmValida_ss7, zqDatos );
       end
        else
       begin
          grid_datosView.Columns[0].DataBinding.FieldName:='Folio';
   ...
   begin
     {$Region 'Ordenes de Compra'}
      ...
      panel3.Visible:=false;
      panel1.Visible:=true;
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'DesValida',2, frmValida_ss7, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
     {$Region 'RIMs'}
      ...
      panel3.Visible:=false;
      panel1.Visible:=true;
      procCargaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'DesValida',3, frmValida_ss7, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
     {$Region 'Entradas de materiales'}
      ...
      panel3.Visible:=false;
      panel1.Visible:=true;
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'DesValida',4, frmValida_ss7, zqDatos );
      {$Endregion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'DesValida',5, frmValida_ss7, zqDatos );
      {$endregion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'DesValida',6, frmValida_ss7, zqDatos );
      {$Endregion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'DesValida',7, frmValida_ss7, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'DesValida',8, frmValida_ss7, zqDatos );
      {$EndRegion}
    end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'DesValida',9, frmValida_ss7, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
      ...
      procCargaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'DesValida',10, frmValida_ss7, zqDatos );
      {$EndRegion}
   end;
   ...
   begin
       ...
       begin
          ...
          procCargaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'DesValida',11, frmValida_ss7, zqDatos );
       end ;
...
procedure TfrmAbreReporte_ss7.cxRefrescarClick(Sender: TObject);
begin
   SavePlace2 := grid_DatosView.DataController.DataSource.DataSet.GetBookmark;
   zqDatos.Refresh;
   try
...
procedure TfrmAbreReporte_ss7.formatoEncabezado;
begin
...
procedure TfrmAbreReporte_ss7.cxSAPClick(Sender: TObject);
Var
...
procedure TfrmAbreReporte_ss7.cxVisualizarClick(Sender: TObject);
begin
    cxLista.Items[iIndiceSeleccionado].Selected := True;
    if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1 then
...
procedure TfrmAbreReporte_ss7.btnAsignarCCClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
           ...
           grid_DatosView.DataController.FocusedRowIndex := indice;
            ...
            begin
               lRecordChange := True;
                ...
                procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DAsignoCC',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                kardex_almacen('DesAsignar '+cxLista.Items[cxLista.ItemIndex].Caption+' No. [' + grid_DatosView.DataController.DataSet.FieldByName('Folio').AsString + '].', 'Otros Movimientos');
            end
            else
            begin
                MessageDlg('No de puede realizar el proceso: '+#13+' -> '+cxLista.Items[cxLista.ItemIndex].Caption+' en Estatus '+grid_DatosView.DataController.DataSet.FieldByName('sStatus').AsString, mtInformation, [mbOk], 0);
...
procedure TfrmAbreReporte_ss7.btnAutorizaClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
          ...
          begin
           ...
           grid_DatosView.DataController.FocusedRowIndex := indice;
            ...
            begin
                ...
                if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1 then
                   procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_requisicion', 'DesValida',1, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );
                ...
                begin
                  if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                        ...
                        if zMontoDesvalida.RecordCount > 0 then
                          procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'DesValida',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 )
                        else
                        begin
                          MessageDlg('Permiso denegado para realizar la Desautorización de O.C., su monto esta fuera del Rango Asignado.', mtWarning,[mbOk],0);
                          exit
                        end;
                      end
                      else
                ...
                if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 3 then
                   procAutorizaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'DesValida',3, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7);

                if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 4 then
                   procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'DesValida',4, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7);

                if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 5 then
                   procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'DesValida',5, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 6 then
                   procAutorizaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'DesValida',6, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );
                ...
                begin
                    ...
                    zRequisicion.First;
                     ...
                     MessageDlg('El proyecto está relacionado con algunos de estos parámetros: [Requisición, Ordenes de Compras, Entradas o Salidas], no puede desautorizar.', mtInformation, [mbOk], 0)
                        ...
                        procAutorizaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'DesValida',7, 0,grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmAbreReporte_ss7 );
                 end;
                 ...
                 begin
                   if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                        ...
                        if zMontoDesvalida.RecordCount > 0 then
                          procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'DesValida',8, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 )
                        else
                        begin
                          MessageDlg('Permiso denegado para realizar la Desautorización de S.A.P, su monto esta fuera del Rango Asignado.', mtWarning,[mbOk],0);
                          exit
                        end;
                      end
                      else
                 ...
                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 9 then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'DesValida',9, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7);

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 10 then
                    procAutorizaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'DesValida',10, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );

                 if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 11 then
                   procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'DesValida',11, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida_ss7 );
...
procedure TfrmAbreReporte_ss7.Grid_reportesGetCellParams(Sender: TObject;
...
procedure TfrmAbreReporte_ss7.Grid_requisicionGetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmAbreReporte_ss7.grid_salidasGetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmAbreReporte_ss7.rDiarioGetValue(const VarName: string;
  var Value: Variant);
var
...
procedure TfrmAbreReporte_ss7.ImprimeDatosPrepare(sParamUser :string; lVisualiza :boolean);
var
  uQryAux : TUniQuery;
begin
...
procedure TfrmAbreReporte_ss7.MuestraColumnas(iParamInicio,iParamFin : integer; lTipo :boolean);
var
  i : integer;
begin
