...
type
  TfrmAbreReporte_CMMI = class(TForm)
    rDiario: TfrxReport;
    ...
    procedure btnValidaTecnicoClick(Sender: TObject);
...
var
  frmAbreReporte_CMMI : TfrmAbreReporte_CMMI;
  sJornada       : string;
  iRecord        : Integer;
...
procedure TfrmAbreReporte_CMMI.btnDComprarClick(Sender: TObject);
var
...
procedure TfrmAbreReporte_CMMI.btnDLiberarClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
...
procedure TfrmAbreReporte_CMMI.btnEnviarClick(Sender: TObject);
begin
    cxLista.Items[iIndiceSeleccionado].Selected := True;
...
procedure TfrmAbreReporte_CMMI.BtnExitClick(Sender: TObject);
begin
  close
end;

procedure TfrmAbreReporte_CMMI.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    action := cafree;
end;

procedure TfrmAbreReporte_CMMI.FormShow(Sender: TObject);
begin
...
//    guardar_leer_grid(grid_datosView,frmAbreReporte,0);
   PermisosBotones(frmAbreReporte_CMMI,btnPermisos);
...
procedure TfrmAbreReporte_CMMI.grid_datosViewCellClick(
...
procedure TfrmAbreReporte_CMMI.grid_datosViewCellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TfrmAbreReporte_CMMI.grid_datosViewStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; var AStyle: TcxStyle);
begin
    //Estatus
...
procedure TfrmAbreReporte_CMMI.HabilitarF;
begin
    lRecordChange := True;
...
procedure TfrmAbreReporte_CMMI.btnHabilitaClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
...
procedure TfrmAbreReporte_CMMI.btnPRClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
...
procedure TfrmAbreReporte_CMMI.btnValidaClick(Sender: TObject);
var
  iGrid, indice: Integer;
  lPoder: Boolean;
  SavePlace : TBookmark;
...
procedure TfrmAbreReporte_CMMI.btnValidaTecnicoClick(Sender: TObject);
var
  iGrid, indice: Integer;
  lPoder: Boolean;
  SavePlace : TBookmark;
                 ...
                 BEGIN
                    if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                        ...
                        if zMontoDesvalida.RecordCount > 0 then
                          procValidaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'DesValidaTecnico',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida )
                        else
                        begin
...
procedure TfrmAbreReporte_CMMI.cxListaClick(Sender: TObject);
begin
   grid_datosView.DataController.Groups.FullExpand;
...
//          btnAutoriza2.Visible := True;
       ...
       begin
          ...
          panel1.Visible:=true;
          btnValidaTecnico.Visible := False;
   ...
   begin
     {$Region 'Ordenes de Compra'}
      ...
      begin
          ...
          grid_datosView.Columns[4].DataBinding.FieldName:='UsuarioValido';
          grid_datosView.Columns[5].DataBinding.FieldName:='FechaValido_A';
          grid_datosView.Columns[6].DataBinding.FieldName:='UsuarioValidoTecnico';
          grid_datosView.Columns[7].DataBinding.FieldName:='FechaValidoTecnico_A';
          grid_datosView.Columns[8].DataBinding.FieldName:='UsuarioAutorizo';
          grid_datosView.Columns[9].DataBinding.FieldName:='FechaAutorizo_A';
          grid_datosView.Columns[10].DataBinding.FieldName:='sStatus';
          grid_datosView.Columns[11].DataBinding.FieldName :='dMontoMN';
          grid_datosView.Columns[12].DataBinding.FieldName := 'Ahorro';
          ...
          grid_datosView.Columns[4].Caption:='Usuario Validó';
          grid_datosView.Columns[5].Caption:='Fecha Validó';
          grid_datosView.Columns[6].Caption:='Usuario Validó Tecnico';
          grid_datosView.Columns[7].Caption:='Fecha Validó Tecnico';
          grid_datosView.Columns[8].Caption:='Usuario Autorizó';
          grid_datosView.Columns[9].Caption:='Fecha Autorizó';
          grid_datosView.Columns[10].Caption:='Estatus';
          grid_datosView.Columns[11].Caption := 'Total O.C';
          grid_datosView.Columns[12].Caption := 'Ahorro';

          grid_datosView.Columns[11].PropertiesClassName := 'TcxCurrencyEditProperties';
...
procedure TfrmAbreReporte_CMMI.cxRefrescarClick(Sender: TObject);
begin
   SavePlace2 := grid_DatosView.DataController.DataSource.DataSet.GetBookmark;
   zqDatos.Refresh;
   try
...
procedure TfrmAbreReporte_CMMI.formatoEncabezado;
begin
...
procedure TfrmAbreReporte_CMMI.cxSAPClick(Sender: TObject);
Var
...
procedure TfrmAbreReporte_CMMI.cxVisualizarClick(Sender: TObject);
begin
    cxLista.Items[iIndiceSeleccionado].Selected := True;
    if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 1 then
...
procedure TfrmAbreReporte_CMMI.btnAsignarCCClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
...
procedure TfrmAbreReporte_CMMI.btnAutorizaClick(Sender: TObject);
var
  lPoder, lFilaGrid: Boolean;
  iGrid, indice: Integer;
  SavePlace: TBookmark;
                ...
                begin
                  if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then
                      begin
                        ...
                        if zMontoDesvalida.RecordCount > 0 then
                          procAutorizaDatosValidaAutoriza(global_contrato, 'anexo_pedidos', 'DesValidaTecnico',2, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida )
                        else
                        begin
...
procedure TfrmAbreReporte_CMMI.Grid_reportesGetCellParams(Sender: TObject;
...
procedure TfrmAbreReporte_CMMI.Grid_requisicionGetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmAbreReporte_CMMI.grid_salidasGetCellParams(Sender: TObject;
  Field: TField; AFont: TFont; var Background: TColor; Highlight: Boolean);
begin
...
procedure TfrmAbreReporte_CMMI.rDiarioGetValue(const VarName: string;
  var Value: Variant);
var
...
procedure TfrmAbreReporte_CMMI.ImprimeDatosPrepare(sParamUser :string; lVisualiza :boolean);
var
  uQryAux : TUniQuery;
begin
...
procedure TfrmAbreReporte_CMMI.MuestraColumnas(iParamInicio,iParamFin : integer; lTipo :boolean);
var
  i : integer;
begin
