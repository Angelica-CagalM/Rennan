...
var
  ...
  Memo1:TMemo;
  zConsulta, zMontoValida : tUniQuery;
  lCancela  : boolean;
begin
    cxLista.Items[iIndiceSeleccionado].Selected := True;
    sTipoMaterial := '';
...
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 3 then
//                     procValidaDatosValidaAutoriza(global_contrato, 'alm_inspeccion_material', 'Valida',3, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida);
//
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 4 then begin
//                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',4, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
//                       if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
//                          ImprimeDatosPrepare('frxDBEntradas', False ,zqDatos);
//                          connection.ExportaPDF.ShowProgress := False;
//                          connection.ExportaPDF.ShowDialog   := False;
...
//                  end;
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 5 then begin
//                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',5, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida);
//                      if (temE.FieldByName('FK_Titulo').AsString = 'CMMI') then begin
//                        ImprimeDatosPrepare('frxDBEntrada', False ,zqDatos);
//                        connection.ExportaPDF.ShowProgress := False;
//                        connection.ExportaPDF.ShowDialog   := False;
...
//                  end;
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 6 then
//                     procValidaDatosValidaAutoriza(global_contrato, 'alm_aviso_embarque', 'Valida',6, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida );
//
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 7 then
//                     procValidaDatosValidaAutoriza(global_contrato, 'ordenesdetrabajo', 'Valida', 7, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida );
...
//
//                        if zMontoValida.RecordCount > 0 then
//                          procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud_aprobpago', 'ValidaTecnico',8, 0, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsString, frmValida )
//                        else
//                        begin
//                          MessageDlg('Permiso denegado para realizar la validación de S.A.P, su monto esta fuera del Rango Asignado', mtWarning,[mbOk],0);
//                          exit
...
//                  end;
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 9 then
//                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_entrada', 'Valida',9, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida);
//
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 10 then
//                     procValidaDatosValidaAutoriza(global_contrato, 'almacen_salida', 'Valida',10, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida);
//
//                  if cxLista.Items.Item[cxLista.ItemIndex].StateIndex = 11 then
//                    procValidaDatosValidaAutoriza(global_contrato, 'anexo_solicitud', 'Valida',11, grid_DatosView.DataController.DataSet.FieldByName('iFolio').AsInteger,'', frmValida);
