...
uses
  ...
  frm_Consulta in 'frm_Consulta.pas' {frmConsulta},
  frm_Especialidad in 'frm_Especialidad.pas' {frmEspecialidad},
  frm_Medicos in 'frm_Medicos.pas' {frmMedicos},
  frm_Pacientes in 'frm_Pacientes.pas' {frmPacientes},
  frm_Plantilla in 'frm_Plantilla.pas' {frmPlantilla},
  frm_TipoEstudio in 'frm_TipoEstudio.pas' {frmTipoEstudio};
...
begin
  ...
  Application.Title := 'Gabinete de ultrasonido Dr. Renán';
