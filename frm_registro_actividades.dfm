object frmRegistroAct: TfrmRegistroAct
  Left = 0
  Top = 0
  ...
  object PanelDetalle: TPanel
    ...
    object PanelDownD: TPanel
      ...
      object dxLayoutControl2: TdxLayoutControl
        ...
        TabOrder = 1
        LayoutLookAndFeel = connection.dxLayoutSkinLookAndFeel1
        object cxProyectoD: TcxDBLookupComboBox
          Left = 83
          Top = 11
          DataBinding.DataField = 'sNumeroOrden'
          DataBinding.DataSource = ds_programadas
          ParentFont = False
          Properties.KeyFieldNames = 'sNumeroOrden'
          Properties.ListColumns = <
            item
        ...
        object cxRecurrenteD: TdxDBToggleSwitch
          Left = 11
          Top = 95
          Caption = #191'Es Recurrente?'
          DataBinding.DataField = 'EsRecurrente'
          DataBinding.DataSource = ds_programadas
          ParentFont = False
          ...
          TabOrder = 5
          Transparent = True
          OnClick = cxRecurrenteDClick
        end
        object cxFechaIniD: TcxDBDateEdit
          Left = 83
          Top = 67
          DataBinding.DataField = 'Fecha'
          DataBinding.DataSource = ds_programadas
        ...
        object cxFechaFinD: TcxDBDateEdit
          Left = 355
          Top = 67
        ...
        object cxHoraIniD: TcxDBTimeEdit
          Left = 83
          Top = 39
          DataBinding.DataField = 'HoraInicio'
          DataBinding.DataSource = ds_programadas
        ...
        object cxHoraFinD: TcxDBTimeEdit
          Left = 355
          Top = 39
          DataBinding.DataField = 'HoraFin'
          DataBinding.DataSource = ds_programadas
    ...
    object cxGridProgramado: TcxGrid
      Left = 1
      Top = 56
      Width = 568
      Height = 226
      ...
      ParentFont = False
      TabOrder = 3
      object cxViewProgramado: TcxGridDBTableView
        Navigator.Buttons.CustomButtons = <>
        DataController.DataSource = ds_programadas
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <>
        DataController.Summary.SummaryGroups = <>
        OptionsCustomize.ColumnsQuickCustomization = True
        ...
        object cxColumnD1: TcxGridDBColumn
          Caption = #191'Es recurrente?'
          DataBinding.FieldName = 'EsRecurrente'
          Visible = False
          GroupIndex = 0
        end
      ...
      object cxGridProgramadoLevel1: TcxGridLevel
        GridView = cxViewProgramado
      end
    end
  end
